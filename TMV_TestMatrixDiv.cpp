...
template <class T> void TestNonSquareDiv(tmv::DivType dt)
{
  ...
  Matrix<complex<T> > q30 = a;
  UpperTriMatrix<complex<T> > r30(10,10);
  ...
  Matrix<complex<T> > q10 = a.Rows(0,10);
  UpperTriMatrix<complex<T> > r10(10,10);
  QR_Decompose(q10.View(),r10.View());
  UpperTriMatrix<complex<T> > r = r10;
  Matrix<complex<T> > a1030 = a.Rows(10,30);
  ...
  Matrix<complex<T> > a1020 = a.Rows(10,20);
  Matrix<complex<T> > a2030 = a.Rows(20,30);
  ...
  Matrix<complex<T> > q29 = a.Rows(0,29);
  UpperTriMatrix<complex<T> > r29(10,10);
