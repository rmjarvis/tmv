...
namespace tmv {
  ...
  template <class T, class Tx> inline Vector<T>& operator+=(
      Vector<T>& v, const Tx& x)
  { v.View() += x; return v; }
  ...
  {
    public:
      ProdXV(T _x1, const GenVector<Tv>& _v2) : x1(_x1), v2(&_v2) {}
      inline size_t size() const { return v2->size(); }
      inline T GetX() const { return x1; }
      inline const GenVector<Tv>& GetV() const { return *v2; }
