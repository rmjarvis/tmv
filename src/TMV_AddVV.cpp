...
namespace tmv {
  ...
  { 
    ...
    std::cout<<"v1 = "<<TypeText(v1)<<" step "<<v1.step()<<"  "<<v1<<endl;
    std::cout<<"v2 = "<<TypeText(v2)<<" step "<<v2.step()<<"  "<<v2<<endl;
    Vector<T> v0 = v2;
    Vector<T> vx = v2;
    ...
    if (Norm(diff) > 0.001*ABS(x)*(Norm(v1)+Norm(v0))) {
      ...
      cerr<<"v2 = "<<TypeText(v2)<<"  step "<<v2.step()<<"  "<<v0<<endl;
      cerr<<"-> "<<v2<<endl;
      cerr<<"vx = "<<vx<<endl;
  ...
  { 
    ...
    cout<<"v1 = "<<TypeText(v1)<<"  "<<v1<<endl;
    cout<<"v2 = "<<TypeText(v2)<<"  "<<v2<<endl;
    cout<<"v3 = "<<TypeText(v3)<<"  "<<v3<<endl;
    Vector<T> v10 = v1;
    Vector<T> v20 = v2;
    Vector<T> vx = v2;
    ...
    if (Norm(diff) > 0.001*(
      ...
      cerr<<"v1 = "<<TypeText(v1)<<"  step "<<v1.step()<<"  "<<v10<<endl;
      cerr<<"v2 = "<<TypeText(v2)<<"  step "<<v2.step()<<"  "<<v20<<endl;
      cerr<<"-> "<<v3<<endl;
      cerr<<"vx = "<<vx<<endl;
