...
namespace tmv {
  ...
  template <class T, class T1> void LDL_LDivEq(
      const GenSymMatrix<T1>& L, const GenVector<T1>& xD, const int* P,
      const MatrixView<T>& m);
  template <class T, class T1> void LDL_RDivEq(
      const GenSymMatrix<T1>& L, const GenVector<T1>& xD, const int* P,
      const MatrixView<T>& m);
  template <class T, class T1> void LDL_Inverse(
      const GenSymMatrix<T>& L, const GenVector<T>& xD, const int* P,
