...
namespace tmv {
    ...
    static void DoMultMM(
        const double x,
        const ConstMatrixView<double,RowMajor>& m1,
        const ConstMatrixView<double,RowMajor>& m2,
    ...
    static void DoMultMM(
        const float x,
        const ConstMatrixView<float,RowMajor>& m1,
        const ConstMatrixView<float,RowMajor>& m2,
