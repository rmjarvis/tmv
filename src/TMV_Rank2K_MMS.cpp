...
#define SYM_R2K_BLOCKSIZE2 1
      ...
      const int beta, const SymMatrixView<std::complex<double> >& A)
  {
    ...
    BlasRank2KUpdate(double(1),x1,y,0,A1.View());
      ...
      const int beta, const SymMatrixView<std::complex<double> >& A)
  {
    ...
    SymMatrix<double,Lower,ColMajor> A1(A.size());
    BlasRank2KUpdate(double(1),x,y1,0,A1.View());
    if (beta == 0) A = alpha*A1;
    else A += alpha*A1;
    y1 = y.Imag();
    BlasRank2KUpdate(double(1),x,y1,0,A1.View());
      ...
      const int beta, const SymMatrixView<std::complex<double> >& A)
  {
    ...
    SymMatrix<double,Lower,ColMajor> A1(A.size(),double(0));
    BlasRank2KUpdate(double(1),x,y,beta,A1.View());
    if (beta == 0) A = alpha*A1;
    else A += alpha*A1;
  }
#endif
      ...
      const int beta, const SymMatrixView<std::complex<float> >& A)
  {
    ...
    BlasRank2KUpdate(float(1),x1,y,0,A1.View());
    if (beta == 0) A = alpha*A1;
    else A += alpha*A1;
    x1 = x.Imag();
    BlasRank2KUpdate(float(1),x1,y,0,A1.View());
      ...
      const int beta, const SymMatrixView<std::complex<float> >& A)
  {
    ...
    SymMatrix<float,Lower,ColMajor> A1(A.size());
    BlasRank2KUpdate(float(1),x,y1,0,A1.View());
    if (beta == 0) A = alpha*A1;
    else A += alpha*A1;
    y1 = y.Imag();
    BlasRank2KUpdate(float(1),x,y1,0,A1.View());
      ...
      const int beta, const SymMatrixView<std::complex<float> >& A)
  {
    ...
    SymMatrix<float,Lower,ColMajor> A1(A.size(),float(0));
    BlasRank2KUpdate(float(1),x,y,beta,A1.View());
    if (beta == 0) A = alpha*A1;
    else A += alpha*A1;
  }
#endif
