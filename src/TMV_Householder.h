...
namespace tmv {
  ...
  template <class T> 
  T Householder_Reflect(ConjRef<T> x0, const VectorView<T>& x, T& det);

  template <class T> 
  T Householder_Reflect(VarConjRef<T> x0, const VectorView<T>& x, T& det);

  template <class T> 
  T Householder_Reflect(const VectorView<T>& x, T& det);

  template <class T> 
  T Householder_Reflect(const MatrixView<T>& m, T& det);
  ...
  template <class T> 
  bool Householder_UnReflect(T& y, const VectorView<T>& x, T& beta);
  ...
  template <class T> 
  bool Householder_UnReflect(ConjRef<T> y, const VectorView<T>& x, T& beta);

  template <class T> 
  bool Householder_UnReflect(VarConjRef<T> y, const VectorView<T>& x,
      T& beta);

  template <class T1, class T2> 
  void Householder_LMult(const GenVector<T1>& v, T1 beta,
      const VectorView<T2>& m0, const MatrixView<T2>& mx);
  ...
  template <class T1, class T2> 
  void Householder_LMult(
      const GenVector<T1>& v, T1 beta, const MatrixView<T2>& m);

  template <class T> 
  void Householder_Unpack(T& v0, const VectorView<T>& v, T beta);
  // The input vector, v, is taken to be the vector for a  Householder 
  // matrix, H. 
  // (v0,v) is set to Ht times e0.

  template <class T> 
  void Householder_Unpack(ConjRef<T> v0, const VectorView<T>& v, T beta);

  template <class T> 
  void Householder_Unpack(VarConjRef<T> v0, const VectorView<T>& v, T beta);

  template <class T> 
  void Householder_Unpack(const MatrixView<T>& m, T beta);
  ...
  template <class T> 
  void BlockHouseholder_Augment(const GenMatrix<T>& Y,
  ...
  template <class T> 
  void BlockHouseholder_MakeZ(const GenMatrix<T>& Y,
  ...
  void BlockHouseholder_LMult(const GenMatrix<T>& Y,
      const GenUpperTriMatrix<T>& Z, const MatrixView<T2>& m);
  ...
  template <class T, class T2> 
  void BlockHouseholder_LDiv(const GenMatrix<T>& Y,
      const GenUpperTriMatrix<T>& Z, const MatrixView<T2>& m);
  // As above, but m <- (I - YZYt)^-1 m 

  template <class T> 
  void BlockHouseholder_Unpack(const MatrixView<T>& Y,
