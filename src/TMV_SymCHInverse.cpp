...
namespace tmv {
  ...
  template <class T> static void NonLapCHInverse(const SymMatrixView<T>& sinv)
  {
...
#ifdef ALAP
  template <class T> static inline void LapCHInverse(const SymMatrixView<T>& sinv)
  ...
  template <class T, class T1> void CH_Inverse(const GenSymMatrix<T>& LLx,
