...
namespace tmv {
  ...
  // C (+)= alpha * A * B
  {
    ...
    //cout<<"A = "<<A.cptr()<<"  "<<TypeText(A)<<"  "<<A.cptr()<<"  "<<A.nlo()<<','<<A.nhi()<<"  "<<A<<endl;
    //cout<<"B = "<<B.cptr()<<"  "<<TypeText(B)<<"  "<<B.cptr()<<"  "<<B.nlo()<<','<<B.nhi()<<"  "<<B<<endl;
    //cout<<"C = "<<C.cptr()<<"  "<<TypeText(C)<<"  "<<C.cptr()<<"  "<<C.nlo()<<','<<C.nhi()<<"  "<<C<<endl;
    Matrix<Ta> A0 = A;
    Matrix<Tb> B0 = B;
    Matrix<T> C0 = C;
...
#ifdef XDEBUG
    //cout<<"Done: C = "<<TypeText(C)<<"  "<<C.nlo()<<','<<C.nhi()<<"  "<<C<<endl;
    //cout<<"C2-C = "<<(C2-C)<<endl;
    ...
    if (Norm(C2-C) > 0.001*(ABS(alpha)*Norm(A0)*Norm(B0)+
      ...
      cerr<<"add = "<<add<<endl;
      cerr<<"A = "<<TypeText(A)<<"  "<<A.nlo()<<','<<A.nhi()<<"  "<<A<<endl;
      cerr<<"B = "<<TypeText(B)<<"  "<<B.nlo()<<','<<B.nhi()<<"  "<<B<<endl;
      cerr<<"C = "<<TypeText(C)<<"  "<<C.nlo()<<','<<C.nhi()<<"  "<<C0<<endl;
      cerr<<"--> C = "<<C0<<endl;
      cerr<<"C2 = "<<C2<<endl;
      abort();
    }
