...
namespace tmv {
        ...
        const BandMatrixView<T>& C)
    {
        ...
        TMVAssert(C.nhi() == TMV_MIN(int(C.rowsize()-1),A.nhi()+B.nhi()));
        TMVAssert(C.nlo() == TMV_MIN(int(C.colsize()-1),A.nlo()+B.nlo()));
        TMVAssert(alpha!= T(0));
        ...
        if (C.colsize() > 0 && C.rowsize() > 0) {
            if (A.rowsize() == 0 || alpha == T(0)) {
                ...
                ConstBandMatrixView<Tb> BB = B.subBandMatrix(
                    ...
                    TMV_MIN(B.nlo(),int(AA.rowsize())-1),B.nhi());
                ...
                ConstBandMatrixView<Ta> AA = A.subBandMatrix(
                    ...
                    A.nlo(),TMV_MIN(A.nhi(),int(BB.rowsize())-1));
                MultMM<add>(alpha,AA,BB,C);
