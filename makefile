#CFLAGS1= -O3 -Wall -Werror -ansi -DNDEBUG -DNOBLAS
#CC= /usr/bin/g++-3.4
#ODIR= gcc-3.4-noblas
#CFLAGS1= -wn3 -Kc++ -tpp7 -wd1476,1505 -DNOBLAS -DNOFLOAT -DTMVFLDEBUG
#CFLAGS1= -wn3 -Kc++ -tpp7 -wd1476,1505 
...
TMV_DIAGH_FILES= TMV_DiagMatrix.h TMV_DiagDivider.h TMV_DiagDiv.h TMV_DiagMatrixArith.h
TMV_DIAGO_FILES= $(ODIR)/TMV_DiagMatrix.o $(ODIR)/TMV_DiagDiv.o $(ODIR)/TMV_DiagMatrixArith.o 

TMV_TRIH_FILES= TMV_TriMatrix.h TMV_TriMatrixArith.h TMV_TriDivider.h TMV_TriDiv.h TMV_TriMatrixArith.h
