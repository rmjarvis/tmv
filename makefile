#CFLAGS1= -g -Wall -Werror -ansi -DNOBLAS -DNOFLOAT -DTMVFLDEBUG -DTMV_BLOCKSIZE=3
#ODIR= gcc-test
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DMKL -DNDEBUG
#ODIR= gcc
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DMKL
#ODIR= gcc-debug
CFLAGS1= -O3 -g -Wall -Werror -ansi -DNOBLAS -DNDEBUG
ODIR= gcc-noblas
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DNOBLAS
#ODIR= gcc-noblas-debug
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DATLAS -DNDEBUG
#ODIR= gcc-atlas
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DATLAS
#ODIR= gcc-atlas-debug
CC= /usr/bin/g++

#CFLAGS1= -O3 -g -Wall -Werror -ansi -DNOBLAS -DNOFLOAT -DTMVFLDEBUG -DTMV_BLOCKSIZE=3
#ODIR= gcc-3.4-test
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DNDEBUG -DMKL
#ODIR= gcc-3.4
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DMKL
#ODIR= gcc-3.4-debug
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DNOBLAS -DNDEBUG
#ODIR= gcc-3.4-noblas
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DNOBLAS
#ODIR= gcc-3.4-noblas-debug
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DATLAS -DNDEBUG
#ODIR= gcc-3.4-atlas
#CFLAGS1= -O3 -g -Wall -Werror -ansi -DATLAS
#ODIR= gcc-3.4-atlas-debug
#CC= /usr/bin/g++-3.4

#CFLAGS1= -wn3 -Kc++ -tpp7 -Werror -wd1476,1505 -DNOBLAS -DNOFLOAT -DTMVFLDEBUG -DTMV_BLOCKSIZE=5
#ODIR= icc-test
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DNOBLAS
#ODIR= icc-noblas
#CFLAGS1= -g -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNOBLAS -DNOFLOAT
#ODIR= icc-noblas-debug
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DNOBLAS -pg #-DTMV_BLOCKSIZE=64
#ODIR= icc-noblas-pg
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DNOBLAS -DLONGDOUBLE
#ODIR= icc-noblas-longdouble
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DMKL -DNOLAP #-DTMV_BLOCKSIZE=64
#ODIR= icc-nolap
#CFLAGS1= -g -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNOLAP -DMKL
#ODIR= icc-nolap-debug
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DMKL -DNOLAP -pg #-DTMV_BLOCKSIZE=64
#ODIR= icc-nolap-pg
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DMKL -DNOLAP -DLONGDOUBLE
#ODIR= icc-nolap-longdouble
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DMKL
#ODIR= icc
#CFLAGS1= -g -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DMKL -DNOFLOAT
#ODIR= icc-debug
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DMKL -pg
#ODIR= icc-pg
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -Werror -wd1476,1505 -DNDEBUG -DMKL -DLONGDOUBLE
#ODIR= icc-longdouble
...
$(BINDIR)/tmvtest: $(TMV_TESTO_FILES) $(ODIR)/libtmv.a 
...
$(ODIR)/TMV_SVDiv_B.o: TMV_SVDiv_B.cpp TMV_SVDiv.h TMV_SVDiv_B.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES)
	$(CC) $(CFLAGS) -c TMV_SVDiv_B.cpp -o $(ODIR)/TMV_SVDiv_B.o

$(ODIR)/TMV_SVDiv_C.o: TMV_SVDiv_C.cpp TMV_SVDiv.h TMV_SVDiv_C.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES)
...
$(ODIR)/TMV_LUDiv_A.o: TMV_LUDiv_A.cpp TMV_LUDiv.h TMV_LUDiv_A.inst $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_LUDiv_A.cpp -o $(ODIR)/TMV_LUDiv_A.o

$(ODIR)/TMV_LUDiv_B.o: TMV_LUDiv_B.cpp TMV_LUDiv.h TMV_LUDiv_B.inst $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_LUDiv_B.cpp -o $(ODIR)/TMV_LUDiv_B.o

$(ODIR)/TMV_LUDiv_C.o: TMV_LUDiv_C.cpp TMV_LUDiv.h TMV_LUDiv_C.inst $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
...
$(ODIR)/TMV_QRDiv_A.o: TMV_QRDiv_A.cpp TMV_QRDiv.h TMV_QRDiv_A.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_A.cpp -o $(ODIR)/TMV_QRDiv_A.o

$(ODIR)/TMV_QRDiv_B.o: TMV_QRDiv_B.cpp TMV_QRDiv.h TMV_QRDiv_B.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_B.cpp -o $(ODIR)/TMV_QRDiv_B.o

$(ODIR)/TMV_QRDiv_C.o: TMV_QRDiv_C.cpp TMV_QRDiv.h TMV_QRDiv_C.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_C.cpp -o $(ODIR)/TMV_QRDiv_C.o

$(ODIR)/TMV_QRDiv_D.o: TMV_QRDiv_D.cpp TMV_QRDiv.h TMV_QRDiv_D.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_D.cpp -o $(ODIR)/TMV_QRDiv_D.o

$(ODIR)/TMV_QRDiv_E.o: TMV_QRDiv_E.cpp TMV_QRDiv.h TMV_QRDiv_E.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_E.cpp -o $(ODIR)/TMV_QRDiv_E.o

$(ODIR)/TMV_QRDiv_F.o: TMV_QRDiv_F.cpp TMV_QRDiv.h TMV_QRDiv_F.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_F.cpp -o $(ODIR)/TMV_QRDiv_F.o

$(ODIR)/TMV_QRPDiv.o: TMV_QRPDiv.cpp TMV_QRPDiv.h TMV_QRPDiv.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRPDiv.cpp -o $(ODIR)/TMV_QRPDiv.o

$(ODIR)/TMV_QRPDiv_A.o: TMV_QRPDiv_A.cpp TMV_QRPDiv.h TMV_QRPDiv_A.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRPDiv_A.cpp -o $(ODIR)/TMV_QRPDiv_A.o

$(ODIR)/TMV_QRPDiv_B.o: TMV_QRPDiv_B.cpp TMV_QRPDiv.h TMV_QRPDiv_B.inst TMV_Householder.h TMV_Givens.h $(TMV_DIAGH_FILES) $(TMV_TRIHFILES)
...
$(ODIR)/TMV_BandQRDiv_C.o: TMV_BandQRDiv_C.cpp TMV_BandQRDiv.h TMV_BandQRDiv_C.inst TMV_Householder.h $(TMV_BANDH_FILES)
...
$(ODIR)/TMV_BandSVDiv_B.o: TMV_BandSVDiv_B.cpp TMV_BandSVDiv.h TMV_BandSVDiv_B.inst TMV_Householder.h $(TMV_BANDH_FILES)
...
$(ODIR)/TMV_SymMatrixArith_H.o: TMV_SymMatrixArith_H.cpp TMV_SymMatrixArith_H.inst $(TMV_SYMH_FILES) 
	$(CC) $(CFLAGS) -c TMV_SymMatrixArith_H.cpp -o $(ODIR)/TMV_SymMatrixArith_H.o

$(ODIR)/TMV_SymMatrixArith_I.o: TMV_SymMatrixArith_I.cpp TMV_SymMatrixArith_I.inst $(TMV_SYMH_FILES) 
	$(CC) $(CFLAGS) -c TMV_SymMatrixArith_I.cpp -o $(ODIR)/TMV_SymMatrixArith_I.o
...
$(ODIR)/TMV_SymSVDiv_A.o: TMV_SymSVDiv_A.cpp TMV_SymSVDiv.h TMV_SymSVDiv_A.inst TMV_Householder.h TMV_Givens.h $(TMV_SYMH_FILES)
	$(CC) $(CFLAGS) -c TMV_SymSVDiv_A.cpp -o $(ODIR)/TMV_SymSVDiv_A.o

$(ODIR)/TMV_SymSVDiv_B.o: TMV_SymSVDiv_B.cpp TMV_SymSVDiv.h TMV_SymSVDiv_B.inst TMV_Householder.h TMV_Givens.h $(TMV_SYMH_FILES)
...
$(ODIR)/TMV_SymCHDiv_A.o: TMV_SymCHDiv_A.cpp TMV_SymCHDiv.h TMV_SymCHDiv_A.inst TMV_Householder.h TMV_Givens.h $(TMV_SYMH_FILES)
	$(CC) $(CFLAGS) -c TMV_SymCHDiv_A.cpp -o $(ODIR)/TMV_SymCHDiv_A.o

$(ODIR)/TMV_SymCHDiv_B.o: TMV_SymCHDiv_B.cpp TMV_SymCHDiv.h TMV_SymCHDiv_B.inst TMV_Householder.h TMV_Givens.h $(TMV_SYMH_FILES)
