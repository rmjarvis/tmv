...
namespace tmv {
  ...
  template <class T, int M, int N> class SmallMatrixComposite : 
  ...
  template <class T, int M, int N, StorageType S, IndexStyle I, class Tx> 
  ...
  template <class T, class T1, int M, int N, int Si1, int Sj1, bool C1> class ProdXm : 
...
#define Y ,int M, int N, int Si1, int Sj1, bool C1
...
#undef GENMATRIX
  ...
  template <class T, class T1, int N, int Si1, int Sj1, bool C1> 
    class SummX_1 : 
	    ...
	    const int Si, const int Sj) const
	{
	  ...
	  const int Sd = Si+Sj;
	  Copy(m,mp,Si,Sj);
	  for(int i=0,ii=0;i<N;++i,ii+=Sd) mp[ii] += REAL(x2);
	}
	inline void DoAssignTom(ComplexType(T)* mp,
	    const int Si, const int Sj, const bool C) const
	{
	  ...
	  if (C) {
	    ...
	    for(int i=0,ii=0;i<N;++i,ii+=Sd) mp[ii] += CONJ(ComplexType(T)(x2));
	  } else {
	    Copy(m,mp,Si,Sj);
	    for(int i=0,ii=0;i<N;++i,ii+=Sd) mp[ii] += ComplexType(T)(x2);
	  }
	}
      private:
  ...
  // m+=x
  template <class T, int N, int Si, int Sj, bool C> 
...
#define Y ,int N, int Si1, int Sj1, bool C1
...
#undef PRODXM
  ...
  template <class T, class T1, class T2, int M, int N, int S1, bool C1, int S2, bool C2> 
    class OProdvv_1 : 
      public SmallMatrixComposite<T,M,N>
    {
      public:
  ...
  // m+=(v^v)
  template <class T, class T1, class T2, int M, int N, int Si0, int Sj0, bool C0, int S1, bool C1, int S2, bool C2> 
  ...
  template <class T, int M, int N, int Si0, int Sj0, bool C0, int S1, bool C1, int S2, bool C2> 
  ...
  template <class T, class T1, class T2, int M, int N, int Si0, int Sj0, bool C0> 
    inline const SmallMatrixView<T,M,N,Si0,Sj0,C0>& operator+=(
	const SmallMatrixView<T,M,N,Si0,Sj0,C0>& m0,
  ...
  template <class T, int M, int N, int Si0, int Sj0, bool C0> 
    inline const SmallMatrixView<CT,M,N,Si0,Sj0,C0>& operator+=(
	const SmallMatrixView<CT,M,N,Si0,Sj0,C0>& m0, 
...
#define Y ,int M,int N,int S1,bool C1,int S2,bool C2
...
#undef PRODXv2
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Summm_1_1 : 
    public SmallMatrixComposite<T,M,N> 
  {
    public:
      inline Summm_1_1(
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Summm_1_m1 : 
    public SmallMatrixComposite<T,M,N> 
  {
    public:
      inline Summm_1_m1(
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Summm_1_x : 
    public SmallMatrixComposite<T,M,N> 
  {
    public:
      inline Summm_1_x(
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Summm_x_1 : 
    public SmallMatrixComposite<T,M,N> 
  {
    public:
      inline Summm_x_1(
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Summm_x_m1 : 
    public SmallMatrixComposite<T,M,N> 
  {
    public:
      inline Summm_x_m1(
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Summm : 
    public SmallMatrixComposite<T,M,N> 
  {
    public:
  ...
  template <class T, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> 
  ...
  template <class T, class T2, int M, int N, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> 
    inline const SmallMatrixView<T,M,N,Si1,Sj1,C1>& operator+=(
  ...
  template <class T, class T2, int M, int N, int Si1, int Sj1, bool C1> 
    inline const SmallMatrixView<T,M,N,Si1,Sj1,C1>& operator+=(
...
#define Y ,int M,int N,int Si1,int Sj1,bool C1,int Si2,int Sj2,bool C2
...
#undef PRODXM2
  ...
  template <class T, class T1, class T2, int M, int N, int K, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Prodmm_1 : 
    public SmallMatrixComposite<T,M,N>
  {
    public:
      inline Prodmm_1(
  ...
  template <class T, class T1, class T2, int M, int N, int K, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2> class Prodmm : 
    public SmallMatrixComposite<T,M,N>
  {
    public:
  ...
  template <class T, class T2, class T3, int M, int N, int K, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2, int Si3, int Sj3, bool C3>
    inline const SmallMatrixView<T,M,N,Si1,Sj1,C1>& operator+=(
	const SmallMatrixView<T,M,N,Si1,Sj1,C1>& m, 
	const Prodmm_1<T,T2,T3,M,N,K,Si2,Sj2,C2,Si3,Sj3,C3>& pmm)
    { AddMultMM_1(pmm.GetM1(),pmm.GetM2(),m); return m; }

  template <class T, int M, int N, int K, int Si1, int Sj1, bool C1, int Si2, int Sj2, bool C2, int Si3, int Sj3, bool C3>
    inline const SmallMatrixView<CT,M,N,Si1,Sj1,C1>& operator+=(
	const SmallMatrixView<CT,M,N,Si1,Sj1,C1>& m, 
  ...
  template <class T, class T2, class T3, int M, int N, int K, int Si1, int Sj1, bool C1>
    inline const SmallMatrixView<T,M,N,Si1,Sj1,C1>& operator+=(
	const SmallMatrixView<T,M,N,Si1,Sj1,C1>& m, 
  ...
  template <class T, int M, int N, int K, int Si1, int Sj1, bool C1>
    inline const SmallMatrixView<CT,M,N,Si1,Sj1,C1>& operator+=(
	const SmallMatrixView<CT,M,N,Si1,Sj1,C1>& m, 
...
#define Y ,int M,int N,int K,int Si1,int Sj1,bool C1,int Si2,int Sj2,bool C2
...
#undef PRODXM2
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int S2, bool C2> class Prodmv_1 :
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int S2, bool C2> class Prodmv :
    public SmallVectorComposite<T,M>
  {
    public:
  ...
  template <class T, int N, int Si1, int Sj1, bool C1, int S2, bool C2> 
  ...
  template <class T, class T1, int N, int Si1, int Sj1, bool C1, int S2, bool C2> 
    inline const SmallVectorView<T,N,S2,C2>& operator*=(
	const SmallVectorView<T,N,S2,C2>& v,
  ...
  template <class T, class T1, class T2, int M, int N, int Si1, int Sj1, bool C1, int S2, bool C2, int S3, bool C3> 
  ...
  template <class T, int M, int N, int Si1, int Sj1, bool C1, int S2, bool C2, int S3, bool C3> 
  ...
  template <class T, int N, int S2, bool C2> 
    inline const SmallVectorView<T,N,S2,C2>& operator*=(
  ...
  template <class T, class T1, int N, int S2, bool C2> 
    inline const SmallVectorView<T,N,S2,C2>& operator*=(
  ...
  template <class T, class T1, class T2, int M, int N, int S3, bool C3> 
    inline const SmallVectorView<T,M,S3,C3>& operator+=(
	const SmallVectorView<T,M,S3,C3>& v, 
  ...
  template <class T, int M, int N, int S3, bool C3> 
    inline const SmallVectorView<CT,M,S3,C3>& operator+=(
	const SmallVectorView<CT,M,S3,C3>& v,
...
#define Y ,int M,int N,int Si1,int Sj1,bool C1,int S2,bool C2
