...
#define MIN(M,N) (M<N ? M : N)
  ...
  template <class T, int M, int N, StorageType S=RowMajor, IndexStyle I=CStyle> 
    class SmallMatrix;

  template <class T1, class T2, int M, int N, int Si1, int Sj1, int Si2, int Sj2, bool C1> 
    inline void Copy(
  ...
  template <class T1, class T2, int M, int N, int Si1, int Sj1, bool C1> 
    inline void Copy(
	const GenSmallMatrix<T1,M,N,Si1,Sj1,C1>& m1, 
	T2* m2p, const int Si2, const int Sj2);

  template <class T, int M, int N> struct AssignableToSmallMatrix :
...
//#define GENBASE
  ...
  template <class T, int M, int N, int Si, int Sj, bool C> 
...
#endif
	inline ConstSmallVectorView<T,N,Sj,C> row(int i) const 
	{ 
	  TMVAssert(i>=0 && i<M);
	  return ConstSmallVectorView<T,N,Sj,C>(cptr()+i*Si); 
	}

	inline ConstSmallVectorView<T,M,Si,C> col(int j) const
	{
	  TMVAssert(j>=0 && j<N);
	  return ConstSmallVectorView<T,M,Si,C>(cptr()+j*Sj); 
	}
	...
	inline ConstSmallVectorView<T,N,Sj,C> operator[](int i) const
	{ 
	  TMVAssert(i>=0 && i<M);
	  return row(i); 
	}
	...
	inline void Write(std::ostream& os, RealType(T) thresh) const
	{
	  ...
	  for(int i=0;i<M;++i) {
	    os << "( ";
	    for(int j=0;j<N;++j) 
	      os << ' '<<(ABS(row(i)[j])<thresh ? T(0) : row(i)[j])<<' ';
	    os << " )\n";
	  }
	}
	...
	inline GenSmallMatrix<T,M,N,Si,Sj,C>& operator=(
  ...
  template <class T, int M, int N, int Si, int Sj, bool C, IndexStyle I> 
	...
	inline ConstSmallMatrixView<T,M,N,Si,Sj,C,I>& operator=(
  ...
  template <class T, int M, int N, int Si, int Sj, bool C> 
	...
	inline ConstSmallVectorView<T,N,Sj,C,FortranStyle> row(int i) const 
	{ 
	  TMVAssert(i>0 && i<=M);
	  return GenSmallMatrix<T,M,N,Si,Sj,C>::row(i-1);
	}

	inline ConstSmallVectorView<T,M,Si,C,FortranStyle> col(int j) const
	{
	  TMVAssert(j>0 && j<=N);
	...
	inline ConstSmallMatrixView<T,M,N,Si,Sj,C,FortranStyle>& operator=(
  ...
  template <class T, int M, int N, int Si, int Sj, bool C, IndexStyle I> 
	...
	inline const SmallMatrixView<T,M,N,Si,Sj,C,I>& operator=(
	    const SmallMatrixView<T,M,N,Si,Sj,C,I>& m2)
	{ Copy(m2,*this); return *this; }
	...
	inline SmallVectorView<T,N,Sj,C,I> operator[](int i) const 
	{ 
	  TMVAssert(I==CStyle);
	  TMVAssert(i>=0 && i<M);
	  return row(i); 
	...
	inline SmallVectorView<T,N,Sj,C,I> row(int i) const
	{
	  TMVAssert(I==CStyle);
	  TMVAssert(i>=0 && i<M);
	  return SmallVectorView<T,N,Sj,C,I>(ptr()+i*Si FIRSTLAST );
	}

	inline SmallVectorView<T,M,Si,C,I> col(int j) const
	{
	  TMVAssert(I==CStyle);
	  TMVAssert(j>=0 && j<N);
	  return SmallVectorView<T,M,Si,C,I>(ptr()+j*Sj FIRSTLAST ); 
	}
  ...
  template <class T, int M, int N, int Si, int Sj, bool C> 
	...
	inline const SmallMatrixView<T,M,N,Si,Sj,C,FortranStyle>& operator=(
	    const SmallMatrixView<T,M,N,Si,Sj,C,FortranStyle>& m2) 
	{ SmallMatrixView<T,M,N,Si,Sj,C,CStyle>::operator=(m2); return *this; }
	...
	inline SmallVectorView<T,N,Sj,C,FortranStyle> row(int i) const
	{
	  TMVAssert(i>0 && i<=M);
	  return SmallMatrixView<T,M,N,Si,Sj,C,CStyle>::row(i-1);
	}

	inline SmallVectorView<T,M,Si,C,FortranStyle> col(int j) const
	{
	  TMVAssert(j>0 && j<=N);
	...
	inline const SmallMatrixView<T,M,N,Si,Sj,C,FortranStyle>& 
	  ReversePermuteRows(const int* p, int i1, int i2) const
	  { 
	    TMVAssert(i1>0);
	...
	inline const SmallMatrixView<T,M,N,Si,Sj,C,FortranStyle>& 
	  ReversePermuteRows(const int* p) const
	  {
...
#define NEW_SIZE 
	...
	{ 
	  ...
	  TMVAssert(N>0);
	  TMVAssert(S==RowMajor || S==ColMajor);
	  memmove(itsm,rhs.itsm,M*N*sizeof(T));
	}
...
#undef NEW_SIZE
	...
	{ 
	  if (&m2 != this) memmove(itsm,m2.itsm,M*N*sizeof(T));
	  return *this; 
	}
	...
	inline ConstSmallVectorView<T,N,Sj,false,I> row(int i) const 
	{ return View().row(i); }

	inline ConstVectorView<T,I> row(int i, int j1, int j2) const 
	{ return View().row(i,j1,j2); }

	inline ConstSmallVectorView<T,N,Sj,false,I> operator[](int i) const
	{ return View().row(i); }

	inline ConstSmallVectorView<T,M,Si,false,I> col(int j) const
	{ return View().col(j); }
	...
	inline SmallVectorView<T,N,Sj,false,I> row(int i)
	{ return View().row(i); }

	inline VectorView<T,I> row(int i, int j1, int j2)
	{ return View().row(i,j1,j2); }

	inline SmallVectorView<T,N,Sj,false,I> operator[](int i)
	{ return View().row(i); }

	inline SmallVectorView<T,M,Si,false,I> col(int j)
	{ return View().col(j); }
	...
	{ return MatrixView<T,I>(ptr(),M,N,Si,Sj,S,NonConj,M*N FIRSTLAST); }
...
//---------------------------------------------------------------------------
  ...
  template <class T, int N, int S, bool C> 
    inline ConstSmallMatrixView<T,1,N,0,S,C> RowVectorViewOf(
	const GenSmallVector<T,N,S,C>& v)
    { return ConstSmallMatrixView<T,1,N,0,S,C>(v.cptr()); }

  template <class T, int N, int S, bool C, IndexStyle I> 
    inline ConstSmallMatrixView<T,1,N,0,S,C,I> RowVectorViewOf(
	const ConstSmallVectorView<T,N,S,C,I>& v)
    { return ConstSmallMatrixView<T,1,N,0,S,C,I>(v.cptr()); }
  ...
  template <class T, int N, int S, bool C, IndexStyle I> 
    inline SmallMatrixView<T,1,N,0,S,false,I> RowVectorViewOf(
      const SmallVectorView<T,N,S,C,I>& v)
    {
      return SmallMatrixView<T,1,N,0,S,false,I>(v.ptr()
	  FIRSTLAST1(v.first,v.last) );
    }
  ...
  template <class T, int M, int S, bool C> 
    inline ConstSmallMatrixView<T,M,1,S,0,C> ColVectorViewOf(
	const GenSmallVector<T,M,S,C>& v)
    { return ConstSmallMatrixView<T,M,1,S,0,C>(v.cptr()); }

  template <class T, int M, int S, bool C, IndexStyle I> 
    inline ConstSmallMatrixView<T,M,1,S,0,C,I> ColVectorViewOf(
	const ConstSmallVectorView<T,M,S,C,I>& v)
    { return ConstSmallMatrixView<T,M,1,S,0,C,I>(v.cptr()); }

  template <class T, int M, IndexStyle I> 
  ...
  template <class T, int M, int S, bool C, IndexStyle I> 
    inline SmallMatrixView<T,M,1,S,0,false,I> ColVectorViewOf(
      const SmallVectorView<T,M,S,C,I>& v)
    {
      return SmallMatrixView<T,M,1,S,0,false,I>(v.ptr()
	  FIRSTLAST1(v.first,v.last) );
    }
...
#define Si (S==RowMajor?N:1)
#define Sj (S==RowMajor?1:M)
  template <int M, int N, StorageType S, IndexStyle I, class T> 
...
#undef Sj
  ...
  template <class T1, class T2, int M, int N, int Si1, int Sj1, int Si2, int Sj2, bool C1> 
	...
	for(int j=0;j<N;++j) Copy(m1.col(j),m2.col(j));
      else
	for(int i=0;i<M;++i) Copy(m1.row(i),m2.row(i));
    }
  template <class T1, class T2, int M, int N, int Si1, int Sj1, bool C1> 
    inline void Copy(
	const GenSmallMatrix<T1,M,N,Si1,Sj1,C1>& m1, 
  ...
  template <class T, int M, int N, int Si1, int Sj1, int Si2, int Sj2, bool C1, bool C2> 
    inline void Swap(
  ...
  template <class T, int M, int N, int Si1, int Sj1, bool C1, StorageType S2, IndexStyle I2> 
    inline void Swap(
	const SmallMatrixView<T,M,N,Si1,Sj1,C1>& m1, 
	SmallMatrix<T,M,N,S2,I2>& m2)
    { Swap(m1,m2.View()); }

  template <class T, int M, int N, StorageType S1, IndexStyle I1, int Si2, int Sj2, bool C2> 
    inline void Swap(
...
#undef Sj
  ...
  template <class T1, class T2, int M, int N, int Si1, int Sj1, int Si2, int Sj2, bool C1, bool C2> 
	...
	for(int j=0;j<N;++j) if (m1.col(j) != m2.col(j)) return false;
	return true;
      }
      else {
	for(int i=0;i<M;++i) if (m1.row(i) != m2.row(i)) return false;
	return true;
      }
    }
