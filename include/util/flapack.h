...
double zlange_(const char& norm, const int& m, const int& n, 
    const cdouble *a, const int& lda, double *work);
float clange_(const char& norm, const int& m, const int& n, 
    const cfloat *a, const int& lda, float *work);

double dlangb_(const char& norm, const int& n, const int& kl, const int& ku, 
    const double *ab, const int& ldab, double *work);
float slangb_(const char& norm, const int& n, const int& kl, const int& ku, 
    const float *ab, const int& ldab, float *work);
double zlangb_(const char& norm, const int& n, const int& kl, const int& ku, 
    const cdouble *ab, const int& ldab, double *work);
float clangb_(const char& norm, const int& n, const int& kl, const int& ku, 
    const cfloat *ab, const int& ldab, float *work);

double dlangt_(const char& norm, const int& n,
    const double *dl, const double *d, const double *du);
float slangt_(const char& norm, const int& n,
    const float *dl, const float *d, const float *du);
double zlangt_(const char& norm, const int& n,
    const cdouble *dl, const cdouble *d, const cdouble *du);
float clangt_(const char& norm, const int& n,
    const cfloat *dl, const cfloat *d, const cfloat *du);
...
double dlansb_(const char& norm, const char& uplo,
    const int& n, const int& k,
    const double *ab, const int& ldab, double *work);
float slansb_(const char& norm, const char& uplo,
    const int& n, const int& k,
    const float *ab, const int& ldab, float *work);
double zlansb_(const char& norm, const char& uplo,
    const int& n, const int& k,
    const cdouble *ab, const int& ldab, double *work);
double zlanhb_(const char& norm, const char& uplo,
    const int& n, const int& k,
    const cdouble *ab, const int& ldab, double *work);
float clansb_(const char& norm, const char& uplo,
    const int& n, const int& k, 
    const cfloat *ab, const int& ldab, float *work);
float clanhb_(const char& norm, const char& uplo,
    const int& n, const int& k, 
    const cfloat *ab, const int& ldab, float *work);

int dlaswp_(const int& n, double* a, const int& lda, 
...
int cgelss_(int *m, int *n, int *nrhs, void *
	a, int *lda, void *b, int *ldb, float *s, float *rcond, 
	int *rank, void *work, int *lwork, float *rwork, int *
	info);

int cgesdd_(char *jobz, int *m, int *n, void *a, 
	int *lda, float *s, void *u, int *ldu, void *vt, int 
	*ldvt, void *work, int *lwork, float *rwork, int *iwork, 
	int *info);

int cgesvd_(char *jobu, char *jobvt, int *m, int *n, 
	void *a, int *lda, float *s, void *u, int *ldu, void *
	vt, int *ldvt, void *work, int *lwork, float *rwork, 
	int *info);

int chbgvd_(char *jobz, char *uplo, int *n, int *ka, 
	int *kb, void *ab, int *ldab, void *bb, int *ldbb, 
	float *w, void *z__, int *ldz, void *work, int *lwork, 
	float *rwork, int *lrwork, int *iwork, int *liwork, 
	int *info);

int chetd2_(char *uplo, int *n, void *a, int *lda,
	 float *d__, float *e, void *tau, int *info);

void cladiv_(void * ret_val, void *x, void *y);

int clalsd_(char *uplo, int *smlsiz, int *n, int 
	*nrhs, float *d__, float *e, void *b, int *ldb, float *rcond, 
	int *rank, void *work, float *rwork, int *iwork, 
	int *info);

double clanhp_(char *norm, char *uplo, int *n, void *ap, 
	float *work);

double clanhs_(char *norm, int *n, void *a, int *lda, 
	float *work);

double clanht_(char *norm, int *n, float *d__, void *e);

double clansp_(char *norm, char *uplo, int *n, void *ap, 
	float *work);

double clantp_(char *norm, char *uplo, char *diag, int *n, 
	void *ap, float *work);

int cpteqr_(char *compz, int *n, float *d__, float *e, 
	void *z__, int *ldz, float *work, int *info);

int cstegr_(char *jobz, char *range, int *n, float *d__, 
	float *e, float *vl, float *vu, int *il, int *iu, float *abstol, 
	int *m, float *w, void *z__, int *ldz, int *isuppz, 
...
double dlanhs_(char *norm, int *n, double *a, int *lda, 
	double *work);
...
double dlantp_(char *norm, char *uplo, char *diag, int *n, 
...
double dzsum1_(int *n, void *cx, int *incx);

double scsum1_(int *n, void *cx, int *incx);
...
double slansp_(char *norm, char *uplo, int *n, float *ap, float *work);
...
double slapy3_(float *x, float *y, float *z__);

int zgelsd_(int *m, int *n, int *nrhs, 
	void *a, int *lda, void *b, int *ldb, 
	double *s, double *rcond, int *rank, void *work, 
	int *lwork, double *rwork, int *iwork, int *info);

int zgesdd_(char *jobz, int *m, int *n, 
	void *a, int *lda, double *s, void *u, 
	int *ldu, void *vt, int *ldvt, void *work, 
	int *lwork, double *rwork, int *iwork, int *info);
...
int zhbgvd_(char *jobz, char *uplo, int *n, int *ka, 
	int *kb, void *ab, int *ldab, void *bb, 
	int *ldbb, double *w, void *z__, int *ldz, 
	void *work, int *lwork, double *rwork, 
	int *lrwork, int *iwork, int *liwork, int *info);

int zhetd2_(char *uplo, int *n, void *a, 
	int *lda, double *d__, double *e, void *tau, 
	int *info);

void zladiv_(void * ret_val, void *x, 
	void *y);

int zlalsd_(char *uplo, int *smlsiz, int *n, int 
	*nrhs, double *d__, double *e, void *b, int *ldb,
	double *rcond, int *rank, void *work, 
	double *rwork, int *iwork, int *info);

double zlanhp_(char *norm, char *uplo, int *n, void *ap, 
	double *work);

double zlanhs_(char *norm, int *n, void *a, int *lda, 
	double *work);

double zlanht_(char *norm, int *n, double *d__, void *e);

double zlansp_(char *norm, char *uplo, int *n, void *ap, 
	double *work);

double zlantp_(char *norm, char *uplo, char *diag, int *n, 
	void *ap, double *work);
...
int zstegr_(char *jobz, char *range, int *n, 
	double *d__, double *e, double *vl, double *vu, 
	int *il, int *iu, double *abstol, int *m, double *w, 
	void *z__, int *ldz, int *isuppz, double *work, 
	int *lwork, int *iwork, int *liwork, int *info);
