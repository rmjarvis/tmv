...
template <class T, class T1, class T2 Y> inline PRODMM<T,T1,T2 X3> operator*(
    T x, const PRODMM<T,T1,T2 X3>& pmm)
{ return PRODMM<T,T1,T2 X3>(x*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    CT x, const PRODMM<T,T,T X3>& pmm)
{ return PRODMM<CT,T,T X3>(x*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    CCT x, const PRODMM<T,T,T X3>& pmm)
{ return PRODMM<CT,T,T X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    VCT x, const PRODMM<T,T,T X3>& pmm)
{ return PRODMM<CT,T,T X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    T x, const PRODMM<CT,T1,T2 X3>& pmm)
{ return PRODMM<CT,T1,T2 X3>(x*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    CCT x, const PRODMM<CT,T1,T2 X3>& pmm)
{ return PRODMM<CT,T1,T2 X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    VCT x, const PRODMM<CT,T1,T2 X3>& pmm)
{ return PRODMM<CT,T1,T2 X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

// (x*m*m)*x
template <class T, class T1, class T2 Y> inline PRODMM<T,T1,T2 X3> operator*(
    const PRODMM<T,T1,T2 X3>& pmm, T x)
{ return PRODMM<T,T1,T2 X3>(x*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    const PRODMM<T,T,T X3>& pmm, CT x)
{ return PRODMM<CT,T,T X3>(x*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    const PRODMM<T,T,T X3>& pmm, CCT x)
{ return PRODMM<CT,T,T X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    const PRODMM<T,T,T X3>& pmm, VCT x)
{ return PRODMM<CT,T,T X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    const PRODMM<CT,T1,T2 X3>& pmm, T x)
{ return PRODMM<CT,T1,T2 X3>(x*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    const PRODMM<CT,T1,T2 X3>& pmm, CCT x)
{ return PRODMM<CT,T1,T2 X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    const PRODMM<CT,T1,T2 X3>& pmm, VCT x)
{ return PRODMM<CT,T1,T2 X3>(CT(x)*pmm.GetX(),pmm.GetM1(),pmm.GetM2()); }
...
// x*(x*m*m)
template <class T, class T1, class T2 Y> inline PRODMM<T,T1,T2 X3> operator*(
    T x, const PRODMM_1<T,T1,T2 X3>& pmm)
{ return PRODMM<T,T1,T2 X3>(x,pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    CT x, const PRODMM_1<T,T,T X3>& pmm)
{ return PRODMM<CT,T,T X3>(x,pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    CCT x, const PRODMM_1<T,T,T X3>& pmm)
{ return PRODMM<CT,T,T X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    VCT x, const PRODMM_1<T,T,T X3>& pmm)
{ return PRODMM<CT,T,T X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    T x, const PRODMM_1<CT,T1,T2 X3>& pmm)
{ return PRODMM<CT,T1,T2 X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    CCT x, const PRODMM_1<CT,T1,T2 X3>& pmm)
{ return PRODMM<CT,T1,T2 X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    VCT x, const PRODMM_1<CT,T1,T2 X3>& pmm)
{ return PRODMM<CT,T1,T2 X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

// (x*m*m)*x
template <class T, class T1, class T2 Y> inline PRODMM<T,T1,T2 X3> operator*(
    const PRODMM_1<T,T1,T2 X3>& pmm, T x)
{ return PRODMM<T,T1,T2 X3>(x,pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    const PRODMM_1<T,T,T X3>& pmm, CT x)
{ return PRODMM<CT,T,T X3>(x,pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    const PRODMM_1<T,T,T X3>& pmm, CCT x)
{ return PRODMM<CT,T,T X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T Y> inline PRODMM<CT,T,T X3> operator*(
    const PRODMM_1<T,T,T X3>& pmm, VCT x)
{ return PRODMM<CT,T,T X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    const PRODMM_1<CT,T1,T2 X3>& pmm, T x)
{ return PRODMM<CT,T1,T2 X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    const PRODMM_1<CT,T1,T2 X3>& pmm, CCT x)
{ return PRODMM<CT,T1,T2 X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }

template <class T, class T1, class T2 Y> inline PRODMM<CT,T1,T2 X3> operator*(
    const PRODMM_1<CT,T1,T2 X3>& pmm, VCT x)
{ return PRODMM<CT,T1,T2 X3>(CT(x),pmm.GetM1(),pmm.GetM2()); }
