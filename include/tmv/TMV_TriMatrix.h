...
//        with all values = x
//
//    TriMatrix<T,A>(size_t n, T* vv)
//    TriMatrix<T,A>(size_t n, const std::vector<T>& vv)
//        Makes a Triangular Matrix with column size = row size = n
...
namespace tmv {
    ...
    struct Traits<UpperTriMatrix<T,A0,A1,A2> >
    {
        ...
        typedef typename TypeSelect< (iscomplex && (_colmajor||_rowmajor)) ,
                ConstSmallUpperTriMatrixView<real_type,UNKNOWN,twoSi,twoSj,twosAc> ,
        ...
        typedef typename TypeSelect< (iscomplex && (_colmajor||_rowmajor)) ,
                SmallUpperTriMatrixView<real_type,UNKNOWN,twoSi,twoSj,twosAc> ,
    ...
    public:
        ...
        {
            TMVStaticAssert(Traits<type>::okA);
            VectorView<T,Unit> lv(ptr(),n*n);
            ConstVectorView<T,Unit>(vv,n*n).newAssignTo(lv);
        }
            ...
            itss(n), itsm(n*n)
        {
            ...
            VectorView<T,Unit> lv(ptr(),n*n);
            ConstVectorView<T,Unit>(&vv[0],n*n).newAssignTo(lv);
        }
    ...
    struct Traits<LowerTriMatrix<T,A0,A1,A2> >
    {
        ...
        typedef typename TypeSelect< (iscomplex && (_colmajor||_rowmajor)) ,
                ConstSmallLowerTriMatrixView<real_type,UNKNOWN,twoSi,twoSj,twosAc> ,
        ...
        typedef typename TypeSelect< (iscomplex && (_colmajor||_rowmajor)) ,
                SmallLowerTriMatrixView<real_type,UNKNOWN,twoSi,twoSj,twosAc> ,
