...
namespace tmv {
  ...
  void MultMM(const T alpha, const GenDiagMatrix<Ta>& A, 
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const T alpha, const GenDiagMatrix<Ta>& A, 
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const CT , const GenDiagMatrix<Ta>& , 
