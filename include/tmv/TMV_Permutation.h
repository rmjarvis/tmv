...
namespace tmv {
    ...
    public:
        ...
        template <class M>
        friend inline void LU_Decompose(BaseMatrix_Rec_Mutable<M>& m, Permutation& P);
        ...
        template <class M>
        friend inline void BandLU_Decompose(BaseMatrix_Band_Mutable<M>& m, Permutation& P);
