...
namespace tmv {
  ...
  void Tri_LDivEq(const GenUpperTriMatrix<T1>& A, const VectorView<T>& v);

  template <class T, class T1> 
  void Tri_LDivEq(const GenLowerTriMatrix<T1>& A, const VectorView<T>& v);

  template <class T, class T1> 
  void Tri_LDivEq(const GenUpperTriMatrix<T1>& A, const MatrixView<T>& m);

  template <class T, class T1> 
  void Tri_LDivEq(const GenLowerTriMatrix<T1>& A, const MatrixView<T>& m);
  ...
  template <class T> 
  void Tri_Inverse(const UpperTriMatrixView<T>& minv);
