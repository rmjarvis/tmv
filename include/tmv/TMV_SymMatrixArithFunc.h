...
namespace tmv {
  ...
  void MultMV(const T alpha, const GenSymMatrix<Ta>& A, 
  ...
  inline void AddMM(const T alpha, const GenSymMatrix<Ta>& A,
      const SymMatrixView<T>& B)
  { AddMM(alpha,A.UpperTri(),B.UpperTri()); }
  template <class T, class Ta> 
  void AddMM(const T alpha, const GenSymMatrix<Ta>& A, const MatrixView<T>& B);
  ...
  template <class T, class Ta, class Tb> 
  void AddMM(const T alpha, const GenSymMatrix<Ta>& A, 
  ...
  void MultMM(const T alpha, const GenSymMatrix<Ta>& A, 
  ...
  void Rank1Update(const T alpha, const GenVector<Tx>& x,
      const SymMatrixView<T>& A);

  // B (+)= alpha * (A * AT) (or At if B is Herm)
  template <bool add, class T, class Ta> 
  void RankKUpdate(const T alpha, const GenMatrix<Ta>& A,
      const SymMatrixView<T>& B);

  template <bool add, class T, class Ta> 
  void RankKUpdate(const T alpha, const GenLowerTriMatrix<Ta>& A, 
      const SymMatrixView<T>& B);
  template <bool add, class T, class Ta> 
  void RankKUpdate(const T alpha, const GenUpperTriMatrix<Ta>& A, 
      const SymMatrixView<T>& B);
  ...
  void Rank2Update(const T alpha, const GenVector<Tx>& x,
      const GenVector<Ty>& y, const SymMatrixView<T>& A);

  // C (+)= alpha * (A * BT + B*AT) (or A*Bt + B*At if C is Herm)
  template <bool add, class T, class Ta, class Tb> 
  void Rank2KUpdate(const T alpha, const GenMatrix<Ta>& A,
  ...
  template <bool add, class T, class Ta, class Tb> 
  void SymMultMM(const T alpha, const GenMatrix<Ta>& A,
      const GenMatrix<Tb>& B, const SymMatrixView<T>& C);
  ...
  template <bool add, class T, class Ta, class Tx> 
  inline void MultMV(const T alpha, const GenSymMatrix<Ta>& A, 
  ...
  { AddMM(beta,B,alpha,A,C); }
  template <class T> 
  inline void AddMM(const CT alpha, const GenSymMatrix<CT>& A, 
      const CT beta, const GenSymMatrix<T>& B, const MatrixView<CT>& C)
  { AddMM(beta,B,alpha,A,C); }

  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const T alpha, const GenSymMatrix<Ta>& A, 
  ...
  template <bool add, class T, class Tx> 
  inline void Rank1Update(const T alpha, const GenVector<Tx>& x,
      const SymMatrixView<CT>& A)
  { Rank1Update<add>(CT(alpha),x,A); }
  template <bool add, class T, class Ta> 
  inline void RankKUpdate(const T alpha, const GenMatrix<Ta>& A,
      const SymMatrixView<CT>& B)
  { RankKUpdate<add>(CT(alpha),A,B); }
  template <bool add, class T, class Ta> 
  inline void RankKUpdate(const T alpha, const GenLowerTriMatrix<Ta>& A, 
      const SymMatrixView<CT>& B)
  { RankKUpdate<add>(CT(alpha),A,B); }
  template <bool add, class T, class Ta> 
  inline void RankKUpdate(const T alpha, const GenUpperTriMatrix<Ta>& A, 
      const SymMatrixView<CT>& B)
  { RankKUpdate<add>(CT(alpha),A,B); }

  template <bool add, class T, class Tx, class Ty> 
  inline void Rank2Update(const T alpha, const GenVector<Tx>& x,
      const GenVector<Ty>& y, const SymMatrixView<CT>& A)
  { Rank2Update<add>(CT(alpha),x,y,A); }
  template <bool add, class T, class Ta, class Tb> 
  inline void Rank2KUpdate(const T alpha, const GenMatrix<Ta>& A,
      const GenMatrix<Tb>& B, const SymMatrixView<CT>& C)
  { Rank2KUpdate<add>(CT(alpha),A,B,C); }

  template <bool add, class T, class Ta, class Tb> 
  inline void SymMultMM(const T alpha, const GenMatrix<Ta>& A,
      const GenMatrix<Tb>& B, const SymMatrixView<CT>& C)
  { SymMultMM<add>(CT(alpha),A,B,C); }

  template <class T, class Ta> 
  inline void ElementProd(const T alpha, const GenSymMatrix<Ta>& A,
      const SymMatrixView<CT>& B)
  { ElementProd(CT(alpha),A,B); }
  template <class T, class Ta, class Tb> 
  inline void AddElementProd(const T alpha, const GenSymMatrix<Ta>& A,
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMV(const CT , const GenSymMatrix<Ta>& , 
  ...
  template <class T, class Ta, class Tb> 
  inline void AddMM(const CT , const GenSymMatrix<Ta>& , 
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const CT , const GenSymMatrix<Ta>& , 
