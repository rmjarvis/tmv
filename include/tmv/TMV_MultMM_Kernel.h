...
// may have known or unknown K.  If SSE, then the M and N versions also
// have x32 and x64 for double and float.
//
...
namespace tmv {
  ...
  static void generic_multmm_M_16_16(const int M1,
      const Scaling<ix,T>& x, const T* A0, const T* B0, T* C0)
  {
  ...
  static void generic_multmm_16_N_16(const int N1,
      const Scaling<ix,T>& x, const T* A0, const T* B0, T* C0)
  {
  ...
  static void generic_multmm_16_16_K(const int K1,
      const Scaling<ix,T>& x, const T* A0, const T* B0, T* C0)
  {
...
#define TMV_STATIC static
  ...
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
    TMVAssert( ((unsigned int)(B) & 0x3) == 0 );
    TMVAssert( ((unsigned int)(C0) & 0x3) == 0 );
    const bool add = true;
  ...
  static void sse_multmm_M_16_16(const int M1,
      const Scaling<ix,float>& x,
      const float* A, const float* B, float* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
  ...
  template <int M2, int ix>
  static void sse_multmm_M_16_32(const int M1,
      const Scaling<ix,float>& x,
      const float* A, const float* B, float* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
  ...
  template <int M2, int ix>
  static void sse_multmm_M_16_64(const int M1,
      const Scaling<ix,float>& x,
      const float* A, const float* B, float* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
  ...
  static void sse_multmm_16_N_16(const int N1,
      const Scaling<ix,float>& x,
      const float* A, const float* B, float* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
  ...
  template <int N2, int ix>
  static void sse_multmm_16_N_32(const int N1,
      const Scaling<ix,float>& x,
      const float* A, const float* B, float* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
  ...
  template <int N2, int ix>
  static void sse_multmm_16_N_64(const int N1,
      const Scaling<ix,float>& x,
      const float* A, const float* B, float* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
  ...
  static void sse_multmm_16_16_K(const int K1,
      const Scaling<ix,float>& x, 
      const float* A, const float* B, float* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x3) == 0 );
  ...
  template <int M2, int ix>
  TMV_STATIC void sse2_multmm_M_16_32(const int M1,
      const Scaling<ix,double>& x,
      const double* A, const double* B, double* C0)
  {
  ...
  template <int N2, int ix>
  TMV_STATIC void sse2_multmm_16_N_16(const int N1,
      const Scaling<ix,double>& x,
      const double* A, const double* B, double* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x1) == 0 );
  ...
  template <int N2, int ix>
  TMV_STATIC void sse2_multmm_16_N_32(const int N1,
      const Scaling<ix,double>& x,
      const double* A, const double* B, double* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x1) == 0 );
  ...
  template <int K2, int ix>
  TMV_STATIC void sse2_multmm_16_16_K(const int K1,
      const Scaling<ix,double>& x,
      const double* A, const double* B, double* C0)
  {
    TMVAssert( ((unsigned int)(A) & 0x1) == 0 );
