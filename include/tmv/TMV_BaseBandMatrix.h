...
namespace tmv {
  ...
  inline std::string TypeText(const BandMatrix<T,S,I>& )
  { return std::string("BandMatrix<")+TypeText(T())+","+Text(I)+","+Text(S)+">"; }

  template <class T> 
  inline std::string TypeText(const GenBandMatrix<T>& m)
  {
    return std::string("GenBandMatrix<")+TypeText(T())+","+Text(m.ct())+
    ","+Text(m.stor())+">";
  }
  template <class T, IndexStyle I> 
  inline std::string TypeText(const ConstBandMatrixView<T,I>& m)
  {
    return std::string("ConstBandMatrixView<")+TypeText(T())+","+Text(I)+
    ","+Text(m.ct())+","+Text(m.stor())+">";
  }
  template <class T, IndexStyle I> 
  inline std::string TypeText(const BandMatrixView<T,I>& m)
  {
    return std::string("BandMatrixView<")+TypeText(T())+","+Text(I)+
    ","+Text(m.ct())+","+Text(m.stor())+">";
  }
