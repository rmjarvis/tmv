...
#define ProductType(T1,T2) typename ProdType<T1,T2>::Tprod
    ...
    // y = alpha * A * x
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class Ta, class Tx, class Ty, bool ok>
    struct MultMV_1Helper
    { MultMV_1Helper(const Ta*, const Tx*, Ty*) {} };
    template <ptrdiff_t M, ptrdiff_t N, class Ta, class Tx, class Ty>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class Ta, class Tx, class Ty>
    inline void MultMV_1(const Ta* A, const Tx* x, Ty* y)
    { MultMV_1Helper<M,N,S,Ta,Tx,Ty,OKTypes2(Ta,Tx,Ty)>(A,x,y); }

    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class T, class Ta, class Tx, class Ty, bool ok>
    struct MultMVHelper
    { MultMVHelper(const T, const Ta*, const Tx*, Ty*) {} };
    template <ptrdiff_t M, ptrdiff_t N, class T, class Ta, class Tx, class Ty>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class T, class Ta, class Tx, class Ty>
    ...
    // y = alpha * x * A
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class Tx, class Ta, class Ty, bool ok>
    struct MultVM_1Helper
    { MultVM_1Helper(const Tx*, const Ta*, Ty*) {} };
    template <ptrdiff_t M, ptrdiff_t N, class Tx, class Ta, class Ty>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class Tx, class Ta, class Ty>
    inline void MultVM_1(const Tx* x, const Ta* A, Ty* y)
    { MultVM_1Helper<M,N,S,Tx,Ta,Ty,OKTypes2(Ta,Tx,Ty)>(x,A,y); }

    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class T, class Tx, class Ta, class Ty, bool ok>
    struct MultVMHelper
    { MultVMHelper(const T, const Tx*, const Ta*, Ty*) {} };
    template <ptrdiff_t M, ptrdiff_t N, class T, class Tx, class Ta, class Ty>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class T, class Tx, class Ta, class Ty>
    ...
    // B += alpha * A
    template <ptrdiff_t M, ptrdiff_t N, StorageType Sa, StorageType Sb, class Ta, class Tb, bool ok>
    struct AddMM_1Helper
    { AddMM_1Helper(const Ta*, Tb*) {} };
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class Ta, class Tb>
    ...
    template <ptrdiff_t M, ptrdiff_t N, class Ta, class Tb>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType Sa, StorageType Sb, class Ta, class Tb> 
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType Sa, StorageType Sb, class T, class Ta, class Tb, bool ok>
    struct AddMMHelper
    { AddMMHelper(const T, const Ta*, Tb*) {} };
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class T, class Ta, class Tb>
    ...
    template <ptrdiff_t M, ptrdiff_t N, class T, class Ta, class Tb>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType Sa, StorageType Sb, class T, class Ta, class Tb> 
...
#define Cij (Sc == RowMajor ? C[i*N+j] : C[j*M+i])
    ...
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sa, StorageType Sb, StorageType Sc, class Ta, class Tb, class Tc, bool ok>
    struct MultMM_1Helper
    { MultMM_1Helper(const Ta*, const Tb*, Tc*) {} };
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sa, StorageType Sb, StorageType Sc, class Ta, class Tb, class Tc>
    ...
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sb, class Ta, class Tb, class Tc>
    ...
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sa, class Ta, class Tb, class Tc>
    ...
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sa, StorageType Sb, StorageType Sc, class T, class Ta, class Tb, class Tc, bool ok>
    struct MultMMHelper
    { MultMMHelper(const T, const Ta*, const Tb*, Tc*) {} };
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sa, StorageType Sb, StorageType Sc, class T, class Ta, class Tb, class Tc>
    ...
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sb, class T, class Ta, class Tb, class Tc>
    ...
    template <ptrdiff_t M, ptrdiff_t N, ptrdiff_t K, StorageType Sa, class T, class Ta, class Tb, class Tc>
...
#undef Cij
    ...
    // A = alpha * x * yT
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class Tx, class Ty, class Ta, bool ok>
    struct Rank1Update_1Helper
    { Rank1Update_1Helper(const Tx*, const Ty*, Ta*) {} };
    template <ptrdiff_t M, ptrdiff_t N, class Tx, class Ty, class Ta>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class Tx, class Ty, class Ta>
    inline void Rank1Update_1(const Tx* x, const Ty* y, Ta* A)
    { Rank1Update_1Helper<M,N,S,Tx,Ty,Ta,OKTypes2(Tx,Ty,Ta)>(x,y,A); }

    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class T, class Tx, class Ty, class Ta, bool ok>
    struct Rank1UpdateHelper
    { Rank1UpdateHelper(const T, const Tx*, const Ty*, Ta*) {} };
    template <ptrdiff_t M, ptrdiff_t N, class T, class Tx, class Ty, class Ta>
    ...
    template <ptrdiff_t M, ptrdiff_t N, StorageType S, class T, class Tx, class Ty, class Ta>
    ...
    template <class T, class Ta, class Tb, class Tc, ptrdiff_t M, ptrdiff_t N, StorageType Sa, StorageType Sb, StorageType Sc> 
    ...
    template <class T, class Ta, class Tb, ptrdiff_t M, ptrdiff_t N, StorageType Sa, StorageType Sb, StorageType Sc> 
    inline void ElemMultMM(
