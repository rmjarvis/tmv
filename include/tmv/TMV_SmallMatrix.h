...
namespace tmv {
  ...
  struct Traits<SmallMatrix<T,M,N,S,I> >
  {
    ...
    typedef ConstSmallVectorView<T,minMN,mdiagstep,false,I> const_diag_type;
    ...
    typedef ConstSmallMatrixView<T,M,2,mstepi,UNKNOWN,false,I> const_colpair_type;
    typedef ConstSmallMatrixView<T,2,N,UNKNOWN,mstepj,false,I> const_rowpair_type;
    typedef ConstSmallMatrixView<T,M,UNKNOWN,mstepi,mstepj,false,I> const_cols_type;
    typedef ConstSmallMatrixView<T,UNKNOWN,N,mstepi,mstepj,false,I> const_rows_type;
    typedef ConstSmallMatrixView<T,M,N,mstepi,mstepj,false,I> const_view_type;
    typedef ConstSmallMatrixView<T,M,N,mstepi,mstepj,false,CStyle> const_cview_type;
    typedef ConstSmallMatrixView<T,M,N,mstepi,mstepj,false,FortranStyle> const_fview_type;
    ...
    typedef ConstSmallMatrixView<T,M,N,mstepi,mstepj,notC,I> const_conjugate_type;
    typedef ConstSmallMatrixView<T,N,M,mstepj,mstepi,false,I> const_transpose_type;
    typedef ConstSmallMatrixView<T,N,M,mstepj,mstepi,notC,I> const_adjoint_type;
    typedef ConstSmallUpperTriMatrixView<T,N,NonUnitDiag,mstepi,mstepj,false,I> const_uppertri_type;
    typedef ConstSmallUpperTriMatrixView<T,N,UnitDiag,mstepi,mstepj,false,I> const_unit_uppertri_type;
    typedef ConstSmallLowerTriMatrixView<T,M,NonUnitDiag,mstepi,mstepj,false,I> const_lowertri_type;
    typedef ConstSmallLowerTriMatrixView<T,M,UnitDiag,mstepi,mstepj,false,I> const_unit_lowertri_type;
    typedef ConstSmallMatrixView<real_type,M,N,twoSi,twoSj,false,I> const_realview_type;
    typedef const_realview_type const_imagview_type;
    typedef ConstSmallVectorView<T,M*N,1,false,I> const_linearview_type;
    typedef ConstSmallMatrixView<T,M,N,mstepi,mstepj,false,I> const_nonconj_type;
    ...
    typedef SmallMatrixView<T,M,UNKNOWN,mstepi,mstepj,false,I> cols_type;
    typedef SmallMatrixView<T,UNKNOWN,N,mstepi,mstepj,false,I> rows_type;
    ...
    typedef SmallMatrixView<T,M,N,mstepi,mstepj,false,FortranStyle> fview_type;
    ...
    typedef SmallUpperTriMatrixView<T,N,NonUnitDiag,mstepi,mstepj,false,I> uppertri_type;
    typedef SmallUpperTriMatrixView<T,N,UnitDiag,mstepi,mstepj,false,I> unit_uppertri_type;
    typedef SmallLowerTriMatrixView<T,M,NonUnitDiag,mstepi,mstepj,false,I> lowertri_type;
    typedef SmallLowerTriMatrixView<T,M,UnitDiag,mstepi,mstepj,false,I> unit_lowertri_type;
    typedef SmallMatrixView<real_type,M,N,twoSi,twoSj,false,I> realview_type;
...
//#endif
  ...
  public:
    ...
    explicit inline SmallMatrix(const T* vv) 
    {
      ...
      this->SetAllTo(T(888));
#endif
      ConstSmallMatrixView<T,M,N,mstepi,mstepj> m2(vv);
      m2.AssignTo(*this);
    }
  ...
  struct Traits<ConstSmallMatrixView<T,M,N,Si,Sj,C,I> >
  {
    ...
    // In case M,N == UNKNOWN
    typedef typename MCopyHelper<T,Rec,M,N,mrowmajor,mfort>::type copy_type;
    ...
    typedef ConstVectorView<T,Si,C,I> const_col_range_type;
    typedef ConstSmallVectorView<T,N,Sj,C,I> const_row_type;
    typedef ConstVectorView<T,Sj,C,I> const_row_range_type;
    ...
    typedef ConstSmallMatrixView<T,M,UNKNOWN,Si,Sj,C,I> const_cols_type;
    typedef ConstSmallMatrixView<T,UNKNOWN,N,Si,Sj,C,I> const_rows_type;
    ...
    typedef ConstSmallMatrixView<T,M,N,Si,Sj,C,FortranStyle> const_fview_type;
    ...
    typedef ConstSmallUpperTriMatrixView<T,N,NonUnitDiag,Si,Sj,C,I> const_uppertri_type;
    typedef ConstSmallUpperTriMatrixView<T,N,UnitDiag,Si,Sj,C,I> const_unit_uppertri_type;
    typedef ConstSmallLowerTriMatrixView<T,M,NonUnitDiag,Si,Sj,C,I> const_lowertri_type;
    typedef ConstSmallLowerTriMatrixView<T,M,UnitDiag,Si,Sj,C,I> const_unit_lowertri_type;
    typedef ConstSmallMatrixView<real_type,M,N,twoSi,twoSj,false,I> const_realview_type;
    typedef const_realview_type const_imagview_type;
  ...
  public:
    ...
    inline ConstSmallMatrixView(const ConstMatrixView<T,Si2,Sj2,C,I2>& m2) :
      itsm(m2.cptr()), itscs(m2.colsize()), itsrs(m2.rowsize()),
      itssi(m2.stepi()), itssj(m2.stepj()) {}
  ...
  private :
    ...
    const T*const itsm;
#endif
    const StepInt<M> itscs;
    const StepInt<N> itsrs;
  ...
  public:
    ...
    inline ConstSmallMatrixViewF(
        const T* m, size_t cs, size_t rs, int si, int sj) :
      mtype(m,cs,rs,si,sj) {}
    inline ConstSmallMatrixViewF(const T* m, size_t cs, size_t rs, int si) :
      mtype(m,cs,rs,si) {}
    ...
    template <int Si2, int Sj2, IndexStyle I2>
    inline ConstSmallMatrixViewF(const ConstMatrixView<T,Si2,Sj2,C,I2>& m2) :
      mtype(m2) {}
    template <int Si2, int Sj2, IndexStyle I2>
  ...
  struct Traits<SmallMatrixView<T,M,N,Si,Sj,C,I> >
  {
    ...
    typedef VectorView<T,Si,C,I> col_range_type;
    typedef SmallVectorView<T,N,Sj,C,I> row_type;
    typedef VectorView<T,Sj,C,I> row_range_type;
    ...
    typedef SmallMatrixView<T,M,UNKNOWN,Si,Sj,C,I> cols_type;
    typedef SmallMatrixView<T,UNKNOWN,N,Si,Sj,C,I> rows_type;
    ...
    typedef SmallUpperTriMatrixView<T,N,NonUnitDiag,Si,Sj,C,I> uppertri_type;
    typedef SmallUpperTriMatrixView<T,N,UnitDiag,Si,Sj,C,I> unit_uppertri_type;
    typedef SmallLowerTriMatrixView<T,M,NonUnitDiag,Si,Sj,C,I> lowertri_type;
    typedef SmallLowerTriMatrixView<T,M,UnitDiag,Si,Sj,C,I> unit_lowertri_type;
    typedef SmallMatrixView<real_type,M,N,twoSi,twoSj,false,I> realview_type;
    typedef realview_type imagview_type;
...
#undef VI
  ...
  inline void Swap(
      SmallMatrixView<T,M,N,Si1,Sj1,C1,I1> m1, SmallMatrixView<T,M,N,Si2,Sj2,C2,I2> m2)
  { DoSwap(m1,m2); }
  template <class T, int M, int N, int Si1, int Sj1, bool C1, IndexStyle I1, int Si2, int Sj2, bool C2, IndexStyle I2>
  inline void Swap(
      SmallMatrixView<T,M,N,Si1,Sj1,C1,I1> m1, MatrixView<T,Si2,Sj2,C2,I2> m2)
  { DoSwap(m1,m2); }
  template <class T, int M, int N, int Si1, int Sj1, bool C1, IndexStyle I1, int Si2, int Sj2, bool C2, IndexStyle I2>
  inline void Swap(
      MatrixView<T,Si1,Sj1,C1,I1> m1, SmallMatrixView<T,M,N,Si2,Sj2,C2,I2> m2)
  { DoSwap(m1,m2); }
  ...
  {
    std::ostringstream s;
    s << "ConstSmallMatrixView<"<<TypeText(T());
    s << ","<<IntTraits<M>::text();
    if (M == UNKNOWN) s << "("<<m.colsize()<<")";
    s << ","<<IntTraits<N>::text();
    if (N == UNKNOWN) s << "("<<m.rowsize()<<")";
