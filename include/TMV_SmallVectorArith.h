...
namespace tmv {
  ...
  template <class T, int N, IndexStyle I, class Tx> 
  ...
  template <class T, class T1, int N, int S1, bool C1> class ProdXv : 
...
#undef PRODXV
  ...
  template <class T, class T1, class T2, int N, int S1, bool C1, int S2, bool C2> class Sumvv_1_1 : 
    public SmallVectorComposite<T,N> 
  {
    public:
      inline Sumvv_1_1(
  ...
  template <class T, class T1, class T2, int N, int S1, bool C1, int S2, bool C2> class Sumvv_1_m1 : 
    public SmallVectorComposite<T,N> 
  {
    public:
      inline Sumvv_1_m1(
  ...
  template <class T, class T1, class T2, int N, int S1, bool C1, int S2, bool C2> class Sumvv_1_x : 
    public SmallVectorComposite<T,N> 
  {
    public:
      inline Sumvv_1_x(
  ...
  template <class T, class T1, class T2, int N, int S1, bool C1, int S2, bool C2> class Sumvv_x_1 : 
    public SmallVectorComposite<T,N> 
  {
    public:
      inline Sumvv_x_1(
  ...
  template <class T, class T1, class T2, int N, int S1, bool C1, int S2, bool C2> class Sumvv_x_m1 : 
    public SmallVectorComposite<T,N> 
  {
    public:
      inline Sumvv_x_m1(
  ...
  template <class T, class T1, class T2, int N, int S1, bool C1, int S2, bool C2> class Sumvv : 
    public SmallVectorComposite<T,N> 
  {
    public:
  ...
  // v+=v
  template <class T, int N, int S1, bool C1, int S2, bool C2> 
  ...
  // v+=(x*v)
  template <class T, class T2, int N, int S1, bool C1, int S2, bool C2> 
    inline const SmallVectorView<T,N,S1,C1>& operator+=(
  ...
  template <class T, class T2, int N, int S1, bool C1> 
    inline const SmallVectorView<T,N,S1,C1>& operator+=(
...
#define Y ,int N,int S1,bool C1,int S2,bool C2
