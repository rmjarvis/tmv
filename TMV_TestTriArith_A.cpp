...
template <class T1, class T2> bool CanAddEq(
    const UpperTriMatrixView<T1>& a, const UpperTriMatrixView<T2>& b)
{ return a.size() == b.size() && !a.isunit(); }

template <class T1, class T2> bool CanAddEq(
    const LowerTriMatrixView<T1>& a, const LowerTriMatrixView<T2>& b)
{ return a.size() == b.size() && !a.isunit(); }

template <class T1, class T2> bool CanAddEq(
    const UpperTriMatrixView<T1>& a, const LowerTriMatrixView<T2>& b)
{ return false; }

template <class T1, class T2> bool CanAddEq(
    const LowerTriMatrixView<T1>& a, const UpperTriMatrixView<T2>& b)
{ return false; }

template <class T1> bool CanAddEqX(const UpperTriMatrixView<T1>& a)
{ return !a.isunit(); }

template <class T1> bool CanAddEqX(const LowerTriMatrixView<T1>& a)
{ return !a.isunit(); }

template <class T1> bool CanMultEqX(const UpperTriMatrixView<T1>& a)
{ return !a.isunit(); }

template <class T1> bool CanMultEqX(const LowerTriMatrixView<T1>& a)
{ return !a.isunit(); }
...
template <class T> bool CanDoSV(const UpperTriMatrixView<T>& a)
{ return false; }
template <class T> bool CanDoSV(const LowerTriMatrixView<T>& a)
{ return false; }
