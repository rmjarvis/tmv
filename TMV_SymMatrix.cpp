...
namespace tmv {
  ...
  template <class T> const SymMatrixView<T>& SymMatrixView<T>::PermuteRowsCols(
  ...
  template <class T> const SymMatrixView<T>& SymMatrixView<T>::ReversePermuteRowsCols(
      const size_t* p, size_t i1, size_t i2) const
  {
