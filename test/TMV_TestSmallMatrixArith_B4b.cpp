...
template <class T> void TestSmallMatrixArith_B4b()
{
  ...
  TestMatrixArith4<T>(a4x,ca4x,a4v,ca4v,a1v,ca1v,"NonSquare");
#ifdef XTEST
  TestMatrixArith4<T>(a4x,ca4x,a4v,ca4v,a5v,ca5v,"NonSquare");
  TestMatrixArith4<T>(a4x,ca4x,a4v,ca4v,a2v,ca2v,"NonSquare");
  TestMatrixArith4<T>(a4x,ca4x,a4v,ca4v,a3v,ca3v,"NonSquare");
#endif
}
