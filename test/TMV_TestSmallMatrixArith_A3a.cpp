...
template <class T> void TestSmallMatrixArith_A3a()
{
  ...
  TestMatrixArith3<T>(a1v,ca1v,v1v,cv1v,v2v,cv2v,"Square");
#ifdef XTEST
  TestMatrixArith3<T>(a1v,ca1v,v1s,cv1s,v2v,cv2v,"Square");
  TestMatrixArith3<T>(a1v,ca1v,v1v,cv1v,v2s,cv2s,"Square");
  TestMatrixArith3<T>(a1v,ca1v,v1s,cv1s,v2s,cv2s,"Square");
#endif
}
