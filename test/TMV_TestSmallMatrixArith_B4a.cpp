...
template <class T> void TestSmallMatrixArith_B4a()
{
  ...
  TestMatrixArith4<T>(a1x,ca1x,a1v,ca1v,a4v,ca4v,"NonSquare");
#ifdef XTEST
  TestMatrixArith4<T>(a1x,ca1x,a2v,ca2v,a4v,ca4v,"NonSquare");
  TestMatrixArith4<T>(a1x,ca1x,a3v,ca3v,a4v,ca4v,"NonSquare");
  TestMatrixArith4<T>(a1x,ca1x,a1v,ca1v,a5v,ca5v,"NonSquare");
  TestMatrixArith4<T>(a1x,ca1x,a2v,ca2v,a5v,ca5v,"NonSquare");
  TestMatrixArith4<T>(a1x,ca1x,a3v,ca3v,a5v,ca5v,"NonSquare");
#endif
}
