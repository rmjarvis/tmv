...
void TestSmallMatrixArith_6(std::string label)
{
    ...
    tmv::SmallMatrix<T,M,K,tmv::ColMajor> a3c;
    tmv::SmallMatrix<CT,M,K,tmv::ColMajor> ca3c;
...
#if (XTEST & 2)
    tmv::SmallMatrix<T,M,K,tmv::RowMajor> a3r;
    tmv::SmallMatrix<CT,M,K,tmv::RowMajor> ca3r;
