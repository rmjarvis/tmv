...
template <class T, int N> static void DoTestSmallMatrixArith_B7b()
{
...
template <class T> void TestSmallMatrixArith_B7b()
{
  ...
  DoTestSmallMatrixArith_B7b<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B7b<T,1>();
  DoTestSmallMatrixArith_B7b<T,3>();
  DoTestSmallMatrixArith_B7b<T,4>();
  DoTestSmallMatrixArith_B7b<T,22>();
  DoTestSmallMatrixArith_B7b<T,555>();
#endif
}
