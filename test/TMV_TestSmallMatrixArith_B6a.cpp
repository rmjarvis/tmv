...
template <class T> void TestSmallMatrixArith_B6a()
{
  ...
  TestMatrixArith6<T>(a4v,ca4v,v3v,cv3v,v1v,cv1v,"NonSquare");
#ifdef XTEST
  TestMatrixArith6<T>(a4v,ca4v,v3s,cv3s,v1v,cv1v,"NonSquare");
  TestMatrixArith6<T>(a4v,ca4v,v3v,cv3v,v1s,cv1s,"NonSquare");
  TestMatrixArith6<T>(a4v,ca4v,v3s,cv3s,v1s,cv1s,"NonSquare");
#endif
}
