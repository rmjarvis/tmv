...
template <class T> void TestSymBandMatrixArith_B2()
{
  ...
  for(size_t i=START;i<s.size();i++) {
    ...
    if (csi.isherm()) {
      ...
      TestMatrixArith456<T>(a3x,ca3x,a3v,ca3v,si,csi,"NonSquareM/HermBand");
      TestMatrixArith456<T>(a4x,ca4x,a4v,ca4v,si,csi,"DegenerateM/HermBand");
    } else {
      ...
      TestMatrixArith456<T>(a3x,ca3x,a3v,ca3v,si,csi,"NonSquareM/SymBand");
      TestMatrixArith456<T>(a4x,ca4x,a4v,ca4v,si,csi,"DegenerateM/SymBand");
    }
  }
