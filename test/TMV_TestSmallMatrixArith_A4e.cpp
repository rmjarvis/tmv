...
template <class T, int N> static void DoTestSmallMatrixArith_A4e()
{
...
template <class T> void TestSmallMatrixArith_A4e()
{
#ifdef DoLargeTest
  DoTestSmallMatrixArith_A4e<T,555>();
#endif
}


#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_A4e<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_A4e<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_A4e<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_A4e<int>();
#endif
