...
template <class T> void TestDiagMatrixArith_A3()
{
    ...
    TestMatrixArith3<T>(av,cav, "Diag");
}

#ifdef TEST_DOUBLE
template void TestDiagMatrixArith_A3<double>();
#endif
#ifdef TEST_FLOAT
template void TestDiagMatrixArith_A3<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestDiagMatrixArith_A3<long double>();
#endif
#ifdef TEST_INT
template void TestDiagMatrixArith_A3<int>();
#endif
