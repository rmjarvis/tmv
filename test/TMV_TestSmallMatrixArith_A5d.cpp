...
template <class T, int N> static void DoTestSmallMatrixArith_A5d()
{
  ...
  TestMatrixArith5<T>(a2,ca2,a2b,ca2b,"Square");
  ...
  TestMatrixArith5<T>(a2f,ca2f,a1f,ca1f,"Square");
#endif
}

template <class T> void TestSmallMatrixArith_A5d()
{
  DoTestSmallMatrixArith_A5d<T,2>();
  DoTestSmallMatrixArith_A5d<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_A5d<T,1>();
  DoTestSmallMatrixArith_A5d<T,3>();
  DoTestSmallMatrixArith_A5d<T,4>();
  DoTestSmallMatrixArith_A5d<T,22>();
#endif
}

#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_A5d<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_A5d<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_A5d<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_A5d<int>();
#endif
