...
template <class T, int N> static void DoTestSmallMatrixArith_A5e()
{
  ...
  TestMatrixArith5<T>(a1,ca1,a2,ca2,"Square");
...
template <class T> void TestSmallMatrixArith_A5e()
{
#ifdef DoLargeTest
  DoTestSmallMatrixArith_A5e<T,555>();
#endif
}


#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_A5e<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_A5e<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_A5e<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_A5e<int>();
#endif
