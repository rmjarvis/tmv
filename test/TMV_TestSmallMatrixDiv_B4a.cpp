...
template <class T, tmv::StorageType stor, int N> static void TestSmallNonSquareDiv_B4a()
{
  ...
  TestMatrixDivArith3b<T>(tmv::QR,a7x,c7x,a1,a7,a5,c1,c7,c5,"NonSquare/NonSquare"); 
#ifdef XTEST
  ...
  TestMatrixDivArith3b<T>(tmv::QR,a7x,c7x,a1,a7,a5,c1,c7,c5,"NonSquare/NonSquare"); 
  TestMatrixDivArith3b<T>(tmv::QR,a7x,c7x,a1f,a7,a5,c1f,c7,c5,"NonSquare/NonSquare"); 
  TestMatrixDivArith3b<T>(tmv::QR,a7x,c7x,a1f,a7f,a5,c1f,c7f,c5,"NonSquare/NonSquare"); 
  TestMatrixDivArith3b<T>(tmv::QR,a7x,c7x,a1f,a7f,a5f,c1f,c7f,c5f,"NonSquare/NonSquare"); 
#endif
}
