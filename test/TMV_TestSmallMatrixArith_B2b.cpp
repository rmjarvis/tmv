...
template <class T, int N> static void DoTestSmallMatrixArith_B2b()
{
...
{
  DoTestSmallMatrixArith_B2b<T,2>();
  DoTestSmallMatrixArith_B2b<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B2b<T,1>();
  DoTestSmallMatrixArith_B2b<T,3>();
  DoTestSmallMatrixArith_B2b<T,4>();
  DoTestSmallMatrixArith_B2b<T,22>();
  DoTestSmallMatrixArith_B2b<T,555>();
#endif
}

#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_B2b<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_B2b<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_B2b<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_B2b<int>();
#endif
