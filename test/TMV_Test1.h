...
template <class T> void TestTriMatrixArith_A4b();
template <class T> void TestTriMatrixArith_A5a();
template <class T> void TestTriMatrixArith_A5b();
template <class T> void TestTriMatrixArith_A6a();
template <class T> void TestTriMatrixArith_A6b();
...
template <class T> void TestTriMatrixArith_C4a();
template <class T> void TestTriMatrixArith_C4b();
...
template <class T> void TestTriDiv();
