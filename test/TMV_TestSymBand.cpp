...
static void TestBasicSymBandMatrix()
{
  ...
  for (size_t i=0, k=1; i<N; ++i) for (size_t j=0; j<N; ++j, ++k) {
	...
	Assert(s1x(j,i) == value,"Access const SymBandMatrix - opposite tri");
	Assert(s1v(j,i) == value,"Access SymBandMatrix V");
	Assert(s1cv(j,i) == value,"Access SymBandMatrix CV");
	Assert(h1(j,i) == conj(hvalue),"Access HermBandMatrix - opposite tri");
	Assert(h1x(j,i) == conj(hvalue),"Access const HermBandMatrix - opposite tri");
	...
	Assert(h1f(j+1,i+1) == conj(hvalue),"Access HermBandMatrixF - opposite tri");
	Assert(h1fx(j+1,i+1) == conj(hvalue),"Access const HermBandMatrixF - opposite tri");
	Assert(h1fv(j+1,i+1) == conj(hvalue),"Access HermBandMatrixF V");
	Assert(h1fcv(j+1,i+1) == conj(hvalue),"Access HermBandMatrixF CV");
	...
	Assert(h1.col(i,i,j2)(j-i) == conj(hvalue),"HermBandMatrix.col");
	Assert(h1x.col(i,i,j2)(j-i) == conj(hvalue),"HermBandMatrix.col");
	Assert(h1cv.col(i,i,j2)(j-i) == conj(hvalue),"HermBandMatrix.col CV");
	Assert(h1v.col(i,i,j2)(j-i) == conj(hvalue),"HermBandMatrix.col V");
	...
	Assert(h1x.col(i,j,j2)(0) == conj(hvalue),"HermBandMatrix.col2");
	Assert(h1cv.col(i,j,j2)(0) == conj(hvalue),"HermBandMatrix.col2 CV");
	Assert(h1v.col(i,j,j2)(0) == conj(hvalue),"HermBandMatrix.col2 V");
	Assert(s1f.row(i+1,i+1,j2)(j-i+1) == value,"SymBandMatrixF.row");
	Assert(s1fx.row(i+1,i+1,j2)(j-i+1) == value,"const SymBandMatrixF.row");
	Assert(s1fcv.row(i+1,i+1,j2)(j-i+1) == value,"SymBandMatrixF.row CV");
	Assert(s1fv.row(i+1,i+1,j2)(j-i+1) == value,"SymBandMatrixF.row V");
	Assert(h1f.row(i+1,i+1,j2)(j-i+1) == hvalue,"HermBandMatrixF.row");
	Assert(h1fx.row(i+1,i+1,j2)(j-i+1) == hvalue,"const HermBandMatrixF.row");
	Assert(h1fcv.row(i+1,i+1,j2)(j-i+1) == hvalue,"HermBandMatrixF.row CV");
	Assert(h1fv.row(i+1,i+1,j2)(j-i+1) == hvalue,"HermBandMatrixF.row V");
	Assert(s1f.col(i+1,i+1,j2)(j-i+1) == value,"SymBandMatrixF.col");
	Assert(s1fx.col(i+1,i+1,j2)(j-i+1) == value,"const SymBandMatrixF.col");
	Assert(s1fcv.col(i+1,i+1,j2)(j-i+1) == value,"SymBandMatrixF.col CV");
	Assert(s1fv.col(i+1,i+1,j2)(j-i+1) == value,"SymBandMatrixF.col V");
	Assert(h1f.col(i+1,i+1,j2)(j-i+1) == conj(hvalue),"HermBandMatrixF.col");
	Assert(h1fx.col(i+1,i+1,j2)(j-i+1) == conj(hvalue),"const HermBandMatrixF.col");
	Assert(h1fcv.col(i+1,i+1,j2)(j-i+1) == conj(hvalue),"HermBandMatrixF.col CV");
	Assert(h1fv.col(i+1,i+1,j2)(j-i+1) == conj(hvalue),"HermBandMatrixF.col V");
	Assert(s1f.row(i+1,j+1,j2)(1) == value,"SymBandMatrixF.row2");
	Assert(s1fx.row(i+1,j+1,j2)(1) == value,"const SymBandMatrixF.row2");
	Assert(s1fcv.row(i+1,j+1,j2)(1) == value,"SymBandMatrixF.row2 CV");
	Assert(s1fv.row(i+1,j+1,j2)(1) == value,"SymBandMatrixF.row2 V");
	Assert(h1f.row(i+1,j+1,j2)(1) == hvalue,"HermBandMatrixF.row2");
	Assert(h1fx.row(i+1,j+1,j2)(1) == hvalue,"const HermBandMatrixF.row2");
	Assert(h1fcv.row(i+1,j+1,j2)(1) == hvalue,"HermBandMatrixF.row2 CV");
	Assert(h1fv.row(i+1,j+1,j2)(1) == hvalue,"HermBandMatrixF.row2 V");
	Assert(s1f.col(i+1,j+1,j2)(1) == value,"SymBandMatrixF.col2");
	Assert(s1fx.col(i+1,j+1,j2)(1) == value,"const SymBandMatrixF.col2");
	Assert(s1fcv.col(i+1,j+1,j2)(1) == value,"SymBandMatrixF.col2 CV");
	Assert(s1fv.col(i+1,j+1,j2)(1) == value,"SymBandMatrixF.col2 V");
	Assert(h1f.col(i+1,j+1,j2)(1) == conj(hvalue),"HermBandMatrixF.col2");
	Assert(h1fx.col(i+1,j+1,j2)(1) == conj(hvalue),"const HermBandMatrixF.col2");
	Assert(h1fcv.col(i+1,j+1,j2)(1) == conj(hvalue),"HermBandMatrixF.col2 CV");
	Assert(h1fv.col(i+1,j+1,j2)(1) == conj(hvalue),"HermBandMatrixF.col2 V");
	int d = int(j)-int(i);
	if (d==0) {
	  ...
	  Assert(s1fx.diag()(i+1) == value,"const SymBandMatrixF.diag");
	  ...
	  Assert(h1fx.diag()(i+1) == hvalue,"const HermBandMatrixF.diag");
	  Assert(h1fcv.diag()(i+1) == hvalue,"HermBandMatrixF.diag CV");
	...
	Assert(s1x.diag(d,i,N-d)(0) == value,"const SymBandMatrix.diag2");
	...
	Assert(h1x.diag(d,i,N-d)(0) == hvalue,"const HermBandMatrix.diag2");
	Assert(h1cv.diag(d,i,N-d)(0) == hvalue,"HermBandMatrix.diag2 CV");
	...
	Assert(s1fx.diag(d,i+1,N-d)(1) == value,"const SymBandMatrixF.diag2");
	Assert(s1fcv.diag(d,i+1,N-d)(1) == value,"SymBandMatrixF.diag2 CV");
	Assert(s1fv.diag(d,i+1,N-d)(1) == value,"SymBandMatrixF.diag2 V");
	Assert(h1f.diag(d)(i+1) == hvalue,"HermBandMatrixF.diag1");
	Assert(h1fx.diag(d)(i+1) == hvalue,"const HermBandMatrixF.diag1");
	Assert(h1fcv.diag(d)(i+1) == hvalue,"HermBandMatrixF.diag1 CV");
	Assert(h1fv.diag(d)(i+1) == hvalue,"HermBandMatrixF.diag1 V");
	Assert(h1f.diag(d,i+1,N-d)(1) == hvalue,"HermBandMatrixF.diag2");
	Assert(h1fx.diag(d,i+1,N-d)(1) == hvalue,"const HermBandMatrixF.diag2");
	Assert(h1fcv.diag(d,i+1,N-d)(1) == hvalue,"HermBandMatrixF.diag2 CV");
	Assert(h1fv.diag(d,i+1,N-d)(1) == hvalue,"HermBandMatrixF.diag2 V");
	Assert(s1.diag(-d)(i) == value,"SymBandMatrix.diag1");
	Assert(s1x.diag(-d)(i) == value,"const SymBandMatrix.diag1");
	Assert(s1cv.diag(-d)(i) == value,"SymBandMatrix.diag1 CV");
	Assert(s1v.diag(-d)(i) == value,"SymBandMatrix.diag1 V");
	...
	Assert(h1x.diag(-d)(i) == conj(hvalue),"const HermBandMatrix.diag1");
	Assert(h1cv.diag(-d)(i) == conj(hvalue),"HermBandMatrix.diag1 CV");
	Assert(h1v.diag(-d)(i) == conj(hvalue),"HermBandMatrix.diag1 V");
	Assert(h1.diag(-d,i,N-d)(0) == conj(hvalue),"HermBandMatrix.diag2");
	Assert(h1x.diag(-d,i,N-d)(0) == conj(hvalue),"const HermBandMatrix.diag2");
	Assert(h1cv.diag(-d,i,N-d)(0) == conj(hvalue),"HermBandMatrix.diag2 CV");
	Assert(h1v.diag(-d,i,N-d)(0) == conj(hvalue),"HermBandMatrix.diag2 V");
	Assert(s1f.diag(-d)(i+1) == value,"SymBandMatrixF.diag1");
	Assert(s1fx.diag(-d)(i+1) == value,"const SymBandMatrixF.diag1");
	Assert(s1fcv.diag(-d)(i+1) == value,"SymBandMatrixF.diag1 CV");
	Assert(s1fv.diag(-d)(i+1) == value,"SymBandMatrixF.diag1 V");
	...
	Assert(s1fcv.diag(-d,i+1,N-d)(1) == value,"SymBandMatrixF.diag2 CV");
	Assert(s1fv.diag(-d,i+1,N-d)(1) == value,"SymBandMatrixF.diag2 V");
	Assert(h1f.diag(-d)(i+1) == conj(hvalue),"HermBandMatrixF.diag1");
	Assert(h1fx.diag(-d)(i+1) == conj(hvalue),"const HermBandMatrixF.diag1");
	Assert(h1fcv.diag(-d)(i+1) == conj(hvalue),"HermBandMatrixF.diag1 CV");
	Assert(h1fv.diag(-d)(i+1) == conj(hvalue),"HermBandMatrixF.diag1 V");
	Assert(h1f.diag(-d,i+1,N-d)(1) == conj(hvalue),"HermBandMatrixF.diag2");
	Assert(h1fx.diag(-d,i+1,N-d)(1) == conj(hvalue),"const HermBandMatrixF.diag2");
	Assert(h1fcv.diag(-d,i+1,N-d)(1) == conj(hvalue),"HermBandMatrixF.diag2 CV");
	Assert(h1fv.diag(-d,i+1,N-d)(1) == conj(hvalue),"HermBandMatrixF.diag2 V");
      }
      if (j<=i) {
	...
	Assert(s2x(i,j) == value,"Access const SymBandMatrix - opposite tri");
	Assert(s2v(i,j) == value,"Access SymBandMatrix V");
	Assert(s2cv(i,j) == value,"Access SymBandMatrix CV");
	Assert(h2(i,j) == hvalue,"Access HermBandMatrix - opposite tri");
	Assert(h2x(i,j) == hvalue,"Access const HermBandMatrix - opposite tri");
	...
	Assert(h2f(j+1,i+1) == conj(hvalue),"Read/Write HermBandMatrixF");
	Assert(h2fx(j+1,i+1) == conj(hvalue),"Access const HermBandMatrixF");
	Assert(h2fv(j+1,i+1) == conj(hvalue),"Access HermBandMatrixF V");
	Assert(h2fcv(j+1,i+1) == conj(hvalue),"Access HermBandMatrixF CV");
	Assert(s2f(i+1,j+1) == value,"Access SymBandMatrixF - opposite tri");
	Assert(s2fx(i+1,j+1) == value,"Access const SymBandMatrixF - opposite tri");
	Assert(s2fv(i+1,j+1) == value,"Access SymBandMatrixF V");
	Assert(s2fcv(i+1,j+1) == value,"Access SymBandMatrixF CV");
	Assert(h2f(i+1,j+1) == hvalue,"Access HermBandMatrixF - opposite tri");
	Assert(h2fx(i+1,j+1) == hvalue,"Access const HermBandMatrixF - opposite tri");
	...
	Assert(s2x.row(i,j1,i+1)(j-j1) == value,"const SymBandMatrix.row");
	Assert(s2cv.row(i,j1,i+1)(j-j1) == value,"SymBandMatrix.row CV");
	Assert(s2v.row(i,j1,i+1)(j-j1) == value,"SymBandMatrix.row V");
	Assert(h2.row(i,j1,i+1)(j-j1) == hvalue,"HermBandMatrix.row");
	Assert(h2x.row(i,j1,i+1)(j-j1) == hvalue,"const HermBandMatrix.row");
	Assert(h2cv.row(i,j1,i+1)(j-j1) == hvalue,"HermBandMatrix.row CV");
	Assert(h2v.row(i,j1,i+1)(j-j1) == hvalue,"HermBandMatrix.row V");
	Assert(s2.col(i,j1,i+1)(j-j1) == value,"SymBandMatrix.col");
	Assert(s2x.col(i,j1,i+1)(j-j1) == value,"const SymBandMatrix.col");
	Assert(s2cv.col(i,j1,i+1)(j-j1) == value,"SymBandMatrix.col CV");
	Assert(s2v.col(i,j1,i+1)(j-j1) == value,"SymBandMatrix.col V");
	Assert(h2.col(i,j1,i+1)(j-j1) == conj(hvalue),"HermBandMatrix.col");
	Assert(h2x.col(i,j1,i+1)(j-j1) == conj(hvalue),"const HermBandMatrix.col");
	Assert(h2cv.col(i,j1,i+1)(j-j1) == conj(hvalue),"HermBandMatrix.col CV");
	Assert(h2v.col(i,j1,i+1)(j-j1) == conj(hvalue),"HermBandMatrix.col V");
	...
	Assert(h2x.row(i,j,i+1)(0) == hvalue,"const HermBandMatrix.row2");
	...
	Assert(h2.col(i,j,i+1)(0) == conj(hvalue),"HermBandMatrix.col2");
	Assert(h2x.col(i,j,i+1)(0) == conj(hvalue),"const HermBandMatrix.col2");
	Assert(h2cv.col(i,j,i+1)(0) == conj(hvalue),"HermBandMatrix.col2 CV");
	Assert(h2v.col(i,j,i+1)(0) == conj(hvalue),"HermBandMatrix.col2 V");
	Assert(s2f.row(i+1,j1+1,i+1)(j+1-j1) == value,"SymBandMatrixF.row");
	Assert(s2fx.row(i+1,j1+1,i+1)(j+1-j1) == value,"const SymBandMatrixF.row");
	Assert(s2fcv.row(i+1,j1+1,i+1)(j+1-j1) == value,"SymBandMatrixF.row CV");
	Assert(s2fv.row(i+1,j1+1,i+1)(j+1-j1) == value,"SymBandMatrixF.row V");
	Assert(h2f.row(i+1,j1+1,i+1)(j+1-j1) == hvalue,"HermBandMatrixF.row");
	Assert(h2fx.row(i+1,j1+1,i+1)(j+1-j1) == hvalue,"const HermBandMatrixF.row");
	Assert(h2fcv.row(i+1,j1+1,i+1)(j+1-j1) == hvalue,"HermBandMatrixF.row CV");
	Assert(h2fv.row(i+1,j1+1,i+1)(j+1-j1) == hvalue,"HermBandMatrixF.row V");
	Assert(s2f.col(i+1,j1+1,i+1)(j+1-j1) == value,"SymBandMatrixF.col");
	Assert(s2fx.col(i+1,j1+1,i+1)(j+1-j1) == value,"const SymBandMatrixF.col");
	Assert(s2fcv.col(i+1,j1+1,i+1)(j+1-j1) == value,"SymBandMatrixF.col CV");
	Assert(s2fv.col(i+1,j1+1,i+1)(j+1-j1) == value,"SymBandMatrixF.col V");
	Assert(h2f.col(i+1,j1+1,i+1)(j+1-j1) == conj(hvalue),"HermBandMatrixF.col");
	Assert(h2fx.col(i+1,j1+1,i+1)(j+1-j1) == conj(hvalue),"const HermBandMatrixF.col");
	Assert(h2fcv.col(i+1,j1+1,i+1)(j+1-j1) == conj(hvalue),"HermBandMatrixF.col CV");
	Assert(h2fv.col(i+1,j1+1,i+1)(j+1-j1) == conj(hvalue),"HermBandMatrixF.col V");
	Assert(s2f.row(i+1,j+1,i+1)(1) == value,"SymBandMatrixF.row2");
	Assert(s2fx.row(i+1,j+1,i+1)(1) == value,"const SymBandMatrixF.row2");
	Assert(s2fcv.row(i+1,j+1,i+1)(1) == value,"SymBandMatrixF.row2 CV");
	Assert(s2fv.row(i+1,j+1,i+1)(1) == value,"SymBandMatrixF.row2 V");
	Assert(h2f.row(i+1,j+1,i+1)(1) == hvalue,"HermBandMatrixF.row2");
	Assert(h2fx.row(i+1,j+1,i+1)(1) == hvalue,"const HermBandMatrixF.row2");
	Assert(h2fcv.row(i+1,j+1,i+1)(1) == hvalue,"HermBandMatrixF.row2 CV");
	Assert(h2fv.row(i+1,j+1,i+1)(1) == hvalue,"HermBandMatrixF.row2 V");
	Assert(s2f.col(i+1,j+1,i+1)(1) == value,"SymBandMatrixF.col2");
	Assert(s2fx.col(i+1,j+1,i+1)(1) == value,"const SymBandMatrixF.col2");
	Assert(s2fcv.col(i+1,j+1,i+1)(1) == value,"SymBandMatrixF.col2 CV");
	Assert(s2fv.col(i+1,j+1,i+1)(1) == value,"SymBandMatrixF.col2 V");
	Assert(h2f.col(i+1,j+1,i+1)(1) == conj(hvalue),"HermBandMatrixF.col2");
	Assert(h2fx.col(i+1,j+1,i+1)(1) == conj(hvalue),"const HermBandMatrixF.col2");
	Assert(h2fcv.col(i+1,j+1,i+1)(1) == conj(hvalue),"HermBandMatrixF.col2 CV");
	Assert(h2fv.col(i+1,j+1,i+1)(1) == conj(hvalue),"HermBandMatrixF.col2 V");
	int d = int(j)-int(i);
	if (d==0) {
	  ...
	  Assert(s2fx.diag()(i+1) == value,"const SymBandMatrixF.diag");
	  ...
	  Assert(h2fx.diag()(i+1) == hvalue,"const HermBandMatrixF.diag");
	  Assert(h2fcv.diag()(i+1) == hvalue,"HermBandMatrixF.diag CV");
	...
	Assert(s2x.diag(d,j,N+d)(0) == value,"const SymBandMatrix.diag2");
	...
	Assert(h2x.diag(d,j,N+d)(0) == hvalue,"const HermBandMatrix.diag2");
	Assert(h2cv.diag(d,j,N+d)(0) == hvalue,"HermBandMatrix.diag2 CV");
	...
	Assert(s2fx.diag(d,j+1,N+d)(1) == value,"const SymBandMatrixF.diag2");
	Assert(s2fcv.diag(d,j+1,N+d)(1) == value,"SymBandMatrixF.diag2 CV");
	Assert(s2fv.diag(d,j+1,N+d)(1) == value,"SymBandMatrixF.diag2 V");
	Assert(h2f.diag(d)(j+1) == hvalue,"HermBandMatrixF.diag1");
	Assert(h2fx.diag(d)(j+1) == hvalue,"const HermBandMatrixF.diag1");
	Assert(h2fcv.diag(d)(j+1) == hvalue,"HermBandMatrixF.diag1 CV");
	Assert(h2fv.diag(d)(j+1) == hvalue,"HermBandMatrixF.diag1 V");
	Assert(h2f.diag(d,j+1,N+d)(1) == hvalue,"HermBandMatrixF.diag2");
	Assert(h2fx.diag(d,j+1,N+d)(1) == hvalue,"const HermBandMatrixF.diag2");
	Assert(h2fcv.diag(d,j+1,N+d)(1) == hvalue,"HermBandMatrixF.diag2 CV");
	Assert(h2fv.diag(d,j+1,N+d)(1) == hvalue,"HermBandMatrixF.diag2 V");
	Assert(s2.diag(-d)(j) == value,"SymBandMatrix.diag1");
	Assert(s2x.diag(-d)(j) == value,"const SymBandMatrix.diag1");
	Assert(s2cv.diag(-d)(j) == value,"SymBandMatrix.diag1 CV");
	Assert(s2v.diag(-d)(j) == value,"SymBandMatrix.diag1 V");
	...
	Assert(h2x.diag(-d)(j) == conj(hvalue),"const HermBandMatrix.diag1");
	Assert(h2cv.diag(-d)(j) == conj(hvalue),"HermBandMatrix.diag1 CV");
	Assert(h2v.diag(-d)(j) == conj(hvalue),"HermBandMatrix.diag1 V");
	Assert(h2.diag(-d,j,N+d)(0) == conj(hvalue),"HermBandMatrix.diag2");
	Assert(h2x.diag(-d,j,N+d)(0) == conj(hvalue),"const HermBandMatrix.diag2");
	Assert(h2cv.diag(-d,j,N+d)(0) == conj(hvalue),"HermBandMatrix.diag2 CV");
	Assert(h2v.diag(-d,j,N+d)(0) == conj(hvalue),"HermBandMatrix.diag2 V");
	Assert(s2f.diag(-d)(j+1) == value,"SymBandMatrixF.diag1");
	Assert(s2fx.diag(-d)(j+1) == value,"const SymBandMatrixF.diag1");
	Assert(s2fcv.diag(-d)(j+1) == value,"SymBandMatrixF.diag1 CV");
	Assert(s2fv.diag(-d)(j+1) == value,"SymBandMatrixF.diag1 V");
	...
	Assert(s2fcv.diag(-d,j+1,N+d)(1) == value,"SymBandMatrixF.diag2 CV");
	Assert(s2fv.diag(-d,j+1,N+d)(1) == value,"SymBandMatrixF.diag2 V");
	Assert(h2f.diag(-d)(j+1) == conj(hvalue),"HermBandMatrixF.diag1");
	Assert(h2fx.diag(-d)(j+1) == conj(hvalue),"const HermBandMatrixF.diag1");
	Assert(h2fcv.diag(-d)(j+1) == conj(hvalue),"HermBandMatrixF.diag1 CV");
	Assert(h2fv.diag(-d)(j+1) == conj(hvalue),"HermBandMatrixF.diag1 V");
	Assert(h2f.diag(-d,j+1,N+d)(1) == conj(hvalue),"HermBandMatrixF.diag2");
	Assert(h2fx.diag(-d,j+1,N+d)(1) == conj(hvalue),"const HermBandMatrixF.diag2");
	Assert(h2fcv.diag(-d,j+1,N+d)(1) == conj(hvalue),"HermBandMatrixF.diag2 CV");
	Assert(h2fv.diag(-d,j+1,N+d)(1) == conj(hvalue),"HermBandMatrixF.diag2 V");
      }
    }
  }
  ...
  for (size_t i=0; i<N; ++i) for (size_t j=0; j<N; ++j) {
    if ( j <= i + noff && i <= j + noff) {
      ...
      Assert(h3(j,i) == conj(h1(i,j)-h2(i,j)),"Subtract HermBandMatrices2");
    }
  }
  ...
  Assert(s1.Real()==sur.Real(),"SymBandMatrix.Real == SymBandMatrix<U,R>.Real");
  Assert(s1.Imag()==sur.Imag(),"SymBandMatrix.Imag == SymBandMatrix<U,R>.Imag");
  ...
  fin >> xs5 >> xh5;
  fin.close();
  Assert(tmv::Matrix<std::complex<T> >(s1) == *xsm5,"SymBandMatrix I/O check #5");
  Assert(tmv::Matrix<std::complex<T> >(h1) == *xhm5,"HermBandMatrix I/O check #5");
  ...
  //system("rm tmvtest_symbandmatrix_io.dat");
#endif
}
...
template <class T> void TestSymBandMatrix() 
{
  ...
  std::cout<<"SymBandMatrix<"<<tmv::Type(T())<<"> passed all basic tests\n";
  TestSymBandMatrixArith_A<T>();
  std::cout<<"SymBandMatrix<"<<tmv::Type(T())<<"> (SymBand/SymBand) Arithmetic passed all tests\n";
  TestSymBandMatrixArith_B1<T>();
  TestSymBandMatrixArith_B2<T>();
  std::cout<<"SymBandMatrix<"<<tmv::Type(T())<<"> (Matrix/SymBand) Arithmetic passed all tests\n";
  TestSymBandMatrixArith_C1<T>();
  TestSymBandMatrixArith_C2<T>();
  std::cout<<"SymBandMatrix<"<<tmv::Type(T())<<"> (Diag/SymBand) Arithmetic passed all tests\n";
  TestSymBandMatrixArith_D1<T>();
  TestSymBandMatrixArith_D2<T>();
  std::cout<<"SymBandMatrix<"<<tmv::Type(T())<<"> (Tri/SymBand) Arithmetic passed all tests\n";
  TestSymBandMatrixArith_E1<T>();
  TestSymBandMatrixArith_E2<T>();
  std::cout<<"SymBandMatrix<"<<tmv::Type(T())<<"> (Band/SymBand) Arithmetic passed all tests\n";
  TestSymBandMatrixArith_F1<T>();
  TestSymBandMatrixArith_F2<T>();
  std::cout<<"SymBandMatrix<"<<tmv::Type(T())<<"> (Sym/SymBand) Arithmetic passed all tests\n";
}
