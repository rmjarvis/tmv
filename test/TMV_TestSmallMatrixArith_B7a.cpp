...
template <class T, int N> static void DoTestSmallMatrixArith_B7a()
{
...
template <class T> void TestSmallMatrixArith_B7a()
{
  ...
  DoTestSmallMatrixArith_B7a<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B7a<T,1>();
  DoTestSmallMatrixArith_B7a<T,3>();
  DoTestSmallMatrixArith_B7a<T,4>();
  DoTestSmallMatrixArith_B7a<T,22>();
  DoTestSmallMatrixArith_B7a<T,555>();
#endif
}
