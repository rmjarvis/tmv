...
template <class T, int N> static void DoTestSmallMatrixArith_B5a()
{
  ...
  TestMatrixArith5<T>(a3,ca3,a2,ca2,"NonSquare");
  TestMatrixArith5<T>(a4,ca4,a1,ca1,"NonSquare");
  TestMatrixArith5<T>(a4,ca4,a2,ca2,"NonSquare");
  //TestMatrixArith5<T>(a3f,ca3f,a1,ca1,"NonSquare");
  //TestMatrixArith5<T>(a3f,ca3f,a1f,ca1f,"NonSquare");
#endif
}
...
template <class T> void TestSmallMatrixArith_B5a()
{
  ...
  DoTestSmallMatrixArith_B5a<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B5a<T,1>();
  DoTestSmallMatrixArith_B5a<T,3>();
  DoTestSmallMatrixArith_B5a<T,4>();
  DoTestSmallMatrixArith_B5a<T,22>();
  DoTestSmallMatrixArith_B5a<T,555>();
#endif
}
