...
static void DoTestSmallMatrixArith_A4a()
{
    ...
    TestMatrixArith4(a1f,ca1f,a2,ca2,"Square");
    TestMatrixArith4(a1f,ca1f,a2f,ca2f,"Square");
#endif
}

template <class T> 
void TestSmallMatrixArith_A4a()
{
    DoTestSmallMatrixArith_A4a<T,2>();
    DoTestSmallMatrixArith_A4a<T,5>();
#if (XTEST & 2)
    DoTestSmallMatrixArith_A4a<T,1>();
    DoTestSmallMatrixArith_A4a<T,3>();
    DoTestSmallMatrixArith_A4a<T,4>();
#endif
}
