...
template <class T, int M, int N> void TestSmallMatrixArith_7(std::string label)
{
    ...
    tmv::SmallVector<T,N> v2x = a1x.row(0);
    tmv::SmallVector<CT,M> cv1x = ca1x.col(0);
    tmv::SmallVector<CT,N> cv2x = ca1x.row(0);
    tmv::SmallVectorView<T,M,1> v1 = v1x.view();
    tmv::SmallVectorView<T,N,1> v2 = v2x.view();
    tmv::SmallVectorView<CT,M,1> cv1 = cv1x.view();
    tmv::SmallVectorView<CT,N,1> cv2 = cv2x.view();
    ...
    v2s = v2;
    tmv::SmallVector<CT,5*M> cv15;
    tmv::SmallVectorView<CT,M,5> cv1s = cv15.subVector(0,5*M,5);
    cv1s = cv1;
    tmv::SmallVector<CT,5*N> cv25;
    tmv::SmallVectorView<CT,N,5> cv2s = cv25.subVector(0,5*N,5);
    cv2s = cv2;

    TestMatrixArith7<T>(a1,ca1,v1s,cv1s,v2,cv2,label+" ColMajor Step1");
    TestMatrixArith7<T>(a1,ca1,v1,cv1,v2s,cv2s,label+" ColMajor Step2");
    TestMatrixArith7<T>(a1,ca1,v1s,cv1s,v2s,cv2s,label+" ColMajor Step12");
    TestMatrixArith7<T>(a2,ca2,v2s,cv2s,v1,cv1,label+" RowMajor Step1");
    TestMatrixArith7<T>(a2,ca2,v2,cv2,v1s,cv1s,label+" RowMajor Step2");
    TestMatrixArith7<T>(a2,ca2,v2s,cv2s,v1s,cv1s,label+" RowMajor Step12");
    TestMatrixArith7<T>(a3,ca3,v1,cv1,v2,cv2,label+" NonMajor");
    TestMatrixArith7<T>(a3,ca3,v1s,cv1s,v2,cv2,label+" NonMajor Step1");
    TestMatrixArith7<T>(a3,ca3,v1,cv1,v2s,cv2s,label+" NonMajor Step2");
    ...
    TestMatrixArith7<T>(a2,ca2,v2v,cv2v,v1v,cv1v,label+" RowMajor");
#endif
}
