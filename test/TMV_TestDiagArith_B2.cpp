...
template <class T> void TestDiagMatrixArith_B2()
{
  ...
  TestMatrixArith45<T>(px,cpx,pv,cpv,av,cav, "SquareM/Diag");
  TestMatrixArith45<T>(qx,cqx,qv,cqv,av,cav, "NonSquareM/Diag");
  TestMatrixArith45<T>(rx,crx,rv,crv,av,cav, "DegenM/Diag");
}
