...
template <class T, tmv::StorageType stor, int N> static void TestSmallNonSquareDiv_B3a()
{
  ...
  tmv::SmallMatrix<T,N,N,stor> a2x = a2a;
  tmv::SmallMatrix<std::complex<T>,N,N,stor> c2x = c2a;

  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1,a2a,a4,c1,c2a,c4,"Square/NonSquare"); 
#ifdef XTEST
  ...
  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1f,a2a,a4,c1f,c2a,c4,"Square/NonSquare"); 
  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1f,a2fa,a4,c1f,c2fa,c4,"Square/NonSquare"); 
  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1f,a2fa,a4f,c1f,c2fa,c4f,"Square/NonSquare"); 
#endif
}
