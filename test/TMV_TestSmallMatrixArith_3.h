...
template <class T, int M, int N> void TestSmallMatrixArith_3(std::string label)
{
    ...
    TestMatrixArith3a<T>(a2,ca2,v2s,cv2s,v1,cv1,label+" RowMajor Step1");
    TestMatrixArith3a<T>(a2,ca2,v2,cv2,v1s,cv1s,label+" RowMajor Step2");
    TestMatrixArith3a<T>(a2,ca2,v2s,cv2s,v1s,cv1s,label+" RowMajor Step12");
    ...
    TestMatrixArith3b<T>(a2,ca2,v2s,cv2s,v1,cv1,label+" RowMajor Step1");
    TestMatrixArith3b<T>(a2,ca2,v2,cv2,v1s,cv1s,label+" RowMajor Step2");
    TestMatrixArith3b<T>(a2,ca2,v2s,cv2s,v1s,cv1s,label+" RowMajor Step12");
