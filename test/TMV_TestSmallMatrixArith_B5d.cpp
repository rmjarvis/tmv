...
template <class T, int N> static void DoTestSmallMatrixArith_B5d()
{
  ...
  TestMatrixArith5<T>(a5,ca5,a3,ca3,"NonSquare");
#ifdef XTEST
  ...
  TestMatrixArith5<T>(a5,ca5,a4,ca4,"NonSquare");
  TestMatrixArith5<T>(a6,ca6,a3,ca3,"NonSquare");
  TestMatrixArith5<T>(a6,ca6,a4,ca4,"NonSquare");
  //TestMatrixArith5<T>(a5f,ca5f,a3,ca3,"NonSquare");
  //TestMatrixArith5<T>(a5f,ca5f,a3f,ca3f,"NonSquare");
#endif
}
...
template <class T> void TestSmallMatrixArith_B5d()
{
  ...
  DoTestSmallMatrixArith_B5d<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B5d<T,1>();
  DoTestSmallMatrixArith_B5d<T,3>();
  DoTestSmallMatrixArith_B5d<T,4>();
  DoTestSmallMatrixArith_B5d<T,22>();
  DoTestSmallMatrixArith_B5d<T,555>();
#endif
}
