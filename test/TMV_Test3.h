...
template <class T> void TestSmallSquareDiv_h();
template <class T> void TestSmallSquareDiv_i();
template <class T> void TestSmallSquareDiv_j();
...
template <class T> void TestSmallNonSquareDiv_h();
template <class T> void TestSmallNonSquareDiv_i();
template <class T> void TestSmallNonSquareDiv_j();
