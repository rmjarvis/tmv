...
void TestSymMatrixArith_D2()
{
    ...
    for(size_t i=START;i<s.size();i++) {
        ...
        TestMatrixArith4(u1v,cu1v,si,csi,"UpperTri/Sym");
        TestMatrixArith5(u1v,cu1v,si,csi,"UpperTri/Sym");
        TestMatrixArith6x(u1v,cu1v,si,csi,"UpperTri/Sym");
        TestMatrixArith4(l1v,cl1v,si,csi,"LowerTri/Sym");
        TestMatrixArith5(l1v,cl1v,si,csi,"LowerTri/Sym");
        TestMatrixArith6x(l1v,cl1v,si,csi,"LowerTri/Sym");
        TestMatrixArith4(u2v,cu2v,si,csi,"UpperTri/Sym");
        TestMatrixArith5(u2v,cu2v,si,csi,"UpperTri/Sym");
        TestMatrixArith6x(u2v,cu2v,si,csi,"UpperTri/Sym");
        TestMatrixArith4(l2v,cl2v,si,csi,"LowerTri/Sym");
        TestMatrixArith5(l2v,cl2v,si,csi,"LowerTri/Sym");
        TestMatrixArith6x(l2v,cl2v,si,csi,"LowerTri/Sym");
        TestMatrixArith4(u3v,cu3v,si,csi,"UpperTri/Sym");
        TestMatrixArith5(u3v,cu3v,si,csi,"UpperTri/Sym");
        TestMatrixArith6x(u3v,cu3v,si,csi,"UpperTri/Sym");
        TestMatrixArith4(l3v,cl3v,si,csi,"LowerTri/Sym");
        TestMatrixArith5(l3v,cl3v,si,csi,"LowerTri/Sym");
        TestMatrixArith6x(l3v,cl3v,si,csi,"LowerTri/Sym");
        TestMatrixArith4(u4v,cu4v,si,csi,"UpperTri/Sym");
        TestMatrixArith5(u4v,cu4v,si,csi,"UpperTri/Sym");
        TestMatrixArith6x(u4v,cu4v,si,csi,"UpperTri/Sym");
        TestMatrixArith4(l4v,cl4v,si,csi,"LowerTri/Sym");
        TestMatrixArith5(l4v,cl4v,si,csi,"LowerTri/Sym");
        TestMatrixArith6x(l4v,cl4v,si,csi,"LowerTri/Sym");
    }
#endif
}
