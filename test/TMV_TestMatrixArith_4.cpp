...
void TestMatrixArith_4()
{
    ...
    TestMatrixArith4(a1f,ca1f,a2f,ca2f,"Square 1F");
    TestMatrixArith4(a2f,ca2f,a1f,ca1f,"Square 2F");
#endif
    ...
    TestMatrixArith4(a4,ca4,a6,ca6,"Degenerate 3");
    TestMatrixArith4(a5,ca5,a6,ca6,"Degenerate 4");
    TestMatrixArith4(a1,ca1,a7,ca7,"Degenerate 5");
    TestMatrixArith4(a2,ca2,a7,ca7,"Degenerate 6");
    TestMatrixArith4(a4,ca4,a7,ca7,"Degenerate 7");
    TestMatrixArith4(a5,ca5,a7,ca7,"Degenerate 8");
    TestMatrixArith4(a6,ca6,a1,ca1,"Degenerate 9");
    TestMatrixArith4(a6,ca6,a2,ca2,"Degenerate 10");
    TestMatrixArith4(a6,ca6,a4,ca4,"Degenerate 11");
    TestMatrixArith4(a6,ca6,a5,ca5,"Degenerate 12");
    TestMatrixArith4(a7,ca7,a1,ca1,"Degenerate 13");
    TestMatrixArith4(a7,ca7,a2,ca2,"Degenerate 14");
    TestMatrixArith4(a7,ca7,a4,ca4,"Degenerate 15");
    TestMatrixArith4(a7,ca7,a5,ca5,"Degenerate 16");
    TestMatrixArith4(a7,ca7,a6,ca6,"Degenerate 17");
    TestMatrixArith4(a6,ca6,a7,ca7,"Degenerate 18");
#if (XTEST & 1)
    TestMatrixArith4(a3,ca3,a6,ca6,"Degenerate 19");
    TestMatrixArith4(a3,ca3,a7,ca7,"Degenerate 20");
    TestMatrixArith4(a6,ca6,a3,ca3,"Degenerate 21");
    TestMatrixArith4(a7,ca7,a3,ca3,"Degenerate 22");
#endif
#endif
}
