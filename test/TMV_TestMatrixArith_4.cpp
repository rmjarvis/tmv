...
template <class T> void TestMatrixArith_4()
{
    ...
    TestMatrixArith4<T>(a1,ca1,a2,ca2,"Square 1");
    TestMatrixArith4<T>(a2,ca2,a1,ca1,"Square 2");
    TestMatrixArith4<T>(a3,ca3,a1,ca1,"Square 3");
#ifdef XTEST
#if (XTEST & 2)
    TestMatrixArith4<T>(a1,ca1,a3,ca3,"Square 4");
    ...
    TestMatrixArith4<T>(a1,ca1,a4,ca4,"NonSquare 1");
    TestMatrixArith4<T>(a4,ca4,a1,ca1,"NonSquare 2");
    TestMatrixArith4<T>(a4,ca4,a5,ca5,"NonSquare 3");
    TestMatrixArith4<T>(a5,ca5,a4,ca4,"NonSquare 4");
#ifdef XTEST
#if (XTEST & 2)
    TestMatrixArith4<T>(a2,ca2,a4,ca4,"NonSquare 5");
    TestMatrixArith4<T>(a3,ca3,a4,ca4,"NonSquare 6");
    TestMatrixArith4<T>(a2,ca2,a5,ca5,"NonSquare 8");
    TestMatrixArith4<T>(a4,ca4,a2,ca2,"NonSquare 10");
    TestMatrixArith4<T>(a4,ca4,a3,ca3,"NonSquare 11");
    TestMatrixArith4<T>(a5,ca5,a1,ca1,"NonSquare 12");
    TestMatrixArith4<T>(a5,ca5,a2,ca2,"NonSquare 13");
    TestMatrixArith4<T>(a5,ca5,a3,ca3,"NonSquare 14");
#endif
    ...
    TestMatrixArith4<T>(a6,ca6,a1,ca1,"Degenerate 2");
    TestMatrixArith4<T>(a6,ca6,a7,ca7,"Degenerate 3");
    TestMatrixArith4<T>(a7,ca7,a6,ca6,"Degenerate 4");
    TestMatrixArith4<T>(a2,ca2,a6,ca6,"Degenerate 5");
    TestMatrixArith4<T>(a3,ca3,a6,ca6,"Degenerate 6");
    TestMatrixArith4<T>(a4,ca4,a6,ca6,"Degenerate 7");
    TestMatrixArith4<T>(a5,ca5,a6,ca6,"Degenerate 8");
    TestMatrixArith4<T>(a1,ca1,a7,ca7,"Degenerate 9");
    TestMatrixArith4<T>(a2,ca2,a7,ca7,"Degenerate 10");
    TestMatrixArith4<T>(a3,ca3,a7,ca7,"Degenerate 11");
    TestMatrixArith4<T>(a4,ca4,a7,ca7,"Degenerate 12");
    TestMatrixArith4<T>(a5,ca5,a7,ca7,"Degenerate 13");
    TestMatrixArith4<T>(a6,ca6,a2,ca2,"Degenerate 14");
    TestMatrixArith4<T>(a6,ca6,a3,ca3,"Degenerate 15");
    TestMatrixArith4<T>(a6,ca6,a4,ca4,"Degenerate 16");
    TestMatrixArith4<T>(a6,ca6,a5,ca5,"Degenerate 17");
    TestMatrixArith4<T>(a7,ca7,a1,ca1,"Degenerate 18");
    TestMatrixArith4<T>(a7,ca7,a2,ca2,"Degenerate 19");
    TestMatrixArith4<T>(a7,ca7,a3,ca3,"Degenerate 20");
    TestMatrixArith4<T>(a7,ca7,a4,ca4,"Degenerate 21");
    TestMatrixArith4<T>(a7,ca7,a5,ca5,"Degenerate 22");
#endif
#endif
}
