...
static void TestSmallSquareDiv_A1c()
{
    ...
    TestMatrixDivArith3e(tmv::LU,a1,b,x,c1,e,y,"V/Square"); 
#if (XTEST & 32)
    ...
    TestMatrixDivArith3e(tmv::LU,a1f,b,x,c1f,e,y,"V/Square"); 
    TestMatrixDivArith3e(tmv::LU,a1f,bf,x,c1f,ef,y,"V/Square"); 
    TestMatrixDivArith3e(tmv::LU,a1f,bf,xf,c1f,ef,yf,"V/Square"); 
#endif
}

template <class T> 
void TestSmallMatrixDiv_A1c()
{
    ...
    TestSmallSquareDiv_A1c<T,tmv::RowMajor,1>();
    TestSmallSquareDiv_A1c<T,tmv::RowMajor,2>();
    TestSmallSquareDiv_A1c<T,tmv::RowMajor,3>();
    TestSmallSquareDiv_A1c<T,tmv::RowMajor,4>();
    TestSmallSquareDiv_A1c<T,tmv::RowMajor,5>();
#endif
}

#ifdef TEST_DOUBLE
template void TestSmallMatrixDiv_A1c<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixDiv_A1c<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixDiv_A1c<long double>();
#endif
