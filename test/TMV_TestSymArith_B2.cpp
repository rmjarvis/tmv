...
template <class T> void TestSymMatrixArith_B2()
{
  ...
  for(size_t i=START;i<s.size();i++) {
    ...
    if (csi.isherm()) {
      ...
      TestMatrixArith45<T>(a1x,ca1x,a1v,ca1v,si,csi,"SquareM/Herm");
      TestMatrixArith45<T>(a3x,ca3x,a3v,ca3v,si,csi,"NonSquareM/Herm");
      TestMatrixArith45<T>(a4x,ca4x,a4v,ca4v,si,csi,"DegenerateM/Herm");
    } else {
      tmv::SymMatrix<T> sx = si;
      tmv::SymMatrix<std::complex<T> > csx = csi;

      TestMatrixArith45<T>(a1x,ca1x,a1v,ca1v,si,csi,"SquareM/Sym");
      TestMatrixArith45<T>(a3x,ca3x,a3v,ca3v,si,csi,"NonSquareM/Sym");
      TestMatrixArith45<T>(a4x,ca4x,a4v,ca4v,si,csi,"DegenerateM/Sym");
    }
  }
#endif
}
