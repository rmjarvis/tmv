...
namespace tmv {
  ...
  template <class T> class GenDiagMatrix : public BaseMatrix<T>
  {
	...
	InverseATA(DiagMatrixViewOf(minv.diag()));
      ...
      inline void Inverse(DiagMatrix<T>& minv) const
      { Inverse(minv.View()); }

      inline void InverseATA(DiagMatrix<T>& minv) const
    ...
    public GenDiagMatrix<T>
  {
	...
	return *this;
      ...
      inline const DiagMatrixView<T>& Clip(RealType(T) thresh) const
    ...
    public GenDiagMatrix<T>
  {
	...
	return *this; 
      ...
      inline DiagMatrix<T>& Clip(RealType(T) thresh)
      { diag().Clip(thresh); return *this; }
