...
namespace tmv {
    ...
    public GenUpperTriMatrix<T>
  {
    public :
      ...
      ConstUpperTriMatrixView(const ConstUpperTriMatrixView<T,I>& rhs) :
  ...
  template <class T> class ConstUpperTriMatrixView<T,FortranStyle> : 
	...
	ConstUpperTriMatrixView(const GenUpperTriMatrix<T>& rhs, DiagType d) :
	  ConstUpperTriMatrixView<T,CStyle>(rhs,d) {}
	...
	ConstUpperTriMatrixView(const GenMatrix<T>& rhs, DiagType dt) : 
	  ConstUpperTriMatrixView<T,CStyle>(rhs,dt) {}
    ...
    public GenLowerTriMatrix<T>
  {
    public :
      ...
      ConstLowerTriMatrixView(const ConstLowerTriMatrixView<T,I>& rhs) :
  ...
  template <class T> class ConstLowerTriMatrixView<T,FortranStyle> : 
	...
	ConstLowerTriMatrixView(const GenLowerTriMatrix<T>& rhs, DiagType d) :
	  ConstLowerTriMatrixView<T,CStyle>(rhs,d) {}
	...
	ConstLowerTriMatrixView(const GenMatrix<T>& rhs, DiagType dt) : 
	  ConstLowerTriMatrixView<T,CStyle>(rhs,dt) {}
    ...
    public GenUpperTriMatrix<T>
  {
    ...
    public:
      ...
      UpperTriMatrixView(const UpperTriMatrixView<T,I>& rhs) : 
    ...
    public GenLowerTriMatrix<T>
  {
    ...
    public:
      ...
      LowerTriMatrixView(const LowerTriMatrixView<T,I>& rhs) : 
	GenLowerTriMatrix<T>(rhs), itsm(rhs.itsm), itss(rhs.itss), 
	itssi(rhs.itssi), itssj(rhs.itssj)
	  DEFFIRSTLAST(rhs.first,rhs.last) {}

      LowerTriMatrixView(const LowerTriMatrixView<T,I>& rhs, DiagType d) : 
  ...
  template <class T> class UpperTriMatrixView<T,FortranStyle> : 
	...
	UpperTriMatrixView(const UpperTriMatrixView<T,FortranStyle>& rhs) : 
	  UpperTriMatrixView<T,CStyle>(rhs) {}

	UpperTriMatrixView(const UpperTriMatrixView<T,CStyle>& rhs) : 
	  UpperTriMatrixView<T,CStyle>(rhs) {}

	UpperTriMatrixView(const UpperTriMatrixView<T>& rhs, DiagType d) : 
	  UpperTriMatrixView<T,CStyle>(rhs,d) {}
	...
	UpperTriMatrixView(const MatrixView<T>& rhs, DiagType dt) : 
	  UpperTriMatrixView<T,CStyle>(rhs,dt) {}
	...
	inline const UpperTriMatrixView<T,FortranStyle>& operator=(
	    const UpperTriMatrixComposite<T>& mcomp) const
	{ UpperTriMatrixView<T,CStyle>::operator=(mcomp); return *this; }
  ...
  template <class T> class LowerTriMatrixView<T,FortranStyle> : 
	...
	LowerTriMatrixView(const LowerTriMatrixView<T,FortranStyle>& rhs) : 
	  LowerTriMatrixView<T,CStyle>(rhs) {}

	LowerTriMatrixView(const LowerTriMatrixView<T,CStyle>& rhs) : 
	  LowerTriMatrixView<T,CStyle>(rhs) {}

	LowerTriMatrixView(const LowerTriMatrixView<T>& rhs, DiagType d) : 
	  LowerTriMatrixView<T,CStyle>(rhs,d) {}
	...
	LowerTriMatrixView(const MatrixView<T>& rhs, DiagType dt) : 
	  LowerTriMatrixView<T,CStyle>(rhs,dt) {}
	...
	inline const LowerTriMatrixView<T,FortranStyle>& operator=(
	    const LowerTriMatrixComposite<T>& mcomp) const
	{ LowerTriMatrixView<T,CStyle>::operator=(mcomp); return *this; }
...
#define NEW_SIZE(s) GenUpperTriMatrix<T>(D,S,NonConj), \
	...
	UpperTriMatrix(const UpperTriMatrix<T,D,S,I>& rhs) :
	...
	template <DiagType D2, IndexStyle I2> UpperTriMatrix(
	...
	template <DiagType D2, StorageType S2, IndexStyle I2> UpperTriMatrix(
	...
	template <StorageType S2, IndexStyle I2> UpperTriMatrix(
...
#define NEW_SIZE(s) GenLowerTriMatrix<T>(D,S,NonConj), \
	...
	LowerTriMatrix(const LowerTriMatrix<T,D,S,I>& rhs) :
	...
	template <DiagType D2, IndexStyle I2> LowerTriMatrix(
	...
	template <DiagType D2, StorageType S2, IndexStyle I2> LowerTriMatrix(
	...
	template <StorageType S2, IndexStyle I2> LowerTriMatrix(
	    const Matrix<T,S2,I2>& rhs) :
...
//---------------------------------------------------------------------------
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()>=m.rowsize());
      return ConstUpperTriMatrixView<T,I>(m.Rows(0,m.rowsize()),dt); 
    }
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()>=m.rowsize());
      return UpperTriMatrixView<T,I>(m.Rows(0,m.rowsize()),dt); 
    }
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()>=m.rowsize());
      TMVAssert(!(m.dt()==UnitDiag && dt==NonUnitDiag));
      return ConstUpperTriMatrixView<T,I>(m,dt); 
    }
  ...
  template <class T, DiagType D, StorageType S, IndexStyle I>
	...
	const UpperTriMatrix<T,D,S,I>& m, DiagType dt)
    {
      ...
      return ConstUpperTriMatrixView<T,I>(m.View(),dt); 
    }
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()>=m.rowsize());
      TMVAssert(!(m.dt()==UnitDiag && dt==NonUnitDiag));
      return UpperTriMatrixView<T,I>(m,dt); 
    }
  ...
  template <class T, DiagType D, StorageType S, IndexStyle I>
	...
	UpperTriMatrix<T,D,S,I>& m, DiagType dt)
    {
      TMVAssert(m.colsize()>=m.rowsize());
      TMVAssert(!(D==UnitDiag && dt==NonUnitDiag));
      return UpperTriMatrixView<T,I>(m.View(),dt); 
    }
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()<=m.rowsize());
      return ConstLowerTriMatrixView<T,I>(m.Cols(0,m.colsize()),dt); 
    }
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()<=m.rowsize());
      return LowerTriMatrixView<T,I>(m.Cols(0,m.colsize()),dt); 
    }
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()<=m.rowsize());
      TMVAssert(!(m.dt()==UnitDiag && dt==NonUnitDiag));
      return ConstLowerTriMatrixView<T,I>(m,dt); 
    }
  ...
  template <class T, DiagType D, StorageType S, IndexStyle I> 
	...
	const LowerTriMatrix<T,D,S,I>& m, DiagType dt)
    {
      TMVAssert(m.colsize()<=m.rowsize());
      TMVAssert(!(D==UnitDiag && dt==NonUnitDiag));
      return ConstLowerTriMatrixView<T,I>(m.View(),dt); 
    }
  ...
  template <class T, IndexStyle I> 
    ...
    { 
      TMVAssert(m.colsize()<=m.rowsize());
      TMVAssert(!(m.dt()==UnitDiag && dt==NonUnitDiag));
      return LowerTriMatrixView<T,I>(m,dt); 
    }
  ...
  template <class T, DiagType D, StorageType S, IndexStyle I> 
	...
	LowerTriMatrix<T,D,S,I>& m, DiagType dt)
    {
      TMVAssert(m.colsize()<=m.rowsize());
      TMVAssert(!(D==UnitDiag && dt==NonUnitDiag));
      return LowerTriMatrixView<T,I>(m.View(),dt); 
    }
  ...
  template <class T, DiagType D, StorageType S, IndexStyle I> 
    istream& operator>>(istream& is, UpperTriMatrix<T,D,S,I>*& m);
  template <class T, DiagType D, StorageType S, IndexStyle I> 
    istream& operator>>(istream& is, LowerTriMatrix<T,D,S,I>*& m);
  ...
  template <class T, DiagType D, StorageType S, IndexStyle I> 
    inline string Type(const UpperTriMatrix<T,D,S>& m)
    { 
