...
namespace tmv {
  ...
  { AddMM(alpha,A.QuickTranspose(),beta,B.QuickTranspose()); }
  ...
  { MultMM(alpha,B.QuickTranspose(),A.QuickTranspose(),beta,C.QuickTranspose()); }
  template <class T, class Ta, class Tb> inline void MultMM(
      const T alpha, const GenMatrix<Ta>& A, 
  ...
  template <class T, class T2> class SumUTX : 
    public UpperTriMatrixComposite<T>
  {
    public:
      SumUTX(T _x1, const GenUpperTriMatrix<T2>& _m2, T _x3) :
  ...
  template <class T, class T2> class SumLTX : 
    public LowerTriMatrixComposite<T>
  {
    public:
      SumLTX(T _x1, const GenLowerTriMatrix<T2>& _m2, T _x3) :
  ...
  template <class T, class T2> class ProdXUT : 
    public UpperTriMatrixComposite<T> 
  {
    public:
      ProdXUT(const T _x1, const GenUpperTriMatrix<T2>& _m2) :
	UpperTriMatrixComposite<T>(NonUnitDiag, BaseStorOf(_m2)),
	x1(_x1), m2(&_m2) {}
      inline size_t size() const { return m2->size(); }
  ...
  template <class T, class T2> class ProdXLT : 
    public LowerTriMatrixComposite<T> 
  {
    public:
      ProdXLT(const T _x1, const GenLowerTriMatrix<T2>& _m2) :
	LowerTriMatrixComposite<T>(NonUnitDiag, BaseStorOf(_m2)),
	x1(_x1), m2(&_m2) {}
      inline size_t size() const { return m2->size(); }
      inline T GetX1() const { return x1; }
  ...
  template <class T, class T2, class T4> class SumUTUT : 
    public UpperTriMatrixComposite<T> 
  {
    public:
      SumUTUT(T _x1, const GenUpperTriMatrix<T2>& _m2, 
	  T _x3, const GenUpperTriMatrix<T4>& _m4) :
	UpperTriMatrixComposite<T>(NonUnitDiag, _m2.stor()),
  ...
  template <class T, class T2, class T4> class SumLTLT : 
    public LowerTriMatrixComposite<T> 
  {
    public:
      SumLTLT(T _x1, const GenLowerTriMatrix<T2>& _m2, 
	  T _x3, const GenLowerTriMatrix<T4>& _m4) :
	LowerTriMatrixComposite<T>(NonUnitDiag, _m2.stor()),
	x1(_x1),m2(&_m2),x3(_x3),m4(&_m4)
      { TMVAssert(m2->size() == m4->size()); }
      inline size_t size() const { return m2->size(); }
      inline T GetX1() const { return x1; }
  ...
  template <class T, class T2, class T4> class SumUTLT : 
    public MatrixComposite<T> 
  {
    public:
      SumUTLT(T _x1, const GenUpperTriMatrix<T2>& _m2, 
	  T _x3, const GenLowerTriMatrix<T4>& _m4) :
	MatrixComposite<T>(_m2.stor()),
	x1(_x1),m2(&_m2),x3(_x3),m4(&_m4)
      {  TMVAssert(m2->size() == m4->size()); }
  ...
  template <class T, class T2, class T4> class SumLTUT : 
    public MatrixComposite<T> 
  {
    public:
      SumLTUT(T _x1, const GenLowerTriMatrix<T2>& _m2, 
	  T _x3, const GenUpperTriMatrix<T4>& _m4) :
	MatrixComposite<T>(_m2.stor()),
	x1(_x1),m2(&_m2),x3(_x3),m4(&_m4)
      {  TMVAssert(m2->size() == m4->size()); }
  ...
  template <class T, class T2, class T3> class ProdUTUT : 
    public UpperTriMatrixComposite<T>
  {
    public:
      ProdUTUT(T _x1, const GenUpperTriMatrix<T2>& _m2,
	  const GenUpperTriMatrix<T3>& _m3) :
	UpperTriMatrixComposite<T>((_m2.isunit()&&_m3.isunit()&&_x1==T(1)) ?
	    UnitDiag : NonUnitDiag,
	    _m2.stor()), x1(_x1), m2(&_m2), m3(&_m3)
  ...
  template <class T, class T2, class T3> 
	...
	const UpperTriMatrixView<T>& m, const ProdUTUT<T,T2,T3>& pmm)
    { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m); return m; }

  template <class T> inline const UpperTriMatrixView<CT>& operator+=(
      const UpperTriMatrixView<CT>& m, const ProdUTUT<T,T,T>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m.Real()); return m; }
  ...
  template <class T, class T2, class T3> class ProdLTLT : 
    public LowerTriMatrixComposite<T>
  {
    public:
      ProdLTLT(T _x1, const GenLowerTriMatrix<T2>& _m2,
  ...
  template <class T, class T2, class T3> 
	...
	const LowerTriMatrixView<T>& m, const ProdLTLT<T,T2,T3>& pmm)
    { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m); return m; }

  template <class T> inline const LowerTriMatrixView<CT>& operator+=(
      const LowerTriMatrixView<CT>& m, const ProdLTLT<T,T,T>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m.Real()); return m; }
  ...
  template <class T, class T2, class T3> class ProdUTLT : 
    public MatrixComposite<T>
  {
    public:
      ProdUTLT(T _x1, const GenUpperTriMatrix<T2>& _m2,
	  const GenLowerTriMatrix<T3>& _m3) :
	MatrixComposite<T>(_m2.stor()), x1(_x1), m2(&_m2), m3(&_m3)
      { TMVAssert( m2->size() == m3->size()); }
      inline size_t colsize() const { return m2->size(); }
      inline size_t rowsize() const { return m2->size(); }
      inline T GetX1() const { return x1; }
  ...
  template <class T, class T2, class T3> inline const MatrixView<T>& operator+=(
      const MatrixView<T>& m, const ProdUTLT<T,T2,T3>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m); return m; }

  template <class T> inline const MatrixView<CT>& operator+=(
      const MatrixView<CT>& m, const ProdUTLT<T,T,T>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m.Real()); return m; }
  ...
  template <class T, class T2, class T3> class ProdLTUT : 
    public MatrixComposite<T>
  {
    public:
      ProdLTUT(T _x1, const GenLowerTriMatrix<T2>& _m2,
	  const GenUpperTriMatrix<T3>& _m3) :
	MatrixComposite<T>(_m2.stor()), x1(_x1), m2(&_m2), m3(&_m3)
      { TMVAssert( m2->size() == m3->size()); }
      inline size_t colsize() const { return m2->size(); }
  ...
  template <class T, class T2, class T3> inline const MatrixView<T>& operator+=(
      const MatrixView<T>& m, const ProdLTUT<T,T2,T3>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m); return m; }

  template <class T> inline const MatrixView<CT>& operator+=(
      const MatrixView<CT>& m, const ProdLTUT<T,T,T>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m.Real()); return m; }
  ...
  template <class T0, class T1, class T2> class QuotUTUT : 
    public UpperTriMatrixComposite<T0>
  {
    public:
      QuotUTUT(const GenUpperTriMatrix<T1>& _m1,
	  const GenUpperTriMatrix<T2>& _m2) :
	UpperTriMatrixComposite<T0>(
	    _m1.dt()==_m2.dt() ? _m1.dt() : NonUnitDiag, _m2.stor()),
	m1(&_m1), m2(&_m2)
  ...
  template <class T0, class T1, class T2> class RQuotUTUT : 
    public UpperTriMatrixComposite<T0>
  {
    public:
      RQuotUTUT(const GenUpperTriMatrix<T1>& _m1,
	  const GenUpperTriMatrix<T2>& _m2) :
	UpperTriMatrixComposite<T0>(
	    _m1.dt()==_m2.dt() ? _m1.dt() : NonUnitDiag, _m2.stor()),
	m1(&_m1), m2(&_m2)
  ...
  template <class T0, class T1, class T2> class QuotLTLT : 
    public LowerTriMatrixComposite<T0>
  {
    public:
      QuotLTLT(const GenLowerTriMatrix<T1>& _m1,
  ...
  template <class T0, class T1, class T2> class RQuotLTLT : 
    public LowerTriMatrixComposite<T0>
  {
    public:
      RQuotLTLT(const GenLowerTriMatrix<T1>& _m1,
	  const GenLowerTriMatrix<T2>& _m2) :
	LowerTriMatrixComposite<T0>(
	    _m1.dt()==_m2.dt() ? _m1.dt() : NonUnitDiag, _m2.stor()),
	m1(&_m1), m2(&_m2)
  ...
  template <class T0, class T1, class T2> class QuotXUT : 
    public UpperTriMatrixComposite<T0> 
  {
    public:
      QuotXUT(const T1 _x1, const GenUpperTriMatrix<T2>& _m2) :
  ...
  template <class T0, class T1, class T2> class QuotXLT : 
    public LowerTriMatrixComposite<T0> 
  {
    public:
      QuotXLT(const T1 _x1, const GenLowerTriMatrix<T2>& _m2) :
...
#define SUMMM SumMUT
#define SUMMX SumUTX
#define PRODXM ProdXUT
#define PRODMV ProdUTV
#define PRODMM ProdMUT
#define QUOTVM QuotVUT
#define RQUOTVM RQuotVUT
#define QUOTMM QuotMUT
#define RQUOTMM RQuotMUT
#define TQUOTMM TransientQuotMUT
#define TRQUOTMM TransientRQuotMUT
#define QUOTXM QuotXUT
...
#define SUMMM SumMLT
#define SUMMX SumLTX
#define PRODXM ProdXLT
#define PRODMV ProdLTV
#define PRODMM ProdMLT
#define QUOTVM QuotVLT
#define RQUOTVM RQuotVLT
#define QUOTMM QuotMLT
#define RQUOTMM RQuotMLT
#define TQUOTMM TransientQuotMLT
#define TRQUOTMM TransientRQuotMLT
#define QUOTXM QuotXLT
...
#define PRODXM1 ProdXUT

#undef SUMMM
#undef PRODMM
#undef QUOTMM
#undef RQUOTMM
#define SUMMM SumUTLT
#define PRODMM ProdUTLT
#define QUOTMM QuotUTLT
#define RQUOTMM RQuotUTLT
...
#undef QUOTMM
#undef RQUOTMM
#define SUMMM SumUTUT
#define PRODMM ProdUTUT
#define QUOTMM QuotUTUT
#define RQUOTMM RQuotUTUT
...
#undef TQUOTMM
#undef TRQUOTMM
#define SUMMM SumLTUT
#define PRODMM ProdLTUT
#define QUOTMM QuotLTUT
#define RQUOTMM RQuotLTUT
#define TQUOTMM TransientQuotMUT
#define TRQUOTMM TransientRQuotMUT
...
#undef QUOTMM
#undef RQUOTMM
#define SUMMM SumLTLT
#define PRODMM ProdLTLT
#define QUOTMM QuotLTLT
#define RQUOTMM RQuotLTLT
...
#undef TQUOTMM
#undef TRQUOTMM
#define SUMMM1 SumMLT
#define SUMMM SumLTM
#define PRODMM ProdLTM
...
#undef SUMMM
#undef PRODMM
#define SUMMM1 SumMUT
#define SUMMM SumUTM
#define PRODMM ProdUTM
