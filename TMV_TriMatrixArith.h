...
namespace tmv {
  ...
  template <class T, class T2, class T3, bool trans> class ProdUU;
  template <class T, class T2, class T3, bool trans> class ProdLL;
  template <class T, class T2, class T3, bool trans> class ProdUL;
  template <class T, class T2, class T3, bool trans> class ProdLU;
  ...
  template <class T, class T2, class T3> class ProdUU<T,T2,T3,true> : 
    public ProdUL<T,T2,T3,false>
    { 
      public:
	ProdUU(T _x1, const GenUpperTriMatrix<T2>& _m2,
	    const GenUpperTriMatrix<T3>& _m3) :
	  ProdUL<T,T2,T3,false>(_x1,_m2,*(_m3.NewTranspose())) 
	{ delete this->m3; }
    };
  ...
  template <class T, class T2, class T3> 
	...
	const UpperTriMatrixView<T>& m, const ProdUU<T,T2,T3,false>& pmm)
  ...
  template <class T, class T2, class T3> class ProdLL<T,T2,T3,true> : 
    public ProdLU<T,T2,T3,false>
    { 
      public:
	ProdLL(T _x1, const GenLowerTriMatrix<T2>& _m2,
	    const GenLowerTriMatrix<T3>& _m3) :
  ...
  template <class T, class T2, class T3> 
	...
	const LowerTriMatrixView<T>& m, const ProdLL<T,T2,T3,false>& pmm)
    { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m); return m; }
  ...
  template <class T, class T2, class T3> class ProdUL<T,T2,T3,true> : 
    public ProdUU<T,T2,T3,false>
    { 
      public:
	ProdUL(T _x1, const GenUpperTriMatrix<T2>& _m2,
	    const GenLowerTriMatrix<T3>& _m3) :
	  ProdUU<T,T2,T3,false>(_x1,_m2,*(_m3.NewTranspose())) 
	{ delete this->m3; }
    };

  template <class T, class T2, class T3> inline const MatrixView<T>& operator+=(
      const MatrixView<T>& m, const ProdUL<T,T2,T3,false>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m); return m; }
  ...
  template <class T, class T2, class T3> class ProdLU<T,T2,T3,true> : 
    public ProdLL<T,T2,T3,false>
    { 
      public:
	ProdLU(T _x1, const GenUpperTriMatrix<T2>& _m2,
	    const GenLowerTriMatrix<T3>& _m3) :
	  ProdLL<T,T2,T3,false>(_x1,_m2,*(_m3.NewTranspose())) 
	{ delete this->m3; }
    };

  template <class T, class T2, class T3> inline const MatrixView<T>& operator+=(
      const MatrixView<T>& m, const ProdLU<T,T2,T3,false>& pmm)
  { MultMM(pmm.GetX1(),pmm.GetM2(),pmm.GetM3(),T(1),m); return m; }
