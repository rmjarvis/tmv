...
int main() try 
{
    ...
    //! Ainv*A = 
    //! 4  4
    //! (  1  -1.11022e-16  0  8.32667e-17  )
    //! (  1.11022e-16  1  -2.22045e-16  -1.66533e-16  )
    //! (  -4.44089e-16  -1.11022e-16  1  5.55112e-17  )
    //! (  0  -2.22045e-16  -1.11022e-16  1  )
    //! 
    
    // This is a case where it can be useful to see only those 
    ...
    //! CA*cx = 4 ( (3,-3.55271e-15)  (5,-1.77636e-15)  (7,1.9984e-15)  (9,-1.77636e-15) )
    std::cout<<"cx = cb/CA = \n"<<(cx=cb/CA)<<std::endl;
    //! cx = cb/CA = 
    ...
    try {
        ...
        //! Unstable x = b/A = 
        //! 4 ( 2.8506e+13  -3.42073e+13  -2.9984  5.70121e+12 )
        std::cout<<"A*x = \n"<<A4*x4<<std::endl;
        //! A*x = 
        //! 10 ( 248.75  398.438  248.25  -202  -951  -2001  -3351  -5000  -6946  -9200 )
    } catch (tmv::Error& e) {
