...
namespace tmv {
  ...
  // TODO: This is the same as the version in TMV_MultMV_C.cpp.
  // I should put it in a .h file and have them both include it.
  template <bool add, class T, class M1, class V2, class V3>
  static void DoMultMV2(const T x, const M1& m1, const V2& v2, V3& v3)
  {
...
#define InstFile "TMV_MultMV_R.inst"
#include "TMV_Inst.h"
#undef InstFile
