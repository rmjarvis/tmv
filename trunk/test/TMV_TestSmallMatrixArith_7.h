...
template <class T, int M, int N> void TestSmallMatrixArith_7(std::string label)
{
  ...
  TestMatrixArith7<T>(a2,ca2,v1,cv1,v2,cv2,label+" RowMajor");
  ...
  TestMatrixArith7<T>(a2,ca2,v1s,cv1s,v2,cv2,label+" RowMajor Step1");
  TestMatrixArith7<T>(a2,ca2,v1,cv1,v2s,cv2s,label+" RowMajor Step2");
  TestMatrixArith7<T>(a2,ca2,v1s,cv1s,v2s,cv2s,label+" RowMajor Step12");
