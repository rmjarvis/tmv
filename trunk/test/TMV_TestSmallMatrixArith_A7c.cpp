...
template <class T, int N> static void DoTestSmallMatrixArith_A7c()
{
...
template <class T> void TestSmallMatrixArith_A7c()
{
#ifdef DoLargeTest
  DoTestSmallMatrixArith_A7c<T,555>();
#endif
}


#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_A7c<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_A7c<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_A7c<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_A7c<int>();
#endif
