...
template <class T, tmv::StorageType stor, int N> static void TestSmallNonSquareDiv_B3b()
{
  ...
  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1,a2b,a4,c1,c2b,c4,"Square/NonSquare"); 
#ifdef XTEST
  ...
  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1f,a2b,a4,c1f,c2b,c4,"Square/NonSquare"); 
  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1f,a2fb,a4,c1f,c2fb,c4,"Square/NonSquare"); 
  TestMatrixDivArith3c<T>(tmv::QR,a2x,c2x,a1f,a2fb,a4f,c1f,c2fb,c4f,"Square/NonSquare"); 
#endif
}
