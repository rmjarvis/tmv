...
#if (XTEST & 2)
    TestMatrixArith4<T>(a5,ca5,a1,ca1,"NonSquare 5");
    TestMatrixArith4<T>(a1,ca2,a5,ca5,"NonSquare 6");
    TestMatrixArith4<T>(a2,ca2,a4,ca4,"NonSquare 7");
    TestMatrixArith4<T>(a2,ca2,a5,ca5,"NonSquare 8");
    TestMatrixArith4<T>(a4,ca4,a2,ca2,"NonSquare 9");
    TestMatrixArith4<T>(a5,ca5,a2,ca2,"NonSquare 10");
#if (XTEST & 1)
    TestMatrixArith4<T>(a3,ca3,a4,ca4,"NonSquare 11");
    TestMatrixArith4<T>(a3,ca3,a5,ca4,"NonSquare 12");
    TestMatrixArith4<T>(a4,ca4,a3,ca3,"NonSquare 13");
