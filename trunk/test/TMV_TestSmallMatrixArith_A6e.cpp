...
template <class T, int N> static void DoTestSmallMatrixArith_A6e()
{
...
template <class T> void TestSmallMatrixArith_A6e()
{
#ifdef DoLargeTest
  DoTestSmallMatrixArith_A6e<T,555>();
#endif
}


#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_A6e<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_A6e<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_A6e<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_A6e<int>();
#endif
