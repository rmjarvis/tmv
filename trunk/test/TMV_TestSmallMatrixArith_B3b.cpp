...
template <class T, int N> static void DoTestSmallMatrixArith_B3b()
{
...
template <class T> void TestSmallMatrixArith_B3b()
{
  ...
  DoTestSmallMatrixArith_B3b<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B3b<T,1>();
  DoTestSmallMatrixArith_B3b<T,3>();
  DoTestSmallMatrixArith_B3b<T,4>();
  DoTestSmallMatrixArith_B3b<T,22>();
  DoTestSmallMatrixArith_B3b<T,555>();
#endif
}
