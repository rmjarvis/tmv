...
template <class T, int M, int N> void TestSmallMatrixArith_3(std::string label)
{
    ...
    TestMatrixArith3a<T>(a1,ca1,v3,cv3,v2,cv2,label+" ColMajor Step1");
    TestMatrixArith3a<T>(a1,ca1,v1,cv1,v4,cv4,label+" ColMajor Step2");
    TestMatrixArith3a<T>(a1,ca1,v3,cv3,v4,cv4,label+" ColMajor Step12");
    TestMatrixArith3a<T>(a2,ca2,v4,cv4,v1,cv1,label+" RowMajor Step1");
    TestMatrixArith3a<T>(a2,ca2,v2,cv2,v3,cv3,label+" RowMajor Step2");
    TestMatrixArith3a<T>(a2,ca2,v4,cv4,v3,cv3,label+" RowMajor Step12");
    ...
    TestMatrixArith3a<T>(a1v,ca1v,v1,cv1,v2,cv2,label+" ColMajor");
    TestMatrixArith3a<T>(a1,ca1,v1v,cv1v,v2v,cv2v,label+" ColMajor");

    TestMatrixArith3b<T>(a1v,ca1v,v1,cv1,v2,cv2,label+" ColMajor");
