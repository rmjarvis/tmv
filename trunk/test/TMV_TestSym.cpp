...
template <class T, tmv::UpLoType U, tmv::StorageType S> static void TestBasicSymMatrix_1()
{
  const size_t N = 6;
...
template <class T, tmv::UpLoType U, tmv::StorageType S> static void TestBasicHermMatrix_1()
{
  const size_t N = 6;
...
template <class T, tmv::UpLoType U, tmv::StorageType S> static void TestBasicSymMatrix_2()
{
  const size_t N = 6;
...
template <class T, tmv::UpLoType U, tmv::StorageType S> static void TestBasicHermMatrix_2()
{
  const size_t N = 6;
...
template <class T, tmv::UpLoType U, tmv::StorageType S> static void TestBasicSymMatrix_IO()
{
  const size_t N = 6;
...
template <class T, tmv::UpLoType U, tmv::StorageType S> static void TestBasicSymMatrix()
{
...
template <class T> void TestSymMatrix() 
{
  ...
  std::cout<<"SymMatrix<"<<tmv::TypeText(T())<<"> passed all basic tests\n";

  if (tmv::Epsilon<T>() > T(0)) {
    TestSymMatrixArith_A<T>();
    std::cout<<"SymMatrix<"<<tmv::TypeText(T())<<"> (Sym/Sym) Arithmetic passed all tests\n";
    TestSymMatrixArith_B1<T>();
    TestSymMatrixArith_B2<T>();
    std::cout<<"SymMatrix<"<<tmv::TypeText(T())<<"> (Matrix/Sym) Arithmetic passed all tests\n";
    TestSymMatrixArith_C1<T>();
    TestSymMatrixArith_C2<T>();
    std::cout<<"SymMatrix<"<<tmv::TypeText(T())<<"> (Diag/Sym) Arithmetic passed all tests\n";
    TestSymMatrixArith_D1<T>();
    TestSymMatrixArith_D2<T>();
    std::cout<<"SymMatrix<"<<tmv::TypeText(T())<<"> (Tri/Sym) Arithmetic passed all tests\n";
    TestSymMatrixArith_E1<T>();
    TestSymMatrixArith_E2<T>();
    std::cout<<"SymMatrix<"<<tmv::TypeText(T())<<"> (Band/Sym) Arithmetic passed all tests\n";
  }
}
