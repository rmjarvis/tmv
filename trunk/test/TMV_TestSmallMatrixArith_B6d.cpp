...
template <class T, int N> static void DoTestSmallMatrixArith_B6d()
{
  ...
  TestMatrixArith6<T>(a5,ca5,a3,ca3,a1,ca1,"NonSquare");
#ifdef XTEST
  ...
  TestMatrixArith6<T>(a5,ca5,a3,ca3,a2,ca2,"NonSquare");
  TestMatrixArith6<T>(a5,ca5,a4,ca4,a1,ca1,"NonSquare");
  TestMatrixArith6<T>(a5,ca5,a4,ca4,a2,ca2,"NonSquare");
  TestMatrixArith6<T>(a6,ca6,a3,ca3,a1,ca1,"NonSquare");
  TestMatrixArith6<T>(a6,ca6,a3,ca3,a2,ca2,"NonSquare");
  TestMatrixArith6<T>(a6,ca6,a4,ca4,a1,ca1,"NonSquare");
  TestMatrixArith6<T>(a6,ca6,a4,ca4,a2,ca2,"NonSquare");
  TestMatrixArith6<T>(a5f,ca5f,a3,ca3,a1,ca1,"NonSquare");
  TestMatrixArith6<T>(a5f,ca5f,a3f,ca3f,a1,ca1,"NonSquare");
  TestMatrixArith6<T>(a5f,ca5f,a3f,ca3f,a1f,ca1f,"NonSquare");
#endif
}

template <class T> void TestSmallMatrixArith_B6d()
{
  DoTestSmallMatrixArith_B6d<T,2>();
  DoTestSmallMatrixArith_B6d<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B6d<T,1>();
  DoTestSmallMatrixArith_B6d<T,3>();
  DoTestSmallMatrixArith_B6d<T,4>();
  DoTestSmallMatrixArith_B6d<T,22>();
  DoTestSmallMatrixArith_B6d<T,555>();
#endif
}

#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_B6d<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_B6d<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_B6d<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_B6d<int>();
#endif
