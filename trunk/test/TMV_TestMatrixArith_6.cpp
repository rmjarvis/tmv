...
void TestMatrixArith_6()
{
    ...
    TestMatrixArith6x<T>(a1f,ca1f,a2f,ca2f,"Square 1F");
    TestMatrixArith6x<T>(a2f,ca2f,a1f,ca1f,"Square 2F");
#endif
...
#if (XTEST & 2)
    TestMatrixArith6x<T>(a2,ca2,a5,ca5,"NonSquare 5");
    TestMatrixArith6x<T>(a4,ca4,a2,ca2,"NonSquare 6");
#if (XTEST & 1)
    TestMatrixArith6x<T>(a3,ca3,a5,ca5,"NonSquare 7");
    TestMatrixArith6x<T>(a4,ca4,a3,ca3,"NonSquare 8");
#endif
#endif
    ...
    TestMatrixArith6x<T>(a4,ca4,a6,ca6,"Degenerate 3");
    TestMatrixArith6x<T>(a7,ca7,a1,ca1,"Degenerate 4");
    TestMatrixArith6x<T>(a7,ca7,a2,ca2,"Degenerate 5");
    TestMatrixArith6x<T>(a7,ca7,a5,ca5,"Degenerate 6");
    TestMatrixArith6x<T>(a7,ca7,a6,ca6,"Degenerate 7");
    TestMatrixArith6x<T>(a6,ca6,a7,ca7,"Degenerate 8");
#if (XTEST & 1)
    TestMatrixArith6x<T>(a3,ca3,a6,ca6,"Degenerate 9");
    TestMatrixArith6x<T>(a7,ca7,a3,ca3,"Degenerate 10");
#endif
#endif
}
