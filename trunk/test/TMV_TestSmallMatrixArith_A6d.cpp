...
template <class T, int N> static void DoTestSmallMatrixArith_A6d()
{
...
template <class T> void TestSmallMatrixArith_A6d()
{
  DoTestSmallMatrixArith_A6d<T,2>();
  DoTestSmallMatrixArith_A6d<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_A6d<T,1>();
  DoTestSmallMatrixArith_A6d<T,3>();
  DoTestSmallMatrixArith_A6d<T,4>();
  DoTestSmallMatrixArith_A6d<T,22>();
#endif
}


#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_A6d<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_A6d<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_A6d<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_A6d<int>();
#endif
