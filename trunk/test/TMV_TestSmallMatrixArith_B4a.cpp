...
template <class T, int N> static void DoTestSmallMatrixArith_B4a()
{
...
template <class T> void TestSmallMatrixArith_B4a()
{
  ...
  DoTestSmallMatrixArith_B4a<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_B4a<T,1>();
  DoTestSmallMatrixArith_B4a<T,3>();
  DoTestSmallMatrixArith_B4a<T,4>();
  DoTestSmallMatrixArith_B4a<T,22>();
  DoTestSmallMatrixArith_B4a<T,555>();
#endif
}
