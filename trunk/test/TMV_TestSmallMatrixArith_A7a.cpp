...
template <class T, int N> static void DoTestSmallMatrixArith_A7a()
{
...
template <class T> void TestSmallMatrixArith_A7a()
{
  DoTestSmallMatrixArith_A7a<T,2>();
  DoTestSmallMatrixArith_A7a<T,12>();
#ifdef XTEST
  DoTestSmallMatrixArith_A7a<T,1>();
  DoTestSmallMatrixArith_A7a<T,3>();
  DoTestSmallMatrixArith_A7a<T,4>();
  DoTestSmallMatrixArith_A7a<T,22>();
#endif
}


#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_A7a<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_A7a<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_A7a<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_A7a<int>();
#endif
