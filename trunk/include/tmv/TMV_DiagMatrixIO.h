...
namespace tmv {
  ...
  void InstWrite(std::ostream& os,
      const ConstDiagMatrixView<T,UNKNOWN,C>& m, RealType(T) thresh);
  ...
  public :
    ...
    inline DiagMatrixReadError(int _i, const BaseMatrix_Diag<M>& _m,
    ...
    inline DiagMatrixReadError(const BaseMatrix_Diag<M>& _m,
  ...
  std::istream& operator>>(std::istream& is, auto_ptr<DiagMatrix<T,I> >& m)
  {
    ...
    try {
      ...
      throw DiagMatrixReadError<type>(ve.i,*m,ve.exp,ve.got,ve.s,
      ...
      BaseMatrix_Diag_Mutable<M>& m)
  {
    ...
    try {
      ...
      throw DiagMatrixReadError<M>(ve.i,m,ve.exp,ve.got,ve.s,
          ve.is,ve.iseof,ve.isbad);
    }
#endif
    return is;
