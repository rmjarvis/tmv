...
//#define TMV_ZeroIX (ix!=1)
  ...
  struct MultUV_Helper<1,1,add,ix,T,M1,V2,V3>
  {
        ...
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      Maybe<add>::add( v3.ref(0) , 
        ZProd<false,false>::prod(x , 
          Maybe<!M1::munit>::prod(m1.cref(0,0) , v2.cref(0)))); 
    }
  };
  ...
  struct MultUV_Helper<11,s,add,ix,T,M1,V2,V3>
  {
        ...
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      ...
      IT1 A0j = m1.get_col(1,0,1).NonConj().begin();
      IT1d Ajj = m1.diag().NonConj().begin();
      ...
      if (--N) do {
        ...
        if (*X != T2(0)) {
          ...
          Maybe<add>::add(*Y++ ,
              Maybe<!unit>::template zprod<c1,false>(*Ajj++ , Xj));  
        } else {
  ...
  struct MultUV_Helper<12,s,add,ix,T,M1,V2,V3>
  {
    ...
    { 
      ...
      IT1 Aii = m1.get_row(0,Maybe<unit>::select(1,0),N).NonConj().begin();
      IT2 X = v2.NonConj().begin();
      IT3 Y = v3.begin();
      ...
      if (len) do {
        // loop from i = 0 .. N-2 or N-1
        // Yi = A.row(i,i,N) * x.SubVector(i,N)
        Yi = Maybe<unit>::sum( Maybe<c2>::conj(*X) , 
            MultVV_Helper<-2,UNKNOWN,M1r,V2>::call2(len,Aii,
              Maybe<unit>::sum(1,X)));
        ++X;
    ...
    struct Unroller<I,1>
    {
        ...
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
      {
        ...
        Maybe<add>::add(v3.ref(I) ,
            ZProd<false,false>::prod(x ,
              Maybe<unit>::sum(v2.cref(I) ,
                MultVV_Helper<-2,s-J,M1r,V2s>::call(
                  m1.get_row(I,J,s),v2.CSubVector(J,s)))));
      }
    };
    template <int I>
    struct Unroller<I,0>
  ...
  // algo 18: colmajor, v3.step() != 1, so copy v3
  template <int s, bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<18,s,add,ix,T,M1,V2,V3> // s known
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      ...
      MultUV_Helper<11,s,false,1,RT,M1,V2,V3cv>::call(one,m1,v2,v3cv);
      AddVV_Helper<-1,s,add,ix,T,V3ccv,V3>::call(x,v3ccv,v3);
    }
  };
  template <bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<18,UNKNOWN,add,ix,T,M1,V2,V3> // s unknown
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
  ...
  // algo 19: rowmajor, v2.step() != 1, so copy v2
  template <int s, bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<19,s,add,ix,T,M1,V2,V3> // s = known
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      ...
      typedef typename V2::value_type T2;
#ifdef PRINTALGO
      std::cout<<"algo 19: N,s,x = "<<N<<','<<s<<','<<T(x)<<std::endl;
#endif
      typedef RealType(T) RT;
      const Scaling<1,RT> one;
      ...
      MultUV_Helper<12,s,add,1,RT,M1,V2ccv,V3>::call(one,m1,v2ccv,v3);
    }
  };
  template <bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<19,UNKNOWN,add,ix,T,M1,V2,V3> // s = unknown
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
  ...
  struct MultUV_Helper<21,s,add,ix,T,M1,V2,V3>
  {
        ...
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      ...
      typedef typename V2::const_nonconj_type::const_iterator IT2;
      typedef typename V3::iterator IT3;
      IT1 Ajj = m1.get_col(N-1,N-1,N).NonConj().begin();
      IT2 X = v2.NonConj().begin() + N-1;
      IT3 Y = v3.begin() + N-1;
      //const int Adiagstep = m1.diagstep();
      const int Astepj = m1.stepj();

      const bool dopref = N * N * sizeof(T1) >= TMV_Q3;
  ...
  struct MultUV_Helper<22,s,add,ix,T,M1,V2,V3>
  {
    ...
    { 
      ...
      if (len) do {
        // loop from i = N-1 .. 0 or 1
        // Yi = A.row(i,0,i+1) * x.SubVector(0,i+1)
        Yi = Maybe<unit>::sum( Maybe<c2>::conj(*X--) , 
            MultVV_Helper<-2,UNKNOWN,M1r,V2>::call2(len,Ai0,X0));
        Ai0.ShiftP(-Astepi);
        if (dopref) Prefetch_Read(Ai0.GetP());
        Maybe<add>::add(*Y--, ZProd<false,false>::prod(x , Yi));
      } while (--len);
    ...
    struct Unroller<I,1>
    {
        ...
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
      {
        ...
        Maybe<add>::add(v3.ref(I) ,
            ZProd<false,false>::prod(x ,
              Maybe<unit>::sum(v2.cref(I) ,
                MultVV_Helper<-2,J,M1r,V2s>::call(
                  m1.get_row(I,0,J),v2.CSubVector(0,J)))));
      }
    };
    template <int I>
    struct Unroller<I,0>
  ...
  // algo 28: colmajor, v3.step() != 1, so copy v3
  template <int s, bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<28,s,add,ix,T,M1,V2,V3> // s known
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      ...
      V3cv v3cv = v3c.View();
      V3ccv v3ccv = v3c.View();
      MultUV_Helper<21,s,false,1,RT,M1,V2,V3cv>::call(one,m1,v2,v3cv);
      AddVV_Helper<-1,s,add,ix,T,V3ccv,V3>::call(x,v3ccv,v3);
    }
  };
  template <bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<28,UNKNOWN,add,ix,T,M1,V2,V3> // s unknown
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
  ...
  // algo 29: rowmajor, v2.step() != 1, so copy v2
  template <int s, bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<29,s,add,ix,T,M1,V2,V3> // s = known
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      ...
      typedef typename V2::value_type T2;
#ifdef PRINTALGO
      std::cout<<"algo 29: N,s,x = "<<N<<','<<s<<','<<T(x)<<std::endl;
#endif
      typedef RealType(T) RT;
      const Scaling<1,RT> one;
      typedef typename Traits2<T,T2>::type T2c;
      ...
      V2ccv v2ccv = v2c.View();
      AddVV_Helper<-1,s,false,ix,T,V2,V2cv>::call(x,v2,v2cv);
      MultUV_Helper<22,s,add,1,RT,M1,V2ccv,V3>::call(one,m1,v2ccv,v3);
    }
  };
  template <bool add, int ix, class T, class M1, class V2, class V3>
  struct MultUV_Helper<29,UNKNOWN,add,ix,T,M1,V2,V3> // s = unknown
  {
    static inline void call(
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
  ...
  struct MultUV_Helper<-1,s,add,ix,T,M1,V2,V3>
  {
        ...
        const Scaling<ix,T>& x, const M1& m1, const V2& v2, V3& v3)
    {
      ...
      // 18 = column major, v3.step() != 1, so copy v3
      // 19 = row major, v2.step() != 1, so copy v2
      //
      // LowerTri:
      // 21 = column major, simple for loop
      // 22 = row major, simple for loop
      // 25 = fully unroll by rows
      // 28 = column major, v3.step() != 1, so copy v3
      // 29 = row major, v2.step() != 1, so copy v2
      ...
      enum { algo = (
          ...
          ShapeTraits<M1::mshape>::upper ? (
            unroll ? 15 :
            M1::mcolmajor ? ( V3::vstep != 1 ? 18 : 11 ) :
            M1::mrowmajor ? ( V2::vstep != 1 ? 19 : 12 ) :
            V2::vstep == 1 ? 12 : V3::vstep == 1 ? 11 : 12 ) :
          ( // lowertri
            unroll ? 25 :
            M1::mcolmajor ? ( V3::vstep != 1 ? 28 : 21 ) :
            M1::mrowmajor ? ( V2::vstep != 1 ? 29 : 22 ) :
  ...
  {
    //std::cout<<"InlineMultUV "<<ix<<"  "<<T(x)<<std::endl;
    ...
    //std::cout<<"End InlineMultUV: v3 = "<<v3<<std::endl;
  }
