...
template <class T, class T1, class T2> inline PRODMM<T,T1,T2> operator*(
    T x1, const PRODMM<T,T1,T2>& pmm2)
{ return PRODMM<T,T1,T2>(x1*pmm2.GetX1(),pmm2.GetM2(),pmm2.GetM3()); }

template <class T> inline PRODMM<CT,T,T> operator*(
    CT x1, const PRODMM<T,T,T>& pmm2)
{ return PRODMM<CT,T,T>(x1*pmm2.GetX1(),pmm2.GetM2(),pmm2.GetM3()); }

template <class T> inline PRODMM<CT,T,T> operator*(
    CCT x1, const PRODMM<T,T,T>& pmm2)
{ return PRODMM<CT,T,T>(CT(x1)*pmm2.GetX1(),pmm2.GetM2(),pmm2.GetM3()); }

template <class T> inline PRODMM<CT,T,T> operator*(
    VCT x1, const PRODMM<T,T,T>& pmm2)
{ return PRODMM<CT,T,T>(CT(x1)*pmm2.GetX1(),pmm2.GetM2(),pmm2.GetM3()); }

template <class T, class T1, class T2> inline PRODMM<CT,T1,T2> operator*(
    T x1, const PRODMM<CT,T1,T2>& pmm2)
{ return PRODMM<CT,T1,T2>(x1*pmm2.GetX1(),pmm2.GetM2(),pmm2.GetM3()); }

template <class T, class T1, class T2> inline PRODMM<CT,T1,T2> operator*(
    CCT x1, const PRODMM<CT,T1,T2>& pmm2)
{ return PRODMM<CT,T1,T2>(CT(x1)*pmm2.GetX1(),pmm2.GetM2(),pmm2.GetM3()); }

template <class T, class T1, class T2> inline PRODMM<CT,T1,T2> operator*(
    VCT x1, const PRODMM<CT,T1,T2>& pmm2)
{ return PRODMM<CT,T1,T2>(CT(x1)*pmm2.GetX1(),pmm2.GetM2(),pmm2.GetM3()); }
...
inline PRODMM<CT,T1,T2> operator*(
