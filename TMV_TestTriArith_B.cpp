...
template <class T1, class T2, IndexStyle I1, IndexStyle I2> bool CanAddEq(
    const UpperTriMatrixView<T1,I1>& a, const tmv::MatrixView<T2,I2>& b)
{ return false; }

template <class T1, class T2, IndexStyle I1, IndexStyle I2> bool CanAddEq(
    const LowerTriMatrixView<T1,I1>& a, const tmv::MatrixView<T2,I2>& b)
{ return false; }
...
template <class T1, class T2, IndexStyle I1, IndexStyle I2> bool CanMultEq2(
    const tmv::MatrixView<T1,I1>& a, const UpperTriMatrixView<T2,I2>& b)
{ return false; }

template <class T1, class T2, IndexStyle I1, IndexStyle I2> bool CanMultEq2(
    const tmv::MatrixView<T1,I1>& a, const LowerTriMatrixView<T2,I2>& b)
{ return false; }

template <class T, IndexStyle I> bool CanDoSV(const UpperTriMatrixView<T,I>& m)
{ return false; }
template <class T, IndexStyle I> bool CanDoSV(const LowerTriMatrixView<T,I>& m)
{ return false; }
