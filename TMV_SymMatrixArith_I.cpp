...
namespace tmv {
  ...
  template <bool ha, bool a1, bool add, class T, class Tx, class Ty> 
    ...
    template <bool ha, bool a1, bool add, class T, class Tx, class Ty> 
      void RecursiveInPlaceSymMultMM(
	  const T alpha, const GenMatrix<Tx>& x, const GenMatrix<Ty>& y,
	  const SymMatrixView<T>& A)
      {
  ...
  template <class T, class Tx, class Ty> void InPlaceSymMultMM(
      const T alpha, const GenMatrix<Tx>& x, const GenMatrix<Ty>& y,
  ...
  template <class T, class Tx, class Ty> void DoSymMultMM(
      const T alpha, const GenMatrix<Tx>& x, const GenMatrix<Ty>& y,
      const int beta, const SymMatrixView<T>& A)
  { 
...
#define InstFile "TMV_SymMatrixArith_I.inst"
#include "TMV_Inst.h"
#undef InstFile
