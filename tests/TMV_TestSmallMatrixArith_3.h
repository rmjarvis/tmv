...
template <class T, int M, int N> void TestSmallMatrixArith_3(std::string label)
{
    ...
    TestMatrixArith3a(a1,ca1,v1,cv1,v2,cv2,label+" RowMajor");
    TestMatrixArith3a(a2,ca2,v2,cv2,v1,cv1,label+" ColMajor");

    TestMatrixArith3b(a1,ca1,v1,cv1,v2,cv2,label+" RowMajor");
    TestMatrixArith3b(a2,ca2,v2,cv2,v1,cv1,label+" ColMajor");
    ...
    TestMatrixArith3a(a1,ca1,v3,cv3,v2,cv2,label+" RowMajor Step1");
    TestMatrixArith3a(a1,ca1,v1,cv1,v4,cv4,label+" RowMajor Step2");
    TestMatrixArith3a(a1,ca1,v3,cv3,v4,cv4,label+" RowMajor Step12");
    TestMatrixArith3a(a2,ca2,v4,cv4,v1,cv1,label+" ColMajor Step1");
    TestMatrixArith3a(a2,ca2,v2,cv2,v3,cv3,label+" ColMajor Step2");
    TestMatrixArith3a(a2,ca2,v4,cv4,v3,cv3,label+" ColMajor Step12");
    TestMatrixArith3a(a3,ca3,v1,cv1,v2,cv2,label+" NonMajor");
    TestMatrixArith3a(a3,ca3,v3,cv3,v2,cv2,label+" NonMajor Step1");
    TestMatrixArith3a(a3,ca3,v1,cv1,v4,cv4,label+" NonMajor Step2");
    TestMatrixArith3a(a3,ca3,v3,cv3,v4,cv4,label+" NonMajor Step12");
#endif
#if (XTEST & 2)
    ...
    TestMatrixArith3a(a1v,ca1v,v1,cv1,v2,cv2,label+" RowMajor");
    TestMatrixArith3a(a1,ca1,v1v,cv1v,v2v,cv2v,label+" RowMajor");

    TestMatrixArith3b(a1v,ca1v,v1,cv1,v2,cv2,label+" RowMajor");
    TestMatrixArith3b(a1,ca1,v1v,cv1v,v2v,cv2v,label+" RowMajor");
#endif
}
