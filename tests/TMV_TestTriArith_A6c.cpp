...
#ifdef TEST_DOUBLE
template void TestTriMatrixArith_A6c<double>();
#endif
#ifdef TEST_FLOAT
template void TestTriMatrixArith_A6c<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestTriMatrixArith_A6c<long double>();
#endif
#ifdef TEST_INT
template void TestTriMatrixArith_A6c<int>();
#endif
