...
static void DoTestSmallMatrixArith_B3c()
{
...
template <class T> 
void TestSmallMatrixArith_B3c()
{
    DoTestSmallMatrixArith_B3c<T,2>();
    DoTestSmallMatrixArith_B3c<T,5>();
#if (XTEST & 2)
    DoTestSmallMatrixArith_B3c<T,1>();
    DoTestSmallMatrixArith_B3c<T,3>();
    DoTestSmallMatrixArith_B3c<T,4>();
#endif
}


#ifdef TEST_DOUBLE
template void TestSmallMatrixArith_B3c<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixArith_B3c<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixArith_B3c<long double>();
#endif
#ifdef TEST_INT
template void TestSmallMatrixArith_B3c<int>();
#endif
