...
void TestMatrixArith_2()
{
    ...
    TestMatrixArith2(a1,ca1,"Square 1");
    TestMatrixArith2(a2,ca2,"Square 2");
#if (XTEST & 1)
    ...
    TestMatrixArith2(a3,ca3,"Square 3");
#endif
    ...
    TestMatrixArith2(a1f,ca1f,"Square 1F");
    TestMatrixArith2(a2f,ca2f,"Square 2F");
#endif
    ...
    TestMatrixArith2(a4,ca4,"NonSquare 1");
    TestMatrixArith2(a5,ca5,"NonSquare 2");
    ...
    TestMatrixArith2(a6,ca6,"Degenerate 1");
    TestMatrixArith2(a7,ca7,"Degenerate 2");
#endif
}

#ifdef TEST_DOUBLE
template void TestMatrixArith_2<double>();
#endif
#ifdef TEST_FLOAT
template void TestMatrixArith_2<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestMatrixArith_2<long double>();
#endif
#ifdef TEST_INT
template void TestMatrixArith_2<int>();
#endif
