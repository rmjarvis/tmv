...
#ifdef TEST_DOUBLE
template void TestTriMatrixArith_C4b<double>();
#endif
#ifdef TEST_FLOAT
template void TestTriMatrixArith_C4b<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestTriMatrixArith_C4b<long double>();
#endif
#ifdef TEST_INT
template void TestTriMatrixArith_C4b<int>();
#endif
