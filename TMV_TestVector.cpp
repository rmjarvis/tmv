...
template <class T> void TestVectorReal()
{
  ...
  cout<<"VectorReal<"<<tmv::Type(T())<<"> passed all tests\n";
}
...
template <class T> void TestVectorComplex()
{
  ...
  cout<<"VectorComplex<"<<tmv::Type(T())<<"> passed all tests\n";
}
    ...
    const V1& a, const Vector<T>& v, string label)
{
  ...
  DoTestVa(a.SubVector(0,v.size(),5),v2,label+" Step");
    ...
    const V1& a, const Vector<T>& v, T2 x, string label)
{
  ...
  Vector<T> v2 = v.SubVector(0,v.size(),5);
  DoTestVXa(a.SubVector(0,v.size(),5),v2,x,label+" Step");
  Vector<T> v3 = v.Reverse();
    ...
    string label)
{
  ...
  DoTestVVa(a.SubVector(0,a.size(),5),b.SubVector(0,a.size()/5),v1s,v2x,label+" StepA");
  DoTestVVa(a.SubVector(0,a.size()/5),b.SubVector(0,a.size(),5),v1x,v2s,label+" StepB");
  DoTestVVa(a.SubVector(0,a.size(),5),b.SubVector(0,a.size(),5),v1s,v2s,label+" StepA,StepB");
