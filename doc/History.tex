...
In addition to the below changes, the code is now hosted on GitHub at
...
\item Documented the sort order for eigenvectors returned by \texttt{Eigen}
and singular values returned \text{{SV\_Decompose}. (\#14)
