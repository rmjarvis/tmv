...
template <class SM, class T, class V, class T2> void DoTestMV1(
    const SM& a, const Matrix<T>& m, const V& v, const Vector<T2>& v0,
    string label)
{
  ...
  v = v0;
  v.SubVector(v0.size()/2,v0.size()).Zero();
  DoTestMV1a(a.View(),m,v,label);
  DoTestMV1a(Transpose(a),mt,v,label+" Trans");
  DoTestMV1a(Conjugate(a),mc,v,label+" Conj");
  DoTestMV1a(Adjoint(a),ma,v,label+" Adj");
  ...
  v = v0;
  v.SubVector(0,v0.size()/4).Zero();
  v.SubVector(3*v0.size()/4,v0.size()).Zero();
  DoTestMV1a(a.View(),m,v,label);
  DoTestMV1a(Transpose(a),mt,v,label+" Trans");
  DoTestMV1a(Conjugate(a),mc,v,label+" Conj");
  DoTestMV1a(Adjoint(a),ma,v,label+" Adj");
  ...
  if (v.size() > 1) {
    ...
    v = v0;
    v.SubVector(v0.size()-1,v0.size()).Zero();
    DoTestMV1a(a.View(),m,v,label);
    DoTestMV1a(Transpose(a),mt,v,label+" Trans");
    DoTestMV1a(Conjugate(a),mc,v,label+" Conj");
    DoTestMV1a(Adjoint(a),ma,v,label+" Adj");
...
//#define XDEBUG
  ...
  cout<<"Conjugate(a) = "<<Conjugate(a)<<endl;
  cout<<"Conjugate(m) = "<<Conjugate(m)<<endl;
  cout<<"a*-m* = "<<Conjugate(a)-Conjugate(m)<<endl;
