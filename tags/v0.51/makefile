...
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -wd1476,1505 -parallel -DNDEBUG -DNOBLAS
#ODIR= icc-noblas
#CFLAGS1= -g -wn3 -Kc++ -O3 -tpp7 -wd1476,1505 -parallel -DNOBLAS 
#ODIR= icc-noblas-debug
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -wd1476,1505 -parallel -DNDEBUG -DMKL -DNOLAP 
#ODIR= icc-nolap
#CFLAGS1= -g -wn3 -Kc++ -O3 -tpp7 -wd1476,1505 -parallel -DNOLAP -DMKL
#ODIR= icc-nolap-debug
#CFLAGS1= -g -wn3 -Kc++ -O3 -tpp7 -wd1476,1505 -parallel -DMKL
#ODIR= icc-debug
#CFLAGS1= -wn3 -Kc++ -O3 -tpp7 -wd1476,1505 -parallel -DNDEBUG -DMKL
#ODIR= icc
...
TMV_SYMO_FILES= $(ODIR)/TMV_SymMatrix.o $(ODIR)/TMV_SymMatrixArith_A.o $(ODIR)/TMV_SymMatrixArith_B.o $(ODIR)/TMV_SymMatrixArith_C.o $(ODIR)/TMV_SymMatrixArith_D.o $(ODIR)/TMV_SymMatrixArith_E.o $(ODIR)/TMV_SymMatrixArith_F.o $(ODIR)/TMV_SymMatrixArith_G.o $(ODIR)/TMV_SymMatrixArith_H.o $(ODIR)/TMV_SymCHDiv.o $(ODIR)/TMV_SymSVDiv.o $(ODIR)/TMV_SymLUDiv.o 
...
#all: $(BINDIR)/tmvtest
#all: $(BINDIR)/tmvsymspeed
#all: $(BINDIR)/tmvtest $(BINDIR)/tmvsymspeed
...
$(BINDIR)/tmvsymspeed: $(ODIR)/libtmv.a $(ODIR)/TMV_SymSpeed.o
	$(CC) $(CFLAGS) $(ODIR)/TMV_SymSpeed.o $(CLIBS) -o $(BINDIR)/tmvsymspeed

$(ODIR)/TMV_Speed.o: TMV_Speed1.cpp $(TMV_H_FILES) 
	$(CC) $(CFLAGS) -c TMV_Speed1.cpp -o $(ODIR)/TMV_Speed.o

$(ODIR)/TMV_SymSpeed.o: TMV_SymSpeed.cpp $(TMV_H_FILES) 
	$(CC) $(CFLAGS) -c TMV_SymSpeed.cpp -o $(ODIR)/TMV_SymSpeed.o
...
$(ODIR)/TMV_SymMatrixArith_F.o: TMV_SymMatrixArith_F.cpp TMV_SymMatrixArith_F.inst $(TMV_SYMH_FILES) TMV_VectorArith_Inline.h
	$(CC) $(CFLAGS) -c TMV_SymMatrixArith_F.cpp -o $(ODIR)/TMV_SymMatrixArith_F.o

$(ODIR)/TMV_SymMatrixArith_G.o: TMV_SymMatrixArith_G.cpp TMV_SymMatrixArith_G.inst $(TMV_SYMH_FILES) TMV_VectorArith_Inline.h
	$(CC) $(CFLAGS) -c TMV_SymMatrixArith_G.cpp -o $(ODIR)/TMV_SymMatrixArith_G.o

$(ODIR)/TMV_SymMatrixArith_H.o: TMV_SymMatrixArith_H.cpp TMV_SymMatrixArith_H.inst $(TMV_SYMH_FILES) TMV_VectorArith_Inline.h
