...
template <class T> inline PRODXM<T,T> operator*(
    T x, const GENMATRIX2<T>& m) 
{ return PRODXM<T,T>(x,m); }

template <class T> inline PRODXM<CT,T> operator*(
    CT x, const GENMATRIX2<T>& m)
{ return PRODXM<CT,T>(x,m); }

template <class T> inline PRODXM<CT,T> operator*(
    CCT x, const GENMATRIX2<T>& m)
{ return PRODXM<CT,T>(CT(x),m); }

template <class T> inline PRODXM<CT,T> operator*(
    VCT x, const GENMATRIX2<T>& m)
{ return PRODXM<CT,T>(CT(x),m); }

template <class T> inline PRODXM<CT,CT> operator*(
    T x, const GENMATRIX2<CT>& m) 
{ return PRODXM<CT,CT>(x,m); }

template <class T> inline PRODXM<CT,CT> operator*(
    CCT x, const GENMATRIX2<CT>& m)
{ return PRODXM<CT,CT>(CT(x),m); }

template <class T> inline PRODXM<CT,CT> operator*(
    VCT x, const GENMATRIX2<CT>& m)
{ return PRODXM<CT,CT>(CT(x),m); }

// m*x
template <class T> inline PRODXM<T,T> operator*(
    const GENMATRIX2<T>& m, T x) 
{ return PRODXM<T,T>(x,m); }

template <class T> inline PRODXM<CT,T> operator*(
    const GENMATRIX2<T>& m,CT x)
{ return PRODXM<CT,T>(x,m); }

template <class T> inline PRODXM<CT,T> operator*(
    const GENMATRIX2<T>& m, CCT x)
{ return PRODXM<CT,T>(CT(x),m); }

template <class T> inline PRODXM<CT,T> operator*(
    const GENMATRIX2<T>& m, VCT x)
{ return PRODXM<CT,T>(CT(x),m); }

template <class T> inline PRODXM<CT,CT> operator*(
    const GENMATRIX2<CT>& m, CCT x)
{ return PRODXM<CT,CT>(CT(x),m); }

template <class T> inline PRODXM<CT,CT> operator*(
    const GENMATRIX2<CT>& m, VCT x)
{ return PRODXM<CT,CT>(CT(x),m); }

template <class T> inline PRODXM<CT,CT> operator*(
    const GENMATRIX2<CT>& m, T x) 
{ return PRODXM<CT,CT>(x,m); }
