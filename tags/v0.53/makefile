#CFLAGS1= -g -ansi -DNOBLAS -DNOFLOAT -DTMVFLDEBUG -DTMV_BLOCKSIZE=3
#ODIR= gcc-test
#CFLAGS1= -O3 -ansi -DMKL -DNDEBUG
#ODIR= gcc
#CFLAGS1= -O -g -ansi -DMKL
#ODIR= gcc-debug
#CFLAGS1= -O3 -ansi -DNOBLAS -DNDEBUG
#ODIR= gcc-noblas
#CFLAGS1= -O -g -ansi -DNOBLAS
#ODIR= gcc-noblas-debug
#CFLAGS1= -O3 -ansi -DATLAS -DNDEBUG
#ODIR= gcc-atlas
#CFLAGS1= -O -g -ansi -DATLAS
#ODIR= gcc-atlas-debug
#CC= /usr/bin/g++

#CFLAGS1= -g -wn3 -Kc++ -wd1476,1505 -DNOBLAS -DNOFLOAT -DTMVFLDEBUG -DTMV_BLOCKSIZE=5
#ODIR= icc-test
#CFLAGS1= -Kc++ -O3 -wd1476,1505 -DNDEBUG -DNOBLAS
#ODIR= icc-noblas
#CFLAGS1= -g -Kc++ -O3 -wd1476,1505 -DNOBLAS -DNOFLOAT
#ODIR= icc-noblas-debug
#CFLAGS1= -Kc++ -O3 -wd1476,1505 -DNDEBUG -DMKL -DNOLAP #-DTMV_BLOCKSIZE=64
#ODIR= icc-nolap
#CFLAGS1= -g -Kc++ -O3 -wd1476,1505 -DNOLAP -DMKL
#ODIR= icc-nolap-debug
CFLAGS1= -Kc++ -O3 -wd1476,1505 -DNDEBUG -DMKL
ODIR= icc
#CFLAGS1= -g -Kc++ -O3 -wd1476,1505 -DMKL -DNOFLOAT
#ODIR= icc-debug
...
#CFLAGS= $(CFLAGS1) -I/usr/local/include -wn3 -Wall -Werror -DXTEST -wd279 -wd981 -wd383 -wd810
CFLAGS= $(CFLAGS1) -I/usr/local/include
...
$(ODIR)/TMV_QRDiv_A.o: TMV_QRDiv_A.cpp TMV_QRDiv.h TMV_QRDiv_A.inst TMV_Householder.h TMV_Givens.h $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_A.cpp -o $(ODIR)/TMV_QRDiv_A.o

$(ODIR)/TMV_QRDiv_B.o: TMV_QRDiv_B.cpp TMV_QRDiv.h TMV_QRDiv_B.inst TMV_Householder.h TMV_Givens.h $(TMV_TRIHFILES)
	$(CC) $(CFLAGS) -c TMV_QRDiv_B.cpp -o $(ODIR)/TMV_QRDiv_B.o

$(ODIR)/TMV_QRDiv_C.o: TMV_QRDiv_C.cpp TMV_QRDiv.h TMV_QRDiv_C.inst TMV_Householder.h TMV_Givens.h $(TMV_TRIHFILES)
...
$(ODIR)/TMV_SymHouseholder.o: TMV_SymHouseholder.cpp TMV_SymHouseholder.h TMV_SymHouseholder.inst
	$(CC) $(CFLAGS) -c TMV_SymHouseholder.cpp -o $(ODIR)/TMV_SymHouseholder.o

$(ODIR)/TMV_SymSVDiv.o: TMV_SymSVDiv.cpp TMV_SymSVDiv.h TMV_SymSVDiv.inst TMV_SymHouseholder.h TMV_Givens.h $(TMV_SYMH_FILES)
...
$(ODIR)/TMV_SymSVDiv_B.o: TMV_SymSVDiv_B.cpp TMV_SymSVDiv.h TMV_SymSVDiv_B.inst TMV_SymHouseholder.h TMV_Givens.h $(TMV_SYMH_FILES)
...
$(ODIR)/TMV_SymCHDiv.o: TMV_SymCHDiv.cpp TMV_SymCHDiv.h TMV_SymCHDiv.inst TMV_SymHouseholder.h TMV_Givens.h $(TMV_SYMH_FILES)
	$(CC) $(CFLAGS) -c TMV_SymCHDiv.cpp -o $(ODIR)/TMV_SymCHDiv.o

$(ODIR)/TMV_SymCHDiv_A.o: TMV_SymCHDiv_A.cpp TMV_SymCHDiv.h TMV_SymCHDiv_A.inst TMV_SymHouseholder.h TMV_Givens.h $(TMV_SYMH_FILES)
	$(CC) $(CFLAGS) -c TMV_SymCHDiv_A.cpp -o $(ODIR)/TMV_SymCHDiv_A.o

$(ODIR)/TMV_SymCHDiv_B.o: TMV_SymCHDiv_B.cpp TMV_SymCHDiv.h TMV_SymCHDiv_B.inst TMV_SymHouseholder.h TMV_Givens.h $(TMV_SYMH_FILES)
