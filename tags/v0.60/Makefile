...
#CFLAGS= $(INCLUDE) -Kc++ -O3 -DNDEBUG -DMKL -DINST_LONGDOUBLE
...
# Note the -DNOSTL.  For my installation of pgCC, the linker couldn't 
...
#INCLUDE= -Iinclude
#CFLAGS= $(INCLUDE) -fast -Mcache_align -DACML -DNDEBUG -DNOSTL -DNOLAP
...
# BINDIR indicates where to put the test and example executables.
