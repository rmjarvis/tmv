...
template <class T, tmv::StorageType stor, int N> static void TestSmallNonSquareDiv_B2a()
{
  ...
  tmv::SmallMatrix<std::complex<T>,6,6,tmv::ColMajor> c3a = a3a * std::complex<T>(-4,8);
  tmv::SmallMatrix<std::complex<T>,N,6,stor> c4;

  tmv::SmallMatrix<T,6,6,stor> a3x = a3a;
  tmv::SmallMatrix<std::complex<T>,6,6,stor> c3x = c3a;

  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1,a3a,a4,c1,c3a,c4,"Square/NonSquare"); 
#ifdef XTEST
  ...
  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1f,a3a,a4,c1f,c3a,c4,"Square/NonSquare"); 
  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1f,a3fa,a4,c1f,c3fa,c4,"Square/NonSquare"); 
  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1f,a3fa,a4f,c1f,c3fa,c4f,"Square/NonSquare"); 
#endif
}
