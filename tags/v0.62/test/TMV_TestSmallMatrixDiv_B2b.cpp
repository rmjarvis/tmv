...
template <class T, tmv::StorageType stor, int N> static void TestSmallNonSquareDiv_B2b()
{
  ...
  tmv::SmallMatrix<std::complex<T>,6,6,tmv::RowMajor> c3b = a3b * std::complex<T>(-4,8);
  tmv::SmallMatrix<std::complex<T>,N,6,stor> c4;

  tmv::SmallMatrix<T,6,6,stor> a3x = a3b;
  tmv::SmallMatrix<std::complex<T>,6,6,stor> c3x = c3b;

  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1,a3b,a4,c1,c3b,c4,"Square/NonSquare"); 
#ifdef XTEST
  ...
  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1f,a3b,a4,c1f,c3b,c4,"Square/NonSquare"); 
  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1f,a3fb,a4,c1f,c3fb,c4,"Square/NonSquare"); 
  TestMatrixDivArith3b<T>(tmv::QR,a3x,c3x,a1f,a3fb,a4f,c1f,c3fb,c4f,"Square/NonSquare"); 
#endif
}
