...
namespace tmv {
  ...
  inline void AddMM(const T x2, const GenUpperTriMatrix<T2>& m2,
  ...
  template <class T, class T2> 
  inline void AddMM(const T x2, const GenLowerTriMatrix<T2>& m2,
      const BandMatrixView<T>& m1)
  {
    if (m2.isunit()) {
      if (m2.size() > 1)
  ...
  inline void MultMM(const T x, const GenUpperTriMatrix<T1>& m1,
  ...
  template <bool add, class T, class T1, class T2> 
  inline void MultMM(const T x, const GenBandMatrix<T1>& m1,
  ...
  template <bool add, class T, class T1, class T2> 
  inline void MultMM(const T x, const GenLowerTriMatrix<T1>& m1,
      const GenBandMatrix<T2>& m2, const BandMatrixView<T>& m0)
  { 
    if (m1.isunit()) {
  ...
  template <class T, class T2> 
  inline void AddMM(const CT , const GenUpperTriMatrix<T2>& ,
      const BandMatrixView<T>& )
  { TMVAssert(FALSE); }
  template <class T, class T2> 
  inline void AddMM(const CT , const GenLowerTriMatrix<T2>& ,
      const BandMatrixView<T>& )
  { TMVAssert(FALSE); }
  ...
  template <bool add, class T, class T1, class T2> 
  inline void MultMM(const CT , const GenUpperTriMatrix<T1>& ,
      const GenBandMatrix<T2>& , const BandMatrixView<T>& )
  { TMVAssert(FALSE); }
  template <bool add, class T, class T1, class T2> 
  inline void MultMM(const CT , const GenBandMatrix<T1>& ,
      const GenUpperTriMatrix<T2>& , const BandMatrixView<T>& )
  { TMVAssert(FALSE); }
  template <bool add, class T, class T1, class T2> 
  inline void MultMM(const CT , const GenLowerTriMatrix<T1>& ,
      const GenBandMatrix<T2>& , const BandMatrixView<T>& )
  { TMVAssert(FALSE); }
  template <bool add, class T, class T1, class T2> 
  inline void MultMM(const CT , const GenBandMatrix<T1>& ,
