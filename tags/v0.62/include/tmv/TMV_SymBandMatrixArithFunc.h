...
namespace tmv {
  ...
  void MultMV(const T alpha, const GenSymBandMatrix<Ta>& A, 
  ...
  inline void AddMM(const T alpha, const GenSymBandMatrix<Ta>& A,
      const SymBandMatrixView<T>& B)
  { AddMM(alpha,A.UpperBand(),B.UpperBand()); }
  template <class T, class Ta> 
  void AddMM(const T alpha, const GenSymBandMatrix<Ta>& A,
  ...
  template <class T, class Ta, class Tb> 
  inline void AddMM(const T alpha, const GenBandMatrix<Ta>& A, 
      const T beta, const GenSymBandMatrix<Tb>& B, const BandMatrixView<T>& C)
  ...
  void MultMM(const T alpha, const GenSymBandMatrix<Ta>& A, 
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const T alpha, const GenBandMatrix<Ta>& A, 
      const GenSymBandMatrix<Tb>& B, const BandMatrixView<T>& C)
  { MultMM<add>(alpha,B.Transpose(),A.Transpose(),C.Transpose()); }

  template <class T, class Ta> 
  inline void ElementProd(const T alpha, const GenSymBandMatrix<Ta>& A,
      const SymBandMatrixView<T>& B)
  { ElementProd(alpha,A.UpperBand(),B.UpperBand()); }
  template <class T, class Ta, class Tb> 
  inline void AddElementProd(const T alpha, const GenSymBandMatrix<Ta>& A,
      const GenSymBandMatrix<Tb>& B, const SymBandMatrixView<T>& C)
  { AddElementProd(alpha,A.UpperBand(),B.UpperBand(),C.UpperBand()); }

  template <class T> 
  class SymBandMatrixComposite :
  ...
  template <bool add, class T, class Ta, class Tx> 
  inline void MultMV(const T alpha, const GenSymBandMatrix<Ta>& A, 
  ...
  { AddMM(CT(alpha),A,CT(beta),B,C); }
  template <class T> 
  inline void AddMM(const CT alpha, const GenSymBandMatrix<CT>& A, 
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const T alpha, const GenSymBandMatrix<Ta>& A, 
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMV(const CT , const GenSymBandMatrix<Ta>& , 
  ...
  template <class T, class Ta> 
  inline void AddMM(const CT , const GenSymBandMatrix<Ta>& ,
      const SymBandMatrixView<T>& )
  { TMVAssert(FALSE); }
  template <class T, class Ta> 
  inline void AddMM(const CT , const GenSymBandMatrix<Ta>& ,
  ...
  { TMVAssert(FALSE); }
  template <class T, class Ta, class Tb> 
  inline void AddMM(const CT , const GenBandMatrix<Ta>& , 
      const CT , const GenSymBandMatrix<Tb>& , const BandMatrixView<T>& )
  { TMVAssert(FALSE); }
  template <class T, class Ta, class Tb> 
  ...
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const CT , const GenSymBandMatrix<Ta>& , 
  ...
  { TMVAssert(FALSE); }
  template <bool add, class T, class Ta, class Tb> 
  inline void MultMM(const CT , const GenBandMatrix<Ta>& , 
      const GenSymBandMatrix<Tb>& , const BandMatrixView<T>& )
  { TMVAssert(FALSE); }
