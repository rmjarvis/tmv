...
#undef ProductType
  ...
  inline void ElementProd(const T alpha,
  ...
  inline void AddElementProd(const T alpha, const SmallVector<T1,N,I1>& v1, 
...
#define CT std::complex<T>
  ...
  inline void ElementProd(const CT , const SmallVector<T1,N,I1>& , 
      const SmallVector<T,N,I2>& )
  { TMVAssert(FALSE); }
  template <class T, class T1, class T2, int N, IndexStyle I1, IndexStyle I2, IndexStyle I3> 
  inline void AddElementProd(const CT , const SmallVector<T1,N,I1>& ,
