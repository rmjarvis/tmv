...
namespace tmv {
  ...
  inline std::string TypeText(const SymBandMatrix<T,U,S,I>& )
  {
    return std::string("SymBandMatrix<")+TypeText(T())+","+Text(U)+","+Text(S)+
    ","+Text(I)+">";
  }

  template <class T, UpLoType U, StorageType S, IndexStyle I>
  inline std::string TypeText(const HermBandMatrix<T,U,S,I>& )
  {
    return std::string("HermBandMatrix<")+TypeText(T())+","+Text(U)+","+Text(S)+
    ","+Text(I)+">";
  }

  template <class T> 
  inline std::string TypeText(const GenSymBandMatrix<T>& m)
  {
    return std::string("GenSymBandMatrix<")+TypeText(T())+","+Text(m.sym())+","
  ...
  {
    return std::string("ConstSymBandMatrixView<")+TypeText(T())+","+Text(m.sym())+
  ...
  {
    return std::string("SymBandMatrixView<")+TypeText(T())+","+Text(m.sym())+
    ","+Text(m.uplo())+ ","+Text(m.stor())+ ","+Text(I)+
    ","+Text(m.ct())+ ">";
  }
