...
namespace tmv {
  ...
  template <class T1, class T2> void CH_LDivEq(
      const GenSymBandMatrix<T1>& L, const MatrixView<T2>& m);
  template <class T1, class T2> void CH_RDivEq(
      const GenSymBandMatrix<T1>& L, const MatrixView<T2>& m);
  template <class T1, class T2> void CH_Inverse(
  ...
  template <class T1, class T2> void LDL_RDivEq(
      const GenSymBandMatrix<T1>& L, const MatrixView<T2>& m);
  template <class T1, class T2> void LDL_Inverse(
      const GenSymBandMatrix<T1>& LLx, const SymMatrixView<T2>& sinv);
  ...
  template <class T> class NonPosDefSymBandLDL :
    public NonPosDef
  {
    public:
  ...
  template <class T> class NonPosDefHermBandLDL :
    public NonPosDef
  {
    public:
      mutable auto_ptr<HermBandMatrix<T> > A;
