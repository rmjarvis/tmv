...
template <class T> void TestSmallMatrixArith_B4c()
{
  ...
  TestMatrixArith4<T>(a5x,ca5x,a5v,ca5v,a4v,ca4v,"NonSquare");
#ifdef XTEST
  TestMatrixArith4<T>(a5x,ca5x,a5v,ca5v,a1v,ca1v,"NonSquare");
  TestMatrixArith4<T>(a5x,ca5x,a5v,ca5v,a2v,ca2v,"NonSquare");
  TestMatrixArith4<T>(a5x,ca5x,a5v,ca5v,a3v,ca3v,"NonSquare");
#endif
}
