...
template <class T, tmv::UpLoType U, tmv::StorageType S> static void TestBasicSymMatrix()
{
  ...
  //system("rm tmvtest_symmatrix_io.dat");
#endif
...
template <class T> void TestSymMatrix() 
{
  ...
  std::cout<<"SymMatrix<"<<tmv::Type(T())<<"> (Diag/Sym) Arithmetic passed all tests\n";
  TestSymMatrixArith_D1<T>();
  TestSymMatrixArith_D2<T>();
  std::cout<<"SymMatrix<"<<tmv::Type(T())<<"> (Tri/Sym) Arithmetic passed all tests\n";
  TestSymMatrixArith_E1<T>();
  TestSymMatrixArith_E2<T>();
  std::cout<<"SymMatrix<"<<tmv::Type(T())<<"> (Band/Sym) Arithmetic passed all tests\n";
}
