...
template <class T> void TestSmallMatrixArith_B5b()
{
  ...
  TestMatrixArith5<T>(a4x,ca4x,a4v,ca4v,a1v,ca1v,"NonSquare");
#ifdef XTEST
  TestMatrixArith5<T>(a4x,ca4x,a4v,ca4v,a5v,ca5v,"NonSquare");
  TestMatrixArith5<T>(a4x,ca4x,a4v,ca4v,a2v,ca2v,"NonSquare");
  TestMatrixArith5<T>(a4x,ca4x,a4v,ca4v,a3v,ca3v,"NonSquare");
#endif
}
