...
\newcommand{\prevtmvversion}{0.71}
\newcommand{\tmvversion}{0.72}
\newcommand{\tmvmajorversion}{0}
\newcommand{\tmvminorversion}{72}
...
\newcommand{\altemailx}{mike_jarvis@sourceforce.net}
\newcommand{\altemail}{\href{mailto:\altemailx}{\textt \altemailx}}
