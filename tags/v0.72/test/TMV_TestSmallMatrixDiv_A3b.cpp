...
static void TestSmallSquareDiv_A3b()
{
    ...
    TestMatrixDivArith3c(tmv::LU,a1,a2b,a3,c1,c2b,c3,"Square/Square"); 
    ...
    TestMatrixDivArith3c(tmv::LU,a1f,a2b,a3,c1f,c2b,c3,"Square/Square"); 
    TestMatrixDivArith3c(tmv::LU,a1f,a2fb,a3,c1f,c2fb,c3,"Square/Square"); 
    TestMatrixDivArith3c(tmv::LU,a1f,a2fb,a3f,c1f,c2fb,c3f,"Square/Square"); 
#endif
}

template <class T> 
void TestSmallMatrixDiv_A3b()
{
    ...
    TestSmallSquareDiv_A3b<T,tmv::RowMajor,1>();
    TestSmallSquareDiv_A3b<T,tmv::RowMajor,2>();
    TestSmallSquareDiv_A3b<T,tmv::RowMajor,3>();
    TestSmallSquareDiv_A3b<T,tmv::RowMajor,4>();
    TestSmallSquareDiv_A3b<T,tmv::RowMajor,5>();
#endif
}

#ifdef TEST_DOUBLE
template void TestSmallMatrixDiv_A3b<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixDiv_A3b<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixDiv_A3b<long double>();
#endif
