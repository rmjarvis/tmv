...
the native code is usually fairly competitive\footnote{Typically within a factor of 2 in speed,
and often within tens of percent.} with generic BLAS implementations like
ATLAS or GotoBLAS.
