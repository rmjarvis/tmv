// Note - This file is covered under a BSD license.
// See the file portable_platform.license in this directory.
// It is normally part of the GASNet software package, which can 
// be found at http://gasnet.cs.berkeley.edu/
//
// ------------------- Begin original file: ----------------------------------
...
#endif
#ifndef _PLATFORM_ARCH_64
#define _PLATFORM_ARCH_64 0
#endif
