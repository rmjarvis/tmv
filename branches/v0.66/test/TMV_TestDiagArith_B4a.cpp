...
template <class T> void TestDiagMatrixArith_B4a()
{
    ...
    TestMatrixArith4<T>(av,cav,pv,cpv, "Diag/SquareM");
    ...
    TestMatrixArith4<T>(av,cav,qv,cqv, "Diag/NonSquareM");
    TestMatrixArith4<T>(av,cav,rv,crv, "Diag/DegenM");
}

#ifdef TEST_DOUBLE
template void TestDiagMatrixArith_B4a<double>();
#endif
#ifdef TEST_FLOAT
template void TestDiagMatrixArith_B4a<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestDiagMatrixArith_B4a<long double>();
#endif
#ifdef TEST_INT
template void TestDiagMatrixArith_B4a<int>();
#endif
