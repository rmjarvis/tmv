...
\texttt{fink install tmv}

This should install TMV in the \texttt{/sw} directory with a minimum of fuss.

The only caveats here are that it will always install a shared library (\tt{libtmv.dylib}), and it will always use Apple's Frameworks BLAS library.  If these are not acceptable to you, then you will need to download TMV and install it yourself.
\end{quote}
