...
static void TestBasicSymBandMatrix_IO()
{
    ...
    Assert(s == xs1,"SymBandMatrix I/O check normal");
    Assert(h == xh1,"HermBandMatrix I/O check normal");
    Assert(cs == xcs1,"CSymBandMatrix I/O check normal");
    Assert(ch == xch1,"CHermBandMatrix I/O check normal");
    fin >> tmv::CompactIO() >> xs1 >> tmv::CompactIO() >> xh1;
    fin >> tmv::CompactIO() >> xcs1 >> tmv::CompactIO() >> xch1;
    Assert(s == xs1,"SymBandMatrix I/O check compact");
    Assert(h == xh1,"HermBandMatrix I/O check compact");
    Assert(cs == xcs1,"CSymBandMatrix I/O check compact");
    Assert(ch == xch1,"CHermBandMatrix I/O check compact");
    fin >> xs1.view() >> xh1.view() >> xcs1.view() >> xch1.view();
    Assert(s2 == xs1,"SymBandMatrix I/O check thresh");
    Assert(h2 == xh1,"HermBandMatrix I/O check thresh");
    Assert(cs2 == xcs1,"CSymBandMatrix I/O check thresh");
    Assert(ch2 == xch1,"CHermBandMatrix I/O check thresh");
    fin >> myStyle >> xs1.view() >> myStyle >> xh1.view();
    fin >> myStyle >> xcs1.view() >> myStyle >> xch1.view();
    Assert(s3 == xs1,"SymBandMatrix I/O check compact thresh & prec(4)");
    Assert(h3 == xh1,"HermBandMatrix I/O check compact thresh & prec(4)");
    Assert(cs3 == xcs1,"CSymBandMatrix I/O check compact thresh & prec(4)");
    Assert(ch3 == xch1,"CHermBandMatrix I/O check compact thresh & prec(4)");
    fin.close();
    ...
    Assert(s == xs2,"SymBandMatrix I/O check normal");
    Assert(h == xh2,"HermBandMatrix I/O check normal");
    Assert(cs == xcs2,"CSymBandMatrix I/O check normal");
    Assert(ch == xch2,"CHermBandMatrix I/O check normal");
    fin >> tmv::CompactIO() >> xs2.view() >> tmv::CompactIO() >> xh2.view();
    fin >> tmv::CompactIO() >> xcs2.view() >> tmv::CompactIO() >> xch2.view();
    Assert(s == xs2,"SymBandMatrix I/O check compact");
    Assert(h == xh2,"HermBandMatrix I/O check compact");
    Assert(cs == xcs2,"CSymBandMatrix I/O check compact");
    Assert(ch == xch2,"CHermBandMatrix I/O check compact");
    fin >> xs2 >> xh2 >> xcs2 >> xch2;
    Assert(s2 == xs2,"SymBandMatrix I/O check thresh");
    Assert(h2 == xh2,"HermBandMatrix I/O check thresh");
    Assert(cs2 == xcs2,"CSymBandMatrix I/O check thresh");
    Assert(ch2 == xch2,"CHermBandMatrix I/O check thresh");
    fin >> myStyle >> xs2 >> myStyle >> xh2;
    fin >> myStyle >> xcs2 >> myStyle >> xch2;
    Assert(s3 == xs2,"SymBandMatrix I/O check compact thresh & prec(4)");
    Assert(h3 == xh2,"HermBandMatrix I/O check compact thresh & prec(4)");
    Assert(cs3 == xcs2,"CSymBandMatrix I/O check compact thresh & prec(4)");
    Assert(ch3 == xch2,"CHermBandMatrix I/O check compact thresh & prec(4)");
    fin.close();
    ...
    Assert(s == xs3,"SymBandMatrix I/O check normal");
    Assert(h == xh3,"HermBandMatrix I/O check normal");
    Assert(cs == xcs3,"CSymBandMatrix I/O check normal");
    Assert(ch == xch3,"CHermBandMatrix I/O check normal");
    fin >> tmv::CompactIO() >> xs3.view() >> tmv::CompactIO() >> xh3.view();
    fin >> tmv::CompactIO() >> xcs3.view() >> tmv::CompactIO() >> xch3.view();
    Assert(s == xs3,"SymBandMatrix I/O check compact");
    Assert(h == xh3,"HermBandMatrix I/O check compact");
    Assert(cs == xcs3,"CSymBandMatrix I/O check compact");
    Assert(ch == xch3,"CHermBandMatrix I/O check compact");
    fin >> xs3 >> xh3 >> xcs3 >> xch3;
    Assert(s2 == xs3,"SymBandMatrix I/O check thresh");
    Assert(h2 == xh3,"HermBandMatrix I/O check thresh");
    Assert(cs2 == xcs3,"CSymBandMatrix I/O check thresh");
    Assert(ch2 == xch3,"CHermBandMatrix I/O check thresh");
    fin >> myStyle >> xs3 >> myStyle >> xh3;
    fin >> myStyle >> xcs3 >> myStyle >> xch3;
    Assert(s3 == xs3,"SymBandMatrix I/O check compact thresh & prec(4)");
    Assert(h3 == xh3,"HermBandMatrix I/O check compact thresh & prec(4)");
    Assert(cs3 == xcs3,"CSymBandMatrix I/O check compact thresh & prec(4)");
    Assert(ch3 == xch3,"CHermBandMatrix I/O check compact thresh & prec(4)");
    fin.close();
    ...
    Assert(s == xh4,"SymBandMatrix I/O check normal");
    Assert(h == xs4,"HermBandMatrix I/O check normal");
    Assert(cs == xcs4,"CSymBandMatrix I/O check normal");
    Assert(ch == xch4,"CHermBandMatrix I/O check normal");
    fin >> tmv::CompactIO() >> xh4.view() >> tmv::CompactIO() >> xs4.view();
    fin >> tmv::CompactIO() >> xcs4.view() >> tmv::CompactIO() >> xch4.view();
    Assert(s == xh4,"SymBandMatrix I/O check compact");
    Assert(h == xs4,"HermBandMatrix I/O check compact");
    Assert(cs == xcs4,"CSymBandMatrix I/O check compact");
    Assert(ch == xch4,"CHermBandMatrix I/O check compact");
    fin >> xh4 >> xs4 >> xcs4 >> xch4;
    Assert(s2 == xh4,"SymBandMatrix I/O check thresh");
    Assert(h2 == xs4,"HermBandMatrix I/O check thresh");
    Assert(cs2 == xcs4,"CSymBandMatrix I/O check thresh");
    Assert(ch2 == xch4,"CHermBandMatrix I/O check thresh");
    fin >> myStyle >> xh4 >> myStyle >> xs4;
    fin >> myStyle >> xcs4 >> myStyle >> xch4;
    Assert(s3 == xh4,"SymBandMatrix I/O check compact thresh & prec(4)");
    Assert(h3 == xs4,"HermBandMatrix I/O check compact thresh & prec(4)");
    Assert(cs3 == xcs4,"CSymBandMatrix I/O check compact thresh & prec(4)");
    Assert(ch3 == xch4,"CHermBandMatrix I/O check compact thresh & prec(4)");
    fin.close();
    ...
    Assert(s == xh5,"SymBandMatrix I/O check normal");
    Assert(h == xs5,"HermBandMatrix I/O check normal");
    Assert(cs == xcs5,"CSymBandMatrix I/O check normal");
    Assert(ch == xch5,"CHermBandMatrix I/O check normal");
    fin >> tmv::CompactIO() >> xh5.view() >> tmv::CompactIO() >> xs5.view();
    fin >> tmv::CompactIO() >> xcs5.view() >> tmv::CompactIO() >> xch5.view();
    Assert(s == xh5,"SymBandMatrix I/O check compact");
    Assert(h == xs5,"HermBandMatrix I/O check compact");
    Assert(cs == xcs5,"CSymBandMatrix I/O check compact");
    Assert(ch == xch5,"CHermBandMatrix I/O check compact");
    fin >> xh5 >> xs5 >> xcs5 >> xch5;
    Assert(s2 == xh5,"SymBandMatrix I/O check thresh");
    Assert(h2 == xs5,"HermBandMatrix I/O check thresh");
    Assert(cs2 == xcs5,"CSymBandMatrix I/O check thresh");
    Assert(ch2 == xch5,"CHermBandMatrix I/O check thresh");
    fin >> myStyle >> xh5 >> myStyle >> xs5;
    fin >> myStyle >> xcs5 >> myStyle >> xch5;
    Assert(s3 == xh5,"SymBandMatrix I/O check compact thresh & prec(4)");
    Assert(h3 == xs5,"HermBandMatrix I/O check compact thresh & prec(4)");
    Assert(cs3 == xcs5,"CSymBandMatrix I/O check compact thresh & prec(4)");
    Assert(ch3 == xch5,"CHermBandMatrix I/O check compact thresh & prec(4)");
    fin.close();
    ...
    Assert(s == xh6,"SymBandMatrix I/O check normal");
    Assert(h == xs6,"HermBandMatrix I/O check normal");
    Assert(cs == xcs6,"CSymBandMatrix I/O check normal");
    Assert(ch == xch6,"CHermBandMatrix I/O check normal");
    fin >> tmv::CompactIO() >> xh6.view() >> tmv::CompactIO() >> xs6.view();
    fin >> tmv::CompactIO() >> xcs6.view() >> tmv::CompactIO() >> xch6.view();
    Assert(s == xh6,"SymBandMatrix I/O check compact");
    Assert(h == xs6,"HermBandMatrix I/O check compact");
    Assert(cs == xcs6,"CSymBandMatrix I/O check compact");
    Assert(ch == xch6,"CHermBandMatrix I/O check compact");
    fin >> xh6 >> xs6 >> xcs6 >> xch6;
    Assert(s2 == xh6,"SymBandMatrix I/O check thresh");
    Assert(h2 == xs6,"HermBandMatrix I/O check thresh");
    Assert(cs2 == xcs6,"CSymBandMatrix I/O check thresh");
    Assert(ch2 == xch6,"CHermBandMatrix I/O check thresh");
    fin >> myStyle >> xh6 >> myStyle >> xs6;
    fin >> myStyle >> xcs6 >> myStyle >> xch6;
    Assert(s3 == xh6,"SymBandMatrix I/O check compact thresh & prec(4)");
    Assert(h3 == xs6,"HermBandMatrix I/O check compact thresh & prec(4)");
    Assert(cs3 == xcs6,"CSymBandMatrix I/O check compact thresh & prec(4)");
    Assert(ch3 == xch6,"CHermBandMatrix I/O check compact thresh & prec(4)");
    fin.close();
    ...
    Assert(s == zs1,"SymBandMatrix I/O check normal");
    Assert(h == zh1,"HermBandMatrix I/O check normal");
    Assert(cs == zcs1,"CSymBandMatrix I/O check normal");
    Assert(ch == zch1,"CHermBandMatrix I/O check normal");
    fin >> zs2 >> zh2 >> zcs2 >> zch2;
    Assert(s == zs2,"SymBandMatrix I/O check compact");
    Assert(h == zh2,"HermBandMatrix I/O check compact");
    Assert(cs == zcs2,"CSymBandMatrix I/O check compact");
    Assert(ch == zch2,"CHermBandMatrix I/O check compact");
    fin >> tmv::NormalIO() >> zs3 >> tmv::NormalIO() >> zh3;
    fin >> tmv::NormalIO() >> zcs3 >> tmv::NormalIO() >> zch3;
    Assert(s2 == zs3,"SymBandMatrix I/O check thresh");
    Assert(h2 == zh3,"HermBandMatrix I/O check thresh");
    Assert(cs2 == zcs3,"CSymBandMatrix I/O check thresh");
    Assert(ch2 == zch3,"CHermBandMatrix I/O check thresh");
    fin >> myStyle >> zs4 >> myStyle >> zh4;
    fin >> myStyle >> zcs4 >> myStyle >> zch4;
    Assert(s3 == zs4,"SymBandMatrix I/O check compact thresh & prec(4)");
    Assert(h3 == zh4,"HermBandMatrix I/O check compact thresh & prec(4)");
    Assert(cs3 == zcs4,"CSymBandMatrix I/O check compact thresh & prec(4)");
    Assert(ch3 == zch4,"CHermBandMatrix I/O check compact thresh & prec(4)");
    fin.close();
    ...
    Assert(s == zm1,"SymBandMatrix -> Matrix I/O check");
    Assert(h == zm2,"HermBandMatrix -> Matrix I/O check");
    Assert(cs == zcm1,"CSymBandMatrix -> CMatrix I/O check");
    Assert(ch == zcm2,"CHermBandMatrix -> CMatrix I/O check");
    fin.close();
