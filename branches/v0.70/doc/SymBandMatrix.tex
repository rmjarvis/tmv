...
\item 
\begin{tmvcode}
tmv::SymBandMatrix<T,A> sb(const Matrix<T>& m, int nlo)
tmv::SymBandMatrix<T,A> sb(const SymMatrix<T>& m, int nlo)
tmv::SymBandMatrix<T,A> sb(const BandMatrix<T>& m, int nlo)
tmv::SymBandMatrix<T,A> sb(const SymBandMatrix<T>& m, int nlo)
\end{tmvcode}
...
\item
\begin{tmvcode}
tmv::SymBandMatrix<T,A> sb1(const SymBandMatrix<T2>& sb2)
sb1 = sb2
\end{tmvcode}
