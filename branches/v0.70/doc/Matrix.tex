...
\item
\begin{tmvcode}
m.permuteRows(const ptrdiff_t* p)
m.permuteRows(const ptrdiff_t* p, int i1, int i2)
m.reversePermuteRows(const ptrdiff_t* p)
m.reversePermuteRows(const ptrdiff_t* p, int i1, int i2)
\end{tmvcode}
...
\item
\begin{tmvcode}
m.permuteCols(const ptrdiff_t* p)
m.permuteCols(const ptrdiff_t* p, int j1, int j2)
m.reversePermuteCols(const ptrdiff_t* p)
m.reversePermuteCols(const ptrdiff_t* p, int j1, int j2)
\end{tmvcode}
