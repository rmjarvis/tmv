...
\item 
\begin{tmvcode}
tmv::BandMatrix<T,stor,index> b(int nrows, int ncols, 
      int nlo, int nhi)
\end{tmvcode}
...
\begin{tmvcode}
typename tmv::BandMatrix<T>::rowmajor_iterator b.rowmajor_begin()
typename tmv::BandMatrix<T>::rowmajor_iterator b.rowmajor_end()
typename tmv::BandMatrix<T>::const_rowmajor_iterator b.rowmajor_begin() const
typename tmv::BandMatrix<T>::const_rowmajor_iterator b.rowmajor_end() const
typename tmv::BandMatrix<T>::colmajor_iterator b.colmajor_begin()
typename tmv::BandMatrix<T>::colmajor_iterator b.colmajor_end()
typename tmv::BandMatrix<T>::const_colmajor_iterator b.colmajor_begin() const
typename tmv::BandMatrix<T>::const_colmajor_iterator b.colmajor_end() const
...
typename tmv::BandMatrix<T>::const_diagmajor_iterator b.diagmajor_begin() const
typename tmv::BandMatrix<T>::const_diagmajor_iterator b.diagmajor_end() const
\end{tmvcode}
...
These methods allow for direct memory access of a \tt{BandMatrix}.  There are two new methods here: \tt{m.diagstep()} returns the step along the diagonal directions, and is equivalent to \tt{(m.stepi()+m.stepj())} and \tt{isdm()} is another convenience function that returns whether \tt{b} is \tt{DiagMajor}. 
