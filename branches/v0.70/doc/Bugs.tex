...
$\quad$\\
% Done:
% Flute: clang++ 3.1 NO BLAS 						X
% Flute: Apple g++ 4.0.1 NO BLAS			
% Flute: Apple g++ 4.2.1 NO BLAS			
% Flute: g++ 4.4.6 NO BLAS						X
% Flute: g++ 4.5.3 NO BLAS				
% Flute: g++ 4.6.2 NO BLAS, GOTO2, GOTO2+FLAPACK, ATLAS			X
% bnl: g++ 4.3.2 NO BLAS, FBLAS						X
% bnl: g++ 4.1.2 NO BLAS, FBLAS						X
% apu: icpc 10.1 NO BLAS, MKL BLAS, MKL LAPACK				X
% chimaera: pgCC 6.1 NO BLAS, ACML BLAS, ACML LAPACK			X
% chimaera: g++ 3.4.6 NO BLAS, ATLAS+FLAPACK, 				X
% lonestar: icpc 11.1 NO BLAS, MKL BLAS, MKL LAPACK			X
...
% susi: icpc 12.0.4 NO BLAS, MKL BLAS, MKL LAPACK			X
% 
