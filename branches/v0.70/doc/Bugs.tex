...
% Flute: g++ 4.5.3 NO BLAS
% Flute: g++ 4.6.2 NO BLAS, GOTO2
% bnl: g++ 4.3.2 FBLAS, NO BLAS
% bnl: g++ 4.1.2 NO BLAS
% apu: icpc 10.1 MKL BLAS, MKL LAPACK
% chimaera: pgCC 6.1 NO BLAS ACML LAPACK
% chimaera: g++ 3.4.6 NO BLAS, ATLAS+FLAPACK, 
% queenbee: icpc 11.1 FBLAS, MKL BLAS, MKL LAPACK
% queenbee: g++ 3.4.6 MKL LAPACK 
% susi: g++ 4.4.5 NO BLAS
% 
...
The version 0.90 code currently in development also uses OpenMP for
multiplication and division by triangle matrices on a rectangle matrix.  These 
algorithms have not been propagated back to the current released version.
