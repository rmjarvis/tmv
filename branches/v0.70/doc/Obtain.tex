...
For that 
release it was considered an alternative method, since it was brand new.  It has worked very well and has allowed very nice automatic behavior as far as finding BLAS libraries on your system fairly painlessly.  
SCons has worked well on every system I've used it on, and since nobody has mentioned having any significant problems with it, I'm making it the only supported installation method starting with version 0.70.

If you have do have any trouble installing with SCons, please let me know about 
