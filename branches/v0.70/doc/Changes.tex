...
I don't think there are any more big changes in the UI coming down the 
pike, even with the big redesign that I'm calling versin 0.90.
...
code that uses them will continue to work with this version.
