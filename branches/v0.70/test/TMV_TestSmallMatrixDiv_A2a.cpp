...
static void TestSmallSquareDiv_A2a()
{
    ...
    TestMatrixDivArith3b(tmv::LU,a1,a2a,a3,c1,c2a,c3,"Square/Square"); 
#if (XTEST & 32)
    ...
    TestMatrixDivArith3b(tmv::LU,a1f,a2a,a3,c1f,c2a,c3,"Square/Square"); 
    TestMatrixDivArith3b(tmv::LU,a1f,a2fa,a3,c1f,c2fa,c3,"Square/Square"); 
    TestMatrixDivArith3b(tmv::LU,a1f,a2fa,a3f,c1f,c2fa,c3f,"Square/Square"); 
#endif
}

template <class T> 
void TestSmallMatrixDiv_A2a()
{
    TestSmallSquareDiv_A2a<T,tmv::ColMajor,2>();
    TestSmallSquareDiv_A2a<T,tmv::ColMajor,5>();
#if (XTEST & 2)
    TestSmallSquareDiv_A2a<T,tmv::ColMajor,1>();
    TestSmallSquareDiv_A2a<T,tmv::ColMajor,3>();
    TestSmallSquareDiv_A2a<T,tmv::ColMajor,4>();
    TestSmallSquareDiv_A2a<T,tmv::RowMajor,1>();
    TestSmallSquareDiv_A2a<T,tmv::RowMajor,2>();
    TestSmallSquareDiv_A2a<T,tmv::RowMajor,3>();
    TestSmallSquareDiv_A2a<T,tmv::RowMajor,4>();
    TestSmallSquareDiv_A2a<T,tmv::RowMajor,5>();
#endif
}

#ifdef TEST_DOUBLE
template void TestSmallMatrixDiv_A2a<double>();
#endif
#ifdef TEST_FLOAT
template void TestSmallMatrixDiv_A2a<float>();
#endif
#ifdef TEST_LONGDOUBLE
template void TestSmallMatrixDiv_A2a<long double>();
#endif
