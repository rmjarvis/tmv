...
static void DoTestSmallMatrixArith_B4c()
{
    ...
    TestMatrixArith4(a5f,ca5f,a6,ca6,"NonSquare");
    TestMatrixArith4(a5f,ca5f,a6f,ca6f,"NonSquare");
#endif
}
