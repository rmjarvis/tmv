...
static void DoTestSmallMatrixArith_A4b()
{
    ...
    TestMatrixArith4(a2f,ca2f,a1,ca1,"Square");
    TestMatrixArith4(a2f,ca2f,a1f,ca1f,"Square");
#endif
}
