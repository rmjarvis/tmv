...
static void DoTestSmallMatrixArith_B4a()
{
    ...
    TestMatrixArith4(a3f,ca3f,a4,ca4,"NonSquare");
    TestMatrixArith4(a3f,ca3f,a4f,ca4f,"NonSquare");
#endif
}
