    ...
    BaseM& a0, CONST MM& a, T2 x, std::string label)
{
  if (showstartdone) {
    ...
    std::cout<<"a = "<<tmv::TMV_Text(a)<<" "<<a<<std::endl;
    std::cout<<"a0 = "<<tmv::TMV_Text(a0)<<" "<<a0<<std::endl;
    std::cout<<"x = "<<tmv::TMV_Text(x)<<" "<<x<<std::endl;
  }
    ...
    IFTEMP1(V0& temp) IFTEMP1(CV0& ctemp) const MM& a, const V& b, std::string label)
{
  ...
  if (CanMultMV(a,b)) {
    ...
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)z*a*b)-(z*m*v)) <= x*eps,label+" z*a*b");
#ifdef XTEST
    Assert(Norm(VEC2(T,Ta,IFTEMP(temp=)(x*a)*b)-(x*m*v)) <= x*eps,label+" (x*a)*b");
    Assert(Norm(VEC2(T,Ta,IFTEMP(temp=)x*(a*b))-(x*m*v)) <= x*eps,label+" x*(a*b)");
    ...
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)(z*a)*b)-(z*m*v)) <= x*eps,label+" (z*a)*b");
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)z*(a*b))-(z*m*v)) <= x*eps,label+" z*(a*b)");
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)a*(z*b))-(z*m*v)) <= x*eps,label+" a*(z*b)");
#endif
  }
  if (showstartdone)
    ...
    IFTEMP1(V0& temp) IFTEMP1(CV0& ctemp) const MM& a, const V& b, std::string label)
{
  ...
  if (CanMultVM(v,m)) {
    ...
    if (XXDEBUG4) {
      ...
      std::cout<<"z*b*a Norm(diff) = "<<Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)z*b*a)-(z*v*m))<<std::endl;
      std::cout<<"eps = "<<eps<<std::endl;
    ...
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)z*b*a)-(z*v*m)) <= x*eps,label+" z*b*a");
#ifdef XTEST
    Assert(Norm(VEC2(T,Ta,IFTEMP(temp=)(x*b)*a)-(x*v*m)) <= x*eps,label+" (x*b)*a");
    Assert(Norm(VEC2(T,Ta,IFTEMP(temp=)x*(b*a))-(x*v*m)) <= x*eps,label+" x*(b*a)");
    ...
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)(z*b)*a)-(z*v*m)) <= x*eps,label+" (z*b)*a");
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)z*(b*a))-(z*v*m)) <= x*eps,label+" z*(b*a)");
    Assert(Norm(VEC(TMV_ComplexType(T),IFTEMP(ctemp=)b*(z*a))-(z*v*m)) <= x*eps,label+" b*(z*a)");
#endif
  }
  if (showstartdone)
    ...
    const MM& a, CONST V& b, std::string label)
{
  ...
  if (CanMultMV(a,v,b)) {
    tmv::Vector<T> prod = m*v;
    if (XXDEBUG5) {
      std::cout<<"CanMult("<<tmv::TMV_Text(a)<<","<<tmv::TMV_Text(v)<<","<<tmv::TMV_Text(b)<<")\n";
      std::cout<<"v = "<<v<<std::endl;
      std::cout<<"m = "<<m<<std::endl;
      std::cout<<"prod = "<<prod<<std::endl;
    }
    ...
    const MM& a, CONST V& b, std::string label)
{
  ...
  if (CanMultVM(v,a,b)) {
    tmv::Vector<T> prod = v*m;
    if (XXDEBUG5) {
      std::cout<<"CanMult("<<tmv::TMV_Text(v)<<","<<tmv::TMV_Text(a)<<","<<tmv::TMV_Text(b)<<")\n";
      std::cout<<"v = "<<v<<std::endl;
      std::cout<<"m = "<<m<<std::endl;
      std::cout<<"prod = "<<prod<<std::endl;
    }
    ...
    IFTEMP1(M0& temp) IFTEMP1(CM0& ctemp) const M1& a, const M2& b, std::string label)
{
  ...
  if (CanAdd(a,b)) {
...

    {
      TMV_RealType(T) x(5);
      TMV_ComplexType(T) z(3,4);
      tmv::Matrix<TMV_ComplexType(T)> sum = m1+z*m2;
      tmv::Matrix<TMV_ComplexType(T)> diff = m1-z*m2;
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)a+z*b)-sum) <= x*eps,label+" a+z*b");
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)a-z*b)-diff) <= x*eps,label+" a-z*b");
#ifdef XTEST
#ifndef NOMIX
      ...
      sum = x*m1+z*m2;
      diff = x*m1-z*m2;
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)x*a-z*b)-diff) <= x*eps,label+" x*a-z*b");
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)x*a+z*b)-sum) <= x*eps,label+" x*a+z*b");
#ifndef NOMIX
      ...
      sum = z*m1+m2;
      diff = z*m1-m2;
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)z*a-b)-diff) <= x*eps,label+" z*a-b");
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)z*a+b)-sum) <= x*eps,label+" z*a+b");
#ifndef NOMIX
      ...
      sum = z*m1+x*m2;
      diff = z*m1-x*m2;
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)z*a-x*b)-diff) <= x*eps,label+" z*a-x*b");
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)z*a+x*b)-sum) <= x*eps,label+" z*a+x*b");
#ifndef NOMIX
      ...
      sum = z*m1+z*m2;
      diff = z*m1-z*m2;
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)z*a-z*b)-diff) <= x*eps,label+" z*a-z*b");
      Assert(Norm(MAT(TMV_ComplexType(T),IFTEMP(ctemp=)z*a+z*b)-sum) <= x*eps,label+" z*a+bz*");
#ifndef NOMIX
    ...
    BaseM& a0, CONST M1& a, const M2& b, std::string label)
{
  ...
  if (CanAddEq(m1,b)) {
    if (XXDEBUG8) {
      std::cout<<"CanAddEq("<<tmv::TMV_Text(m1)<<","<<tmv::TMV_Text(b)<<")\n";
    }
    tmv::Matrix<T> m3 = m1;
    tmv::Matrix<T> m4 = m1;
    m3 += b;
    ...
    BaseM& a0, CONST M1& a, const M2& b, std::string label)
{
  ...
  if (m1.rowsize() == m2.colsize()) {
    ...
    if (CanMultMM(a,b,m1)) {
      if (XXDEBUG8) {
        std::cout<<"CanMult("<<tmv::TMV_Text(a)<<","<<tmv::TMV_Text(b)<<","<<tmv::TMV_Text(m1)<<")\n";
      }
      tmv::Matrix<T> m3 = m1;
      tmv::Matrix<T> m4 = m1;
      TMV_RealType(T) x(5);
      ...
      m4 = x*mm;
      if (XXDEBUG8) {
        std::cout<<"m = x*a*b = "<<m3<<std::endl;
        std::cout<<"cf. "<<m4<<std::endl;
        std::cout<<"Norm(diff) = "<<Norm(m3-m4)<<std::endl;
        std::cout<<"x*eps2 = "<<x*eps2<<std::endl;
      }
    ...
    if (CanMultMM(m1,b,m1)) {
      if (XXDEBUG8) {
        std::cout<<"CanMult("<<tmv::TMV_Text(m1)<<","<<tmv::TMV_Text(b)<<","<<tmv::TMV_Text(m1)<<")\n";
      }
      tmv::Matrix<T> m3 = m1;
      tmv::Matrix<T> m4 = m1;
      m3 += m1*b;
  ...
  if (m2.rowsize() == m1.colsize()) {
    ...
    if (CanMultMM(b,m1,m1)) {
      if (XXDEBUG8) {
        std::cout<<"CanMult("<<tmv::TMV_Text(b)<<","<<tmv::TMV_Text(m1)
        <<","<<tmv::TMV_Text(m1)<<")\n";
      }
      tmv::Matrix<T> m3 = m1;
      tmv::Matrix<T> m4 = m1;
    ...
    if (CanMultXMM(b,a,a)) {
      if (XXDEBUG8) {
        std::cout<<"CanMultXM("<<tmv::TMV_Text(b)<<","<<tmv::TMV_Text(a)
        <<","<<tmv::TMV_Text(a)<<")\n";
      }
      tmv::Matrix<T> m4 = m1;
      a = -b * a;
  ...
  if (m2.rowsize() == m2.colsize()) {
    ...
    if (CanMultMM(b,b,a)) {
      if (XXDEBUG8) {
        std::cout<<"CanMult("<<tmv::TMV_Text(b)<<","<<tmv::TMV_Text(b)
        <<","<<tmv::TMV_Text(a)<<")\n";
      }
      tmv::Matrix<T> m4 = m1;
      a = b*b;
    ...
    if (CanMultXMM(b,b,a)) {
      if (XXDEBUG8) {
        std::cout<<"CanMultXM("<<tmv::TMV_Text(b)<<","<<tmv::TMV_Text(b)
        <<","<<tmv::TMV_Text(a)<<")\n";
      }
      tmv::Matrix<T> m4 = m1;
      a = -b*b;
    ...
    std::string label)
{
  if (showstartdone) {
    ...
    std::cout<<"ca0 = "<<tmv::TMV_Text(ca0)<<" "<<ca0<<std::endl;
  }
    ...
    std::string label)
{
  if (showstartdone) {
    ...
    std::cout<<"ca = "<<tmv::TMV_Text(ca)<<" "<<ca<<std::endl;
    std::cout<<"cb = "<<tmv::TMV_Text(cb)<<" "<<cb<<std::endl;
    std::cout<<"a0 = "<<tmv::TMV_Text(a0)<<std::endl;
    std::cout<<"ca0 = "<<tmv::TMV_Text(ca0)<<std::endl;
  }
